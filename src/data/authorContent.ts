...
const jonasArticles: AuthorArticle[] = [
  ...
  { title: "Martingale System", path: "/casinospil/blackjack/martingale", category: "Guide", excerpt: "Martingale-systemet forklaret – dobling ved tab i blackjack." },
  { title: "Fibonacci System", path: "/casinospil/blackjack/fibonacci", category: "Guide", excerpt: "Fibonacci-systemet – progressiv betting baseret på talrækken." },
  { title: "D'Alembert System", path: "/casinospil/blackjack/dalembert", category: "Guide", excerpt: "D'Alembert-systemet – forsigtig progressiv strategi til blackjack." },
