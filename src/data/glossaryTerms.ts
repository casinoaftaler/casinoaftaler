...
export const glossaryTerms: GlossaryTerm[] = [
  {
    ...
    fullContent: `<h2>Hvad er RTP?</h2><p>RTP står for <strong>Return to Player</strong> og er den mest fundamentale statistik inden for spillemaskiner. RTP udtrykkes som en procentdel og angiver, hvor stor en andel af alle indsatser en spillemaskine teoretisk set returnerer til spillerne over en uendelig lang tidsperiode.</p><p>Hvis en spillemaskine har en RTP på <strong>96,50%</strong>, betyder det, at for hver 100 kr. der indsættes, vil maskinen i gennemsnit udbetale 96,50 kr. tilbage. De resterende 3,50 kr. er casinoets teoretiske fortjeneste, også kaldet <em>house edge</em>.</p><h2>Hvordan beregnes RTP?</h2><p>RTP beregnes ud fra spillets matematiske model og er baseret på millioner af simulerede spins. Formlen er:</p><p><strong>RTP = (Samlede udbetalinger ÷ Samlede indsatser) × 100</strong></p><p>Det er vigtigt at forstå, at RTP er et <strong>langsigtet gennemsnit</strong>. På kort sigt kan dine resultater variere markant.</p><h2>RTP i praksis</h2><ul><li><strong>Slot A</strong>: RTP 97,00% – returnerer i gennemsnit 9.700 kr. per 10.000 kr.</li><li><strong>Slot B</strong>: RTP 94,00% – returnerer i gennemsnit 9.400 kr. per 10.000 kr.</li></ul><p>Forskellen akkumulerer sig over tusindvis af spins. Vi anbefaler altid slots med <strong>RTP på 96% eller derover</strong>.</p><h2>RTP vs. House Edge</h2><p><strong>House Edge = 100% − RTP</strong></p><p>En spillemaskine med 96% RTP har et house edge på 4%. Jo højere RTP, desto bedre for spilleren.</p><h2>Typiske RTP-intervaller</h2><ul><li><strong>Høj RTP (96,50%+)</strong>: Blood Suckers (98,00%), Mega Joker (99,00%)</li><li><strong>Gennemsnitlig RTP (95–96,50%)</strong>: Gates of Olympus (96,50%), Sweet Bonanza (96,48%)</li><li><strong>Lav RTP (under 95%)</strong>: Ofte jackpot-slots som Mega Moolah (88,12%)</li></ul><h2>Vigtigt at huske</h2><ul><li>RTP gælder over <strong>millioner af spins</strong> — ikke din individuelle session</li><li>Danske casinoer med licens fra Spillemyndigheden skal oplyse RTP for alle spil</li><li>Kombinér altid RTP med volatilitet for at forstå spillets risikoprofil</li></ul>`,
  },
  {
    slug: "wagering",
  ...
  },
  {
    ...
    fullContent: `<h2>Hvad er volatilitet?</h2><p><strong>Volatilitet</strong> (også kaldet varians) beskriver, hvor meget og hvor ofte en spillemaskine udbetaler. Det er et mål for risikoen.</p><h2>De tre niveauer</h2><h3>Lav volatilitet</h3><p>Hyppige små gevinster. Din saldo svinger minimalt. Eksempler: Starburst, Blood Suckers.</p><h3>Medium volatilitet</h3><p>Balance mellem gevinststørrelse og frekvens. Eksempler: Gonzo's Quest, Fire Joker.</p><h3>Høj volatilitet</h3><p>Lange tørkeperioder afbrudt af potentielt massive gevinster. Eksempler: Dead or Alive 2, Book of Dead.</p><h2>Bankroll-management</h2><ul><li><strong>Lav</strong>: 50-100 spins i bankroll</li><li><strong>Medium</strong>: 150-300 spins</li><li><strong>Høj</strong>: 300-500+ spins</li></ul><h2>Volatilitet vs. RTP</h2><p>De er <strong>uafhængige parametre</strong>. Begge bør vurderes sammen for at forstå spillets samlede risikoprofil.</p>`,
  },
  {
    slug: "house-edge",
    title: "House Edge",
    ...
    fullContent: `<h2>Hvad er house edge?</h2><p><strong>House edge</strong> er den procentdel af hver indsats, som casinoet forventer at beholde over tid.</p><h2>Beregning</h2><p><strong>House Edge = 100% − RTP</strong></p><h2>House edge på tværs af spil</h2><ul><li><strong>Blackjack</strong> (0,20–0,50%): Laveste med perfekt strategi</li><li><strong>Baccarat</strong> (1,06–1,24%): Banker-bet er stærkest</li><li><strong>Europæisk Roulette</strong> (2,70%): Enkelt nul</li><li><strong>Spillemaskiner</strong> (2–8%): Varierer kraftigt</li></ul><h2>Forventet tab</h2><p><strong>Forventet tab = Samlet indsats × House Edge</strong></p><p>5.000 kr. på europæisk roulette (2,70%) = 135 kr. forventet tab.</p>`,
  },
  {
    slug: "free-spins",
    ...
    fullContent: `<h2>Hvad er free spins?</h2><p><strong>Free spins</strong> refererer til to koncepter:</p><ol><li><strong>In-game free spins</strong>: Bonusfunktion i slotten, typisk udløst af scatter-symboler</li><li><strong>Casino free spins</strong>: Bonus fra casinoet som del af velkomstpakke</li></ol><h2>In-game free spins</h2><p>Aktiveres ved 3+ scatter-symboler. Ekstra funktioner inkluderer expanding wilds, multiplikatorer, retriggers og sticky wilds.</p><h2>Casino free spins</h2><ul><li><strong>Velkomstbonus</strong>: F.eks. 100 free spins ved første indbetaling</li><li><strong>No deposit</strong>: Gratis spins uden indbetaling</li><li><strong>Daglige</strong>: Kampagner med gratis spins hver dag</li></ul><h2>Vigtige vilkår</h2><ul><li><strong>Omsætningskrav</strong>: Typisk 20-40x</li><li><strong>Max gevinst</strong>: Loft på gevinster</li><li><strong>Spin-værdi</strong>: Typisk 1-2 kr. per spin</li></ul>`,
  },
  {
    slug: "scatter",
    ...
    fullContent: `<h2>Hvad er et scatter-symbol?</h2><p><strong>Scatter-symbolet</strong> kan udbetale og aktivere bonusfunktioner <strong>uanset hvor det lander på hjulene</strong>.</p><h2>Funktioner</h2><ul><li><strong>Direkte udbetaling</strong>: Baseret på samlet indsats</li><li><strong>Bonusudløser</strong>: 3+ scatters aktiverer free spins</li></ul><h2>Scatter vs. andre symboler</h2><ul><li><strong>Scatter</strong>: Tæller overalt, udløser bonusser</li><li><strong>Wild</strong>: Erstatter symboler, skal stå på gevinstlinje</li></ul><h2>Populære eksempler</h2><ul><li><strong>Book of Dead</strong>: Bogen er både scatter og wild</li><li><strong>Sweet Bonanza</strong>: Lollipop-scatter</li><li><strong>Gates of Olympus</strong>: Zeus-scatter</li></ul>`,
  },
  {
    slug: "wild",
    title: "Wild-symbol",
    ...
    fullContent: `<h2>Hvad er et wild-symbol?</h2><p><strong>Wild-symbolet</strong> erstatter alle standardsymboler for at danne gevinster. Wild erstatter normalt <strong>ikke</strong> scatter eller bonussymboler.</p><h2>Typer</h2><h3>Expanding Wild</h3><p>Udvider sig til at dække hele hjulet. Populært i Book of Dead og Starburst.</p><h3>Sticky Wild</h3><p>Forbliver på sin position i flere spins, typisk under free spins.</p><h3>Walking Wild</h3><p>Bevæger sig ét hjul til venstre for hvert spin.</p><h3>Multiplier Wild</h3><p>Multiplicerer gevinsten med 2x, 3x eller mere.</p><h3>Stacked Wild</h3><p>Flere wilds stablet oven på hinanden.</p>`,
  },
  {
    slug: "jackpot",
    title: "Jackpot",
    ...
    fullContent: `<h2>Hvad er en jackpot?</h2><p>En <strong>jackpot</strong> er den højeste mulige gevinst i et casinospil.</p><h2>Typer</h2><h3>Fast jackpot</h3><p>Forudbestemt topgevinst, f.eks. 5.000x indsats.</p><h3>Progressiv jackpot</h3><p>Vokser med en andel af hver indsats. Tre typer: standalone, lokal og netværks-progressiv.</p><h2>Berømte jackpots</h2><ul><li><strong>Mega Moolah</strong>: Rekord €18,9 millioner</li><li><strong>Mega Fortune</strong>: Over €10 millioner</li><li><strong>Divine Fortune</strong>: Hyppigere, mindre jackpots</li></ul><h2>RTP og jackpots</h2><p>Progressive slots har typisk lavere base RTP, fordi en del af indsatsen går til jackpot-puljen.</p>`,
  },
  {
    slug: "rng",
    ...
    fullContent: `<h2>Hvad er RNG?</h2><p><strong>RNG</strong> står for Random Number Generator og er algoritmen der styrer alle udfald i online casinospil.</p><h2>Hvordan fungerer det?</h2><ol><li>Algoritmen starter med en seed-værdi</li><li>Genererer et nyt tilfældigt tal per spin</li><li>Tallet mappes til et specifikt udfald</li></ol><h2>Certificering</h2><ul><li><strong>eCOGRA</strong>: Anerkendt af Spillemyndigheden</li><li><strong>iTech Labs</strong>: Australsk testlaboratorium</li><li><strong>GLI</strong>: En af verdens største</li></ul><h2>Vigtige fakta</h2><ul><li>Hvert spin er <strong>fuldstændig uafhængigt</strong></li><li>Der findes ingen "varme" eller "kolde" maskiner</li><li>Danske casinoer skal have certificeret RNG</li></ul>`,
  },
  {
    slug: "paylines",
    ...
    fullContent: `<h2>Hvad er paylines?</h2><p><strong>Paylines</strong> er mønstrene på tværs af hjulene, hvor identiske symboler skaber gevinst.</p><h2>Typer</h2><h3>Faste paylines</h3><p>Fast antal linjer (f.eks. 10, 20). Book of Dead har 10 faste paylines.</p><h3>Ways to Win</h3><p>Matchende symboler på tilstødende hjul. 5×3 grid = 243 ways. Eksempel: Starburst.</p><h3>Megaways</h3><p>Varierende symbolantal per hjul, op til <strong>117.649 gevinstmuligheder</strong>. Eksempler: Bonanza, Extra Chilli.</p><h3>Cluster Pays</h3><p>Gevinster dannes ved 5+ identiske symboler i klynge. Eksempler: Reactoonz, Jammin' Jars.</p>`,
  },
  {
    slug: "bonus-runde",
    title: "Bonusrunde",
    ...
    fullContent: `<h2>Hvad er en bonusrunde?</h2><p>En <strong>bonusrunde</strong> er en ekstra spillefase med højere gevinstpotentiale end basisspillet.</p><h2>Typer</h2><h3>Free Spins</h3><p>Den mest udbredte bonustype med gratis spins og ekstra funktioner.</p><h3>Pick and Click</h3><p>Vælg mellem skjulte objekter for at afsløre præmier.</p><h3>Cascading/Tumble Wins</h3><p>Vindende symboler forsvinder og erstattes af nye. Bruges i Gates of Olympus.</p><h3>Bonus Buy</h3><p>Køb direkte adgang til bonusrunden mod 50-100x normal indsats.</p><h2>Udløsere</h2><ul><li>3+ scatter-symboler</li><li>Specifikke bonussymboler</li><li>Tilfældig trigger</li><li>Bonus Buy</li></ul>`,
  },
  {
    slug: "multiplikator",
    ...
    fullContent: `<h2>Hvad er en multiplikator?</h2><p>En <strong>multiplikator</strong> ganger din gevinst med en given faktor.</p><h2>Typer</h2><h3>Basis-multiplikator</h3><p>Fast multiplikator for alle gevinster i en funktion.</p><h3>Stigende multiplikator</h3><p>Stiger for hvert cascade-win. Bruges i Gates of Olympus.</p><h3>Tilfældig multiplikator</h3><p>Tildeles tilfældigt, op til 500x i Gates of Olympus.</p><h3>Wild multiplikator</h3><p>Wild-symboler med multiplikator-værdi. To 3x wilds = 9x.</p><h2>I populære slots</h2><ul><li><strong>Gates of Olympus</strong>: Op til 500x multiplikator-orbs</li><li><strong>Sweet Bonanza</strong>: 2x–100x multiplikator-bolsjer</li><li><strong>Money Train 3</strong>: Persistent multipliers</li></ul>`,
  },
  {
    slug: "max-bet",
    title: "Max Bet",
    ...
    fullContent: `<h2>Hvad er max bet?</h2><p><strong>Max bet</strong> refererer til den højeste indsats du kan placere per spin.</p><h2>Bonus max bet</h2><p>Typiske grænser:</p><ul><li>50 kr. per spin (mest almindeligt)</li><li>30 kr. per spin</li><li>10% af bonusbeløbet</li></ul><h2>Konsekvenser ved overskridelse</h2><ul><li>Annullering af alle gevinster</li><li>Fjernelse af bonus</li><li>Kontolukning i gentagne tilfælde</li></ul><h2>Max bet og jackpots</h2><p>Visse progressive slots kræver max bet for at kvalificere dig til hovedjackpotten.</p>`,
  },
  {
    slug: "autoplay",
    title: "Autoplay",
    ...
    fullContent: `<h2>Hvad er autoplay?</h2><p><strong>Autoplay</strong> lader dig indstille automatiske spins med din valgte indsats.</p><h2>Indstillinger</h2><ul><li>Antal spins: 10, 25, 50, 100</li><li>Tab-grænse</li><li>Gevinst-grænse</li><li>Stop ved bonus</li></ul><h2>Regulering</h2><ul><li><strong>UK (UKGC)</strong>: Har forbudt autoplay</li><li><strong>Danmark</strong>: Tilladt med stop-betingelser</li><li><strong>Sverige</strong>: 3-sekunders minimum mellem spins</li></ul><h2>Ansvarligt spil</h2><p>Autoplay kan øge risikoen for problematisk spil. Sæt altid klare grænser og tag pauser.</p>`,
  },
  {
    slug: "hit-frequency",
    title: "Hit Frequency",
    ...
    fullContent: `<h2>Hvad er hit frequency?</h2><p><strong>Hit frequency</strong> er den procentdel af spins der resulterer i en gevinst af enhver størrelse.</p><h2>Hit frequency vs. volatilitet</h2><ul><li><strong>Hit frequency</strong>: Hvor <em>ofte</em> du vinder</li><li><strong>Volatilitet</strong>: Hvor <em>meget</em> gevinsterne varierer</li></ul><h2>Typiske intervaller</h2><ul><li><strong>Høj (30%+)</strong>: Hyppige, typisk mindre gevinster</li><li><strong>Medium (20–30%)</strong>: Balanceret oplevelse</li><li><strong>Lav (under 20%)</strong>: Sjældne, typisk større gevinster</li></ul><h2>Vigtigt</h2><ul><li>Hit frequency siger <strong>intet om gevinstens størrelse</strong></li><li>Kombinér med RTP og volatilitet for det fulde billede</li><li>Oplyses sjældent af spiludviklere</li></ul>`,
  },
];
