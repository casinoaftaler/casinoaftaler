...
export const PROVIDER_HUB_CONTENT: Record<string, ProviderHubContent> = {
  "pragmatic-play": {
    ...
    introHtml: `
      ...
      <p>Hvad der særligt adskiller Pragmatic Play fra konkurrenterne er deres evne til at skabe slots med bred appel. Titler som <a href="/casinospil/spillemaskiner/sweet-bonanza">Sweet Bonanza</a>, <a href="/casinospil/spillemaskiner/gates-of-olympus">Gates of Olympus</a> og <a href="/casinospil/spillemaskiner/big-bass-bonanza">Big Bass Bonanza</a> er blevet synonyme med moderne online slots. Disse spil kombinerer cluster pays-mekanikker, tumble-features og multipliers på måder der konstant overrasker spillere.</p>
  ...
  "netent": {
    ...
    introHtml: `
      <p>NetEnt (Net Entertainment) er en af de mest ikoniske spiludviklere i online casino-historien. Grundlagt i Sverige i 1996 har NetEnt skabt nogle af industriens mest elskede spillemaskiner – fra den revolutionerende <a href="/casinospil/spillemaskiner/starburst">Starburst</a> til den grænsesøgende <a href="/casinospil/spillemaskiner/dead-or-alive-2">Dead or Alive 2</a>.</p>
  ...
  "play-n-go": {
    ...
    introHtml: `
      <p>Play'n GO har markeret sig som en af de mest produktive og innovative spiludviklere på det danske marked. Med <a href="/casinospil/spillemaskiner/book-of-dead">Book of Dead</a> som deres absolutte flagskib har det svenske studie bevist, at de kan skabe spillemaskiner der kombinerer klassisk tematik med moderne mekanikker.</p>
      <p>Det der gør Play'n GO unik er deres fokus på high volatility slots med book-mekanikken – en formel de har perfektioneret med titler som <a href="/casinospil/spillemaskiner/legacy-of-dead">Legacy of Dead</a>, <a href="/casinospil/spillemaskiner/rise-of-olympus">Rise of Olympus</a> og <a href="/casinospil/spillemaskiner/reactoonz">Reactoonz</a>-serien. Deres grid-baserede slots med cascading wins har defineret en helt ny genre indenfor online spillemaskiner.</p>
  ...
  "hacksaw-gaming": {
    ...
    introHtml: `
      ...
      <p>Med titler som <a href="/casinospil/spillemaskiner/wanted-dead-or-a-wild">Wanted Dead or a Wild</a>, <a href="/casinospil/spillemaskiner/chaos-crew">Chaos Crew</a> og <a href="/casinospil/spillemaskiner/razor-shark">Razor Shark</a> har Hacksaw Gaming skabt en nicheposition som den foretrukne udvikler for ekstrem volatilitet. Deres max win-potentiale ligger typisk mellem 10.000x og 15.000x, hvilket er blandt de højeste i industrien.</p>
  ...
  "big-time-gaming": {
    ...
    introHtml: `
      <p>Big Time Gaming (BTG) er synonymt med én ting: Megaways. Det australske studie opfandt den banebrydende mekanik i 2016 med <a href="/casinospil/spillemaskiner/bonanza">Bonanza</a>, og har siden licenseret den til næsten alle andre store udviklere. Megaways tilbyder op til 117.649 gevinstlinjer per spin, hvilket fundamentalt ændrede hvordan spillemaskiner fungerer.</p>
      <p>Udover Megaways har BTG introduceret andre innovative features som <a href="/casinospil/spillemaskiner/extra-chilli">Extra Chilli</a>'s Gamble-funktion og den populære "Bonus Buy"-mekanik, der lader spillere købe sig direkte ind i bonusrunden. Deres slots er konsekvent high volatility med max win-potentiale der typisk ligger mellem 20.000x og 50.000x.</p>
  ...
  "nolimit-city": {
    ...
    introHtml: `
      ...
      <p>Med proprietære mekanikker som xWays, xBet og xNudge har Nolimit City skabt et helt eget gameplay-univers. Titler som <a href="/casinospil/spillemaskiner/mental">Mental</a>, <a href="/casinospil/spillemaskiner/san-quentin-xways">San Quentin xWays</a> og <a href="/casinospil/spillemaskiner/tombstone-rip">Tombstone RIP</a> er berømte for deres astronomiske max win-potentiale, der kan nå op til 150.000x indsatsen.</p>
  ...
  "elk-studios": {
    ...
    introHtml: `
      ...
      <p>ELK er især kendt for deres Avalanche-mekanik og innovative bonusstrukturer. Titler som <a href="/casinospil/spillemaskiner/cygnus">Cygnus</a>, <a href="/casinospil/spillemaskiner/katmandu-gold">Katmandu Gold</a> og <a href="/casinospil/spillemaskiner/ecuador-gold">Ecuador Gold</a> har demonstreret studiets evne til at skabe unikke spilleoplevelser med dybe feature-systemer og progressive multipliers.</p>
  ...
  "yggdrasil": {
    ...
    introHtml: `
      ...
      <p>Yggdrasils slots er kendetegnet ved cinematisk grafik, 3D-animationer og unikke feature-systemer. Titler som <a href="/casinospil/spillemaskiner/vikings-go-berzerk">Vikings Go Berzerk</a>, <a href="/casinospil/spillemaskiner/valley-of-the-gods">Valley of the Gods</a> og <a href="/casinospil/spillemaskiner/hades-gigablox">Hades – Gigablox</a> viser studiets evne til at forene visuelt imponerende oplevelser med solide matematiske modeller.</p>
  ...
  "red-tiger": {
    ...
    introHtml: `
      ...
      <p>Red Tigers Daily Drop Jackpots er blevet en definerende feature – et netværk af jackpots der garanteres at falde inden for en bestemt tidsramme, hvilket skaber en unik spænding udover det traditionelle slot-gameplay. Titler som <a href="/casinospil/spillemaskiner/gonzos-quest-megaways">Gonzo's Quest Megaways</a> (i samarbejde med NetEnt) og <a href="/casinospil/spillemaskiner/piggy-riches-megaways">Piggy Riches Megaways</a> viser deres evne til at revitalisere klassikere.</p>
  ...
  "igt": {
    ...
    introHtml: `
      ...
      <p>IGTs mest ikoniske titel er uden tvivl <a href="/casinospil/spillemaskiner/cleopatra">Cleopatra</a>, der har defineret det egyptiske tema i spillemaskiner og stadig er en af de mest spillede slots globalt. Andre klassikere som <a href="/casinospil/spillemaskiner/da-vinci-diamonds">Da Vinci Diamonds</a>, <a href="/casinospil/spillemaskiner/wheel-of-fortune">Wheel of Fortune</a> og <a href="/casinospil/spillemaskiner/siberian-storm">Siberian Storm</a> er ligeledes velkendte blandt spillere verden over.</p>
