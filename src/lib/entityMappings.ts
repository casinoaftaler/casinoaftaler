...
export const ENTITY_MAPPINGS: EntityMapping[] = [
  ...
  { patterns: [/\bEvolution Gaming\b/i, /\bEvolution\b/], href: "/spiludviklere/evolution-gaming", anchor: "" },
  { patterns: [/\bPragmatic Play\b/i], href: "/spiludviklere/pragmatic-play", anchor: "Pragmatic Play" },
  { patterns: [/\bNetEnt\b/], href: "/spiludviklere/netent", anchor: "NetEnt" },
  { patterns: [/\bPlay'?n.?GO\b/i, /\bPlay n Go\b/i], href: "/spiludviklere/play-n-go", anchor: "" },
  ...
  { patterns: [/\bBooming Games\b/i], href: "/spiludviklere/booming-games", anchor: "Booming Games" },
