...
export const seoRoutes: SeoRoute[] = ([
  ...
  { path: "/er-casinoaftaler-trovaerdig", changefreq: "monthly", priority: 0.7, lastmod: "2026-03-27",
    author: "jonas", articleTitle: "Er CasinoAftaler troværdig?", articleCategory: "Trust",
    articleExcerpt: "GPWA-godkendt affiliate platform – læs om vores testmetode, team og uafhængige redaktion." },
