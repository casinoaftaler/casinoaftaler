...
export const seoRoutes: SeoRoute[] = ([
  // ── Forside ──
  { path: "/", changefreq: "daily", priority: 1.0, lastmod: "2026-03-31" },
  ...
  { path: "/casino-anmeldelser/getlucky", changefreq: "weekly", priority: 0.8, lastmod: "2026-03-21" },
  { path: "/casino-anmeldelser/mr-green", changefreq: "weekly", priority: 0.8, lastmod: "2026-03-21" },
  ...
  { path: "/casino-anmeldelser/expekt", changefreq: "weekly", priority: 0.8, lastmod: "2026-03-21" },
  ...
  { path: "/casino-anmeldelser/unibet", changefreq: "weekly", priority: 0.8, lastmod: "2026-03-21" },
  { path: "/casino-anmeldelser/bet365", changefreq: "weekly", priority: 0.8, lastmod: "2026-03-21" },
  { path: "/casino-anmeldelser/royal-casino", changefreq: "weekly", priority: 0.8, lastmod: "2026-03-08" },
  { path: "/casino-anmeldelser/maria-casino", changefreq: "weekly", priority: 0.8, lastmod: "2026-03-21" },
  { path: "/casino-anmeldelser/kapow-casino", changefreq: "weekly", priority: 0.8, lastmod: "2026-03-21" },
  { path: "/casino-anmeldelser/nordicbet", changefreq: "weekly", priority: 0.8, lastmod: "2026-03-21" },
  ...
  { path: "/casino-anmeldelser/stake-casino", changefreq: "weekly", priority: 0.8, lastmod: "2026-03-21" },
  ...
  { path: "/casinospil/blackjack", changefreq: "weekly", priority: 0.9, lastmod: "2026-03-18", author: "jonas", factCheckedBy: "kevin", articleTitle: "Blackjack Guide 2026 – Regler, Strategi & Odds", articleCategory: "Guide", articleExcerpt: "Den komplette blackjack-guide: regler, basic strategy, house edge og de bedste danske borde." },
  { path: "/casinospil/blackjack/amerikansk-blackjack", changefreq: "weekly", priority: 0.8, lastmod: "2026-03-18", author: "jonas", factCheckedBy: "kevin", articleTitle: "Amerikansk Blackjack – Hole Card Regler & Strategi", articleCategory: "Guide", articleExcerpt: "Dybdegående analyse af amerikansk blackjack: hole card-regler, peek-mekanik og strategiske forskelle." },
  { path: "/casinospil/blackjack/europaeisk-blackjack", changefreq: "weekly", priority: 0.8, lastmod: "2026-03-18", author: "jonas", factCheckedBy: "frederik", articleTitle: "Europæisk Blackjack – No Hole Card Regler & Analyse", articleCategory: "Guide", articleExcerpt: "Europæisk blackjack forklaret: no hole card, strategijusteringer og sammenligning med den amerikanske variant." },
  { path: "/casinospil/blackjack/double-exposure-blackjack", changefreq: "weekly", priority: 0.76, lastmod: "2026-03-18", author: "jonas", factCheckedBy: "kevin", articleTitle: "Double Exposure Blackjack – Åbne Kort & Tilpasset Strategi", articleCategory: "Guide", articleExcerpt: "Double Exposure blackjack: begge dealerkort er synlige, men reglerne kompenserer. Fuld strategianalyse." },
  { path: "/casinospil/blackjack/spanish-21", changefreq: "weekly", priority: 0.78, lastmod: "2026-03-18", author: "jonas", factCheckedBy: "frederik", articleTitle: "Spanish 21 – Regler, Bonusudbetalinger & Strategi", articleCategory: "Guide", articleExcerpt: "Spanish 21 uden 10'ere: bonusudbetalinger, redouble og late surrender analyseret matematisk." },
  { path: "/casinospil/blackjack/martingale", changefreq: "weekly", priority: 0.74, lastmod: "2026-03-18", author: "jonas", factCheckedBy: "frederik", articleTitle: "Martingale i Blackjack – Matematik, Risiko & Realitet", articleCategory: "Guide", articleExcerpt: "Martingale-systemet i blackjack: matematisk bevis, risk of ruin og hvorfor fordoblingsstrategien kollapser." },
  { path: "/casinospil/blackjack/fibonacci", changefreq: "weekly", priority: 0.74, lastmod: "2026-03-18", author: "jonas", factCheckedBy: "kevin", articleTitle: "Fibonacci-Systemet i Blackjack – Sekvens, Simulering & Vurdering", articleCategory: "Guide", articleExcerpt: "Fibonacci i blackjack: talrækkens mekanik, simuleret performance og sammenligning med Martingale." },
  { path: "/casinospil/blackjack/dalembert", changefreq: "weekly", priority: 0.74, lastmod: "2026-03-18", author: "jonas", factCheckedBy: "frederik", articleTitle: "D'Alembert i Blackjack – Lineær Progression & Analyse", articleCategory: "Guide", articleExcerpt: "D'Alembert-systemet i blackjack: lineær progression, stresstest og hvorfor det er mildere end Martingale." },
  { path: "/casinospil/blackjack/skema", changefreq: "weekly", priority: 0.85, lastmod: "2026-03-30", author: "jonas", factCheckedBy: "kevin", articleTitle: "Blackjack Skema – Komplet Basic Strategy Guide", articleCategory: "Guide", articleExcerpt: "Det komplette blackjack skema med farvekodede HTML-tabeller, interaktiv quiz og EV-analyse. Reducer house edge til 0,5 %." },
  { path: "/casinospil/roulette", changefreq: "weekly", priority: 0.8, lastmod: "2026-03-18", author: "jonas", factCheckedBy: "frederik", articleTitle: "Roulette Guide 2026 – Regler, Odds & Bordtyper", articleCategory: "Guide", articleExcerpt: "Komplet roulette-guide: regler, indsatstyper, house edge og sammenligning af europæisk, fransk og amerikansk." },
  { path: "/casinospil/roulette/amerikansk-roulette", changefreq: "weekly", priority: 0.7, lastmod: "2026-03-05", author: "jonas", factCheckedBy: "kevin", articleTitle: "Amerikansk Roulette – Dobbelt Nul & Matematisk Analyse", articleCategory: "Guide", articleExcerpt: "Amerikansk roulette med dobbelt nul: house edge på 5,26 %, indsatstyper og hvorfor europæisk er bedre." },
  { path: "/casinospil/roulette/europaeisk-roulette", changefreq: "weekly", priority: 0.7, lastmod: "2026-03-05", author: "jonas", factCheckedBy: "frederik", articleTitle: "Europæisk Roulette – Enkelt Nul & Odds", articleCategory: "Guide", articleExcerpt: "Europæisk roulette med enkelt nul: 2,70 % house edge, indsatstyper og strategiske valg." },
  { path: "/casinospil/roulette/fransk-roulette", changefreq: "weekly", priority: 0.7, lastmod: "2026-03-05", author: "jonas", factCheckedBy: "kevin", articleTitle: "Fransk Roulette – La Partage & Laveste House Edge", articleCategory: "Guide", articleExcerpt: "Fransk roulette med La Partage: 1,35 % house edge på lige chancer. Den mest spillervenlige variant." },
  { path: "/casinospil/roulette/dalembert-roulette", changefreq: "weekly", priority: 0.7, lastmod: "2026-03-05", author: "frederik", factCheckedBy: "jonas", articleTitle: "D'Alembert i Roulette – Lineær Strategi & Simulering", articleCategory: "Guide", articleExcerpt: "D'Alembert-systemet i roulette: lineær progression, Monte Carlo-simulering og praktisk vurdering." },
  { path: "/casinospil/roulette/martingale-roulette", changefreq: "weekly", priority: 0.7, lastmod: "2026-03-05", author: "frederik", factCheckedBy: "jonas", articleTitle: "Martingale i Roulette – Fordobling, Risiko & Kollaps", articleCategory: "Guide", articleExcerpt: "Martingale i roulette: fordoblingsstrategien analyseret med simuleringer og risk of ruin." },
  { path: "/casinospil/roulette/fibonacci-roulette", changefreq: "weekly", priority: 0.7, lastmod: "2026-03-05", author: "frederik", factCheckedBy: "jonas", articleTitle: "Fibonacci i Roulette – Talrække, Simulering & Analyse", articleCategory: "Guide", articleExcerpt: "Fibonacci-systemet i roulette: mekanik, simuleret performance og sammenligning med Martingale." },
  { path: "/casinospil/roulette/labouchere-roulette", changefreq: "weekly", priority: 0.7, lastmod: "2026-03-05", author: "jonas", factCheckedBy: "frederik", articleTitle: "Labouchère i Roulette – Cancellation System & Analyse", articleCategory: "Guide", articleExcerpt: "Labouchère-systemet: talrække-cancellation, praktisk anvendelse og matematisk vurdering." },
  { path: "/casinospil/roulette/james-bond-roulette", changefreq: "weekly", priority: 0.7, lastmod: "2026-03-05", author: "jonas", factCheckedBy: "kevin", articleTitle: "James Bond Roulette-Strategi – Indsatsfordeling & Odds", articleCategory: "Guide", articleExcerpt: "James Bond-strategien i roulette: fast indsatsfordeling, dækning og matematisk forventet tab." },
  { path: "/casinospil/poker", changefreq: "weekly", priority: 0.8, lastmod: "2026-03-18", author: "kevin", factCheckedBy: "jonas", articleTitle: "Poker Guide 2026 – Regler, Varianter & Strategi", articleCategory: "Guide", articleExcerpt: "Komplet poker-guide: regler, varianter, håndhierarki og strategi for danske spillere." },
  { path: "/casinospil/poker/texas-holdem", changefreq: "weekly", priority: 0.7, lastmod: "2026-03-05", author: "kevin", factCheckedBy: "jonas", articleTitle: "Texas Hold'em – Regler, Positioner & Strategi", articleCategory: "Guide", articleExcerpt: "Texas Hold'em fra bunden: blinds, positioner, betting-runder og pre-flop strategi." },
  { path: "/casinospil/poker/omaha", changefreq: "weekly", priority: 0.7, lastmod: "2026-03-05", author: "kevin", factCheckedBy: "jonas", articleTitle: "Omaha Poker – Fire Hole Cards & PLO Strategi", articleCategory: "Guide", articleExcerpt: "Omaha poker: fire hole cards, pot-limit-struktur og strategiske forskelle fra Hold'em." },
  { path: "/casinospil/poker/three-card-poker", changefreq: "weekly", priority: 0.7, lastmod: "2026-03-05", author: "jonas", factCheckedBy: "kevin", articleTitle: "Three Card Poker – Regler, Pair Plus & Optimal Strategi", articleCategory: "Guide", articleExcerpt: "Three Card Poker: Ante/Play, Pair Plus side bet og Queen-6-4 strategigrænsen." },
  { path: "/casinospil/poker/caribbean-stud", changefreq: "weekly", priority: 0.7, lastmod: "2026-03-05", author: "kevin", factCheckedBy: "jonas", articleTitle: "Caribbean Stud Poker – Regler, Jackpot & House Edge", articleCategory: "Guide", articleExcerpt: "Caribbean Stud poker: progressive jackpot, optimal raise-strategi og house edge-analyse." },
  { path: "/casinospil/poker/video-poker", changefreq: "weekly", priority: 0.7, lastmod: "2026-03-05", author: "jonas", factCheckedBy: "kevin", articleTitle: "Video Poker – RTP, Varianter & Optimal Strategi", articleCategory: "Guide", articleExcerpt: "Video poker: Jacks or Better, Deuces Wild og strategier der presser RTP over 99 %." },
  { path: "/casinospil/poker/poker-strategi", changefreq: "weekly", priority: 0.7, lastmod: "2026-03-05", author: "kevin", factCheckedBy: "jonas", articleTitle: "Poker Strategi – Avanceret Spilteori & Positionering", articleCategory: "Guide", articleExcerpt: "Avanceret poker-strategi: pot odds, implied odds, bluffing-frekvens og GTO-principper." },
  ...
  { path: "/casinospil/craps", changefreq: "weekly", priority: 0.8, lastmod: "2026-03-05", author: "jonas", factCheckedBy: "kevin", articleTitle: "Craps Guide 2026 – Regler, Odds & Pass Line", articleCategory: "Guide", articleExcerpt: "Craps fra bunden: pass line, don't pass, come bets og de matematisk bedste indsatser." },
  { path: "/casinospil/baccarat", changefreq: "weekly", priority: 0.8, lastmod: "2026-03-05", author: "jonas", factCheckedBy: "frederik", articleTitle: "Baccarat Guide 2026 – Regler, Banker Bet & Strategi", articleCategory: "Guide", articleExcerpt: "Baccarat forklaret: player, banker, tie-indsatser, tredje kort-regler og optimal strategi." },
  { path: "/casinospil/roulette-strategi", changefreq: "weekly", priority: 0.7, lastmod: "2026-03-21", author: "frederik", factCheckedBy: "jonas", articleTitle: "Roulette Strategi 2026 – Systemer, Odds & Bankroll", articleCategory: "Guide", articleExcerpt: "Komplet roulette-strategi: Martingale, Fibonacci, D'Alembert og bankroll-styring analyseret." },
  { path: "/casinospil/online-lotteri", changefreq: "weekly", priority: 0.8, lastmod: "2026-03-05", author: "jonas", factCheckedBy: "niklas", articleTitle: "Online Lotteri – Jackpot-Odds & Regressionsanalyse", articleCategory: "Guide", articleExcerpt: "Online lotteri i Danmark: jackpot-sandsynligheder, EV-beregninger og sammenligning af Lotto, Eurojackpot og Keno." },
  { path: "/live-casino/game-shows", changefreq: "weekly", priority: 0.8, lastmod: "2026-03-18", author: "kevin", factCheckedBy: "jonas", articleTitle: "Casino Game Shows – Underholdningens Pris i Tal", articleCategory: "Guide", articleExcerpt: "Game shows analyseret: Crazy Time, Dream Catcher, Monopoly Live – RTP, volatilitet og underholdningsværdi." },
  { path: "/casinospil/bingo", changefreq: "weekly", priority: 0.8, lastmod: "2026-03-18", author: "jonas", factCheckedBy: "kevin", articleTitle: "Online Bingo Guide 2026 – Regler, RTP & Varianter", articleCategory: "Guide", articleExcerpt: "Online bingo i Danmark: 75-kugle, 90-kugle, video bingo – RTP, regler og bedste casinoer." },
  { path: "/casinospil/keno", changefreq: "weekly", priority: 0.8, lastmod: "2026-06-06", author: "jonas", factCheckedBy: "niklas", articleTitle: "Online Keno Guide 2026 – Odds, Payout & Strategi", articleCategory: "Guide", articleExcerpt: "Keno i Danmark: sandsynlighedsmodeller, payout-tabeller og optimal antal-spots analyse." },
  { path: "/casinospil/skrabespil", changefreq: "weekly", priority: 0.8, lastmod: "2026-03-28", author: "jonas", factCheckedBy: "frederik", articleTitle: "Online Skrabespil 2026 – RTP, Odds & Sammenligning", articleCategory: "Guide", articleExcerpt: "Online skrabespil vs. fysiske lod: RTP-forskelle (85-97% vs. 50-65%), gevinstregler og bedste casinoer." },
  ...
  { path: "/indskudsbonus", changefreq: "weekly", priority: 0.8, lastmod: "2026-03-06", author: "niklas", factCheckedBy: "frederik", articleTitle: "Indskudsbonus Guide 2026", articleCategory: "Guide", articleExcerpt: "Alt om indskudsbonusser – deposit match, procentsatser og de bedste tilbud." },
  ...
  { path: "/bonus-uden-indbetaling", changefreq: "weekly", priority: 0.85, lastmod: "2026-03-18", author: "niklas", factCheckedBy: "frederik", articleTitle: "Bonus uden Indbetaling 2026", articleCategory: "Guide", articleExcerpt: "Find de bedste no-deposit bonusser hos danske casinoer – gratis bonus uden indskud." },
  ...
  { path: "/no-sticky-bonus", changefreq: "weekly", priority: 0.85, lastmod: "2026-03-18", author: "niklas", factCheckedBy: "frederik", articleTitle: "No-Sticky Bonus Guide 2026", articleCategory: "Guide", articleExcerpt: "Alt om no-sticky bonusser – hvordan de fungerer, fordele og de bedste casinoer med no-sticky." },
  { path: "/sticky-bonus", changefreq: "weekly", priority: 0.85, lastmod: "2026-03-18", author: "niklas", factCheckedBy: "frederik", articleTitle: "Sticky Bonus Guide 2026", articleCategory: "Guide", articleExcerpt: "Forstå sticky bonusser – forskellen fra no-sticky, fordele/ulemper og hvornår de er værd at bruge." },
  { path: "/cashback-bonus", changefreq: "weekly", priority: 0.85, lastmod: "2026-03-18", author: "niklas", factCheckedBy: "frederik", articleTitle: "Cashback Bonus Guide 2026", articleCategory: "Guide", articleExcerpt: "Alt om cashback bonusser – få penge retur på tab hos danske casinoer." },
  { path: "/reload-bonus", changefreq: "weekly", priority: 0.85, lastmod: "2026-03-18", author: "niklas", factCheckedBy: "frederik", articleTitle: "Reload Bonus Guide 2026", articleCategory: "Guide", articleExcerpt: "Reload bonusser for eksisterende spillere – de bedste tilbud og vilkår." },
  ...
  { path: "/forfatter/frederik", changefreq: "monthly", priority: 0.6, lastmod: "2026-03-28" },
