...
export const seoRoutes: SeoRoute[] = ([
  ...
  { path: "/casinospil/spillemaskiner/big-bad-wolf", changefreq: "weekly", priority: 0.8, lastmod: "2026-03-13" },
  { path: "/casinospil/spillemaskiner/buffalo-rising-megaways", changefreq: "weekly", priority: 0.8, lastmod: "2026-03-13" },
  { path: "/casinospil/spillemaskiner/chilli-pop", changefreq: "weekly", priority: 0.8, lastmod: "2026-03-13" },
  { path: "/casinospil/spillemaskiner/classic-fruits", changefreq: "weekly", priority: 0.8, lastmod: "2026-03-13" },
  { path: "/casinospil/spillemaskiner/cygnus", changefreq: "weekly", priority: 0.8, lastmod: "2026-03-13" },
  { path: "/casinospil/spillemaskiner/esqueleto-explosivo-2", changefreq: "weekly", priority: 0.8, lastmod: "2026-03-13" },
  { path: "/casinospil/spillemaskiner/gold-vein", changefreq: "weekly", priority: 0.8, lastmod: "2026-03-13" },
  { path: "/casinospil/spillemaskiner/hot-spin-deluxe", changefreq: "weekly", priority: 0.8, lastmod: "2026-03-13" },
  { path: "/casinospil/spillemaskiner/magic-hot", changefreq: "weekly", priority: 0.8, lastmod: "2026-03-13" },
  { path: "/casinospil/spillemaskiner/mystery-reels-megaways", changefreq: "weekly", priority: 0.8, lastmod: "2026-03-13" },
  { path: "/casinospil/spillemaskiner/satoshis-secret", changefreq: "weekly", priority: 0.8, lastmod: "2026-03-13" },
  { path: "/casinospil/spillemaskiner/tombstone-rip", changefreq: "weekly", priority: 0.8, lastmod: "2026-03-13" },
  { path: "/casinospil/spillemaskiner/vikings-go-berzerk", changefreq: "weekly", priority: 0.8, lastmod: "2026-03-13" },
