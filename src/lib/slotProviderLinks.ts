...
const SLOT_DISPLAY_NAMES: Record<string, string> = {
  ...
  "cleopatra": "Cleopatra",
  "tombstone-rip": "Tombstone RIP",
  "vikings-go-berzerk": "Vikings Go Berzerk",
  "esqueleto-explosivo-2": "Esqueleto Explosivo 2",
  "cygnus": "Cygnus",
  "mystery-reels-megaways": "Mystery Reels Megaways",
  "buffalo-rising-megaways": "Buffalo Rising Megaways",
  "big-bad-wolf": "Big Bad Wolf",
  "hot-spin-deluxe": "Hot Spin Deluxe",
  "chilli-pop": "Chilli Pop",
  "magic-hot": "Magic Hot",
  "satoshis-secret": "Satoshi's Secret",
  "classic-fruits": "Classic Fruits",
  "gold-vein": "Gold Vein",
