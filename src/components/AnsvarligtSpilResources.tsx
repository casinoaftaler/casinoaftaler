...
const ALL_RESOURCES: SpilResource[] = [
  { to: "/ansvarligt-spil", title: "Ansvarligt Spil", desc: "Komplet guide til ansvarligt casinospil i Danmark", iconName: "shield-check" },
  ...
  { to: "/casino-licenser", title: "Casino Licenser", desc: "Forstå det danske licenssystem", iconName: "book-open" },
];
  ...
  return (
    <section className="mb-12">
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        {resources.map(({ to, title, desc, iconName }) => (
          <Link
            key={to}
            to={to}
