...
export const MENU_ICON_MAP: Record<string, string> = {
  ...
  "check-circle": img("check-circle-green.webp"),
  "play": img("play-button.webp"),
  "external-link": img("external-link.webp"),
  "user": img("user-avatar.webp"),
  "bar-chart-3": img("chart-stats.webp"),
  "calendar-days": img("calendar-check.webp"),
  "volume-2": img("headphones.webp"),
  "x-circle": img("shield-off.webp"),
  "loader-2": img("reload-refresh.webp"),
  "thumbs-up": img("medal-award.webp"),
  "thumbs-down": img("shield-off.webp"),
  "settings": img("strategy-table.webp"),
  "filter": img("scale-compare.webp"),
  "download": img("arrow-strategy.webp"),
  "upload": img("arrow-strategy.webp"),
  "refresh-ccw": img("reload-refresh.webp"),
  "message-circle": img("mail-envelope.webp"),
  "help-circle": img("info-circle.webp"),
  "phone": img("mobile-casino.webp"),
  "map-pin": img("target-aim.webp"),

  // Aliases & additional mappings
  "arrow-right": img("arrow-strategy.webp"),
  "ban": img("shield-off.webp"),
  "bar-chart3": img("chart-stats.webp"),
  "battery": img("lightning-fast.webp"),
  "bell": img("info-circle.webp"),
  "building": img("building-game.webp"),
  "building2": img("building-game.webp"),
  "check-circle2": img("check-circle-green.webp"),
  "code": img("strategy-table.webp"),
  "cpu": img("slot-machine.webp"),
  "dice-3": img("dice-craps.webp"),
  "dice1": img("dice-craps.webp"),
  "dices": img("dice-craps.webp"),
  "dollar-sign": img("dollar-circle.webp"),
  "file-check": img("clipboard-check.webp"),
  "fingerprint": img("scan-id.webp"),
  "gamepad2": img("gamepad-fun.webp"),
  "gauge": img("trending-rtp.webp"),
  "gavel": img("scale-compare.webp"),
  "grid3x3": img("strategy-table.webp"),
  "hand-heart": img("heart-handshake.webp"),
  "handshake": img("heart-handshake.webp"),
  "hourglass": img("clock-time.webp"),
  "key": img("lock-secure.webp"),
  "lightbulb": img("sun-warm.webp"),
  "link2": img("chain-linked.webp"),
  "megaphone": img("party-popper.webp"),
  "message-square": img("mail-envelope.webp"),
  "more-horizontal": img("info-circle.webp"),
  "package": img("gift-bonus.webp"),
  "pen": img("file-text.webp"),
  "rocket": img("lightning-fast.webp"),
  "rotate-ccw": img("reload-refresh.webp"),
  "scan": img("scan-id.webp"),
  "server": img("database.webp"),
  "shuffle": img("reload-refresh.webp"),
  "square": img("slot-machine.webp"),
  "store": img("shopping-bag.webp"),
  "timer": img("clock-time.webp"),
  "unlock": img("lock-secure.webp"),
  "user-check": img("user-avatar.webp"),
  "video": img("play-video.webp"),
  "volume2": img("headphones.webp"),
  "wifi": img("globe-earth.webp"),
};
