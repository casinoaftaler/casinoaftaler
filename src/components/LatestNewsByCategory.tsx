...
const PAGE_CATEGORY_MAP: Record<string, { categories: string[]; tags: string[]; label: string }> = {
  ...
  "/casinospil/blackjack": { categories: ["nye-casinoer"], tags: ["blackjack", "online blackjack", "blackjack regler", "basic strategy"], label: "blackjack" },
  "/casinospil/blackjack/amerikansk-blackjack": { categories: ["nye-casinoer"], tags: ["blackjack", "amerikansk blackjack", "hole card", "live blackjack"], label: "amerikansk blackjack" },
  "/casinospil/blackjack/europaeisk-blackjack": { categories: ["nye-casinoer"], tags: ["blackjack", "europæisk blackjack", "ENHC", "OBO"], label: "europæisk blackjack" },
  "/casinospil/blackjack/double-exposure-blackjack": { categories: ["nye-casinoer"], tags: ["blackjack", "double exposure", "blackjack variant"], label: "Double Exposure blackjack" },
  "/casinospil/blackjack/spanish-21": { categories: ["nye-casinoer"], tags: ["blackjack", "Spanish 21", "blackjack variant"], label: "Spanish 21" },
  "/casinospil/blackjack/martingale": { categories: ["nye-casinoer"], tags: ["blackjack", "martingale", "betting system"], label: "Martingale blackjack" },
  "/casinospil/blackjack/fibonacci": { categories: ["nye-casinoer"], tags: ["blackjack", "fibonacci", "betting system"], label: "Fibonacci blackjack" },
  "/casinospil/blackjack/dalembert": { categories: ["nye-casinoer"], tags: ["blackjack", "d'alembert", "betting system"], label: "D'Alembert blackjack" },
