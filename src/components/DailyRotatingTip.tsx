 ...
 */
const TIPS: Tip[] = [
  { text: "Vidste du, at alle gevinster fra online casinoer med dansk licens er 100 % skattefri?", linkText: "Læs mere om ansvarligt spil", linkTo: "/ansvarligt-spil" },
  { text: "No-sticky bonusser lader dig hæve gevinster uden omsætningskrav – en stor fordel for spilleren.", linkText: "Se casinoer med no-sticky bonus", linkTo: "/no-sticky-bonus" },
  ...
  { text: "Danske casinoer skal overholde et maksimalt omsætningskrav på 10x ifølge Spillemyndigheden.", linkText: "Forstå omsætningskrav", linkTo: "/omsaetningskrav" },
  { text: "Live casino giver dig den autentiske casinooplevelse med rigtige dealere fra din sofa.", linkText: "Prøv live casino", linkTo: "/live-casino" },
  ...
  { text: "Spillemyndigheden fører løbende tilsyn med alle danske licenserede casinoer.", linkText: "Se compliance-status", linkTo: "/casino-licenser" },
  ...
  { text: "Pragmatic Play, NetEnt og Play'n GO er blandt de mest populære spiludbydere i Danmark.", linkText: "Udforsk spiludbydere", linkTo: "/spiludviklere/pragmatic-play" },
  ...
  { text: "Nolimit City og Hacksaw Gaming er kendt for high-volatility slots med store gevinstpotentialer.", linkText: "Se Nolimit City slots", linkTo: "/spiludviklere/nolimit-city" },
];
