...
import { Badge, Check, ChevronDown, Info, Link, RotateCcw, Star } from "lucide-react"
        ...
        >
          ...
          <div className="flex flex-col p-5 pt-4">
            ...
            <div className="flex items-center justify-between mt-3">
              ...
              {["spilleautomaten", "spildansknu", "campobet", "betinia", "swift-casino", "luna-casino", "playkasino"].includes(casino.slug) && (
                <Link
