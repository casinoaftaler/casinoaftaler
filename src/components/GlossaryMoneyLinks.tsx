...
import { ArrowRight, BarChart3, CreditCard, Database, Filter, Gift, Play, Sparkles, Star } from "lucide-react"
...
const CATEGORY_MONEY_LINKS: Record<string, MoneyLink[]> = {
  ...
  "Spillemaskiner": [
    ...
    { to: "/slot-database", label: "Slot Database", icon: BarChart3, desc: `${SLOT_COUNT_LABEL} slots med community-data` },
  ],
  "Grundbegreber": [
...
const SLUG_OVERRIDES: Record<string, MoneyLink[]> = {
  "rtp": [
    ...
    { to: "/slot-database", label: "Slot Database", icon: BarChart3, desc: `Sammenlign RTP på ${SLOT_COUNT_LABEL} slots` },
