...
export function CommunitySeoBridge() {
  ...
  const isSlotPage =
    pathname.startsWith("/community/slots");

  // Reorder: put Spillemaskiner first on slot pages
  const links = isSlotPage
    ? [
        BASE_LINKS[4], // Spillemaskiner
        BASE_LINKS[0], // Casino Bonus
        BASE_LINKS[1], // Nye Casinoer
        BASE_LINKS[2], // Casino Anmeldelser
        BASE_LINKS[3], // Live Casino
      ]
    : BASE_LINKS;
