...
const slotDatabaseHub: GuideLink = { to: "/slot-database", label: "Slot Database", icon: BarChart3, desc: "1.470+ slots med community-data og statistik" };: GuideLink = { to: "/slot-database", label: "Slot Database", icon: BarChart3, desc: "1.470+ slots med community-data og statistik" };" };
...
const allReviews: GuideLink[] = [
  ...
  { to: "/casino-anmeldelser/playkasino", label: "PlayKasino", icon: Star, desc: "SkillOnNet-casino med 10x omsætning og mobilapp" },
