    ...
    <>
      ...
      <div className="container py-8 md:py-12">
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">Mr Green Casino tilbyder en <Link to="/velkomstbonus" className={linkClass}>velkomstbonus</Link> på op til 3.000 kr. plus free spins til nye spillere. Bonussen er typisk fordelt over de første indbetalinger, og <Link to="/omsaetningskrav" className={linkClass}>omsætningskravene</Link> følger den danske standard på 10x (indskud + bonus). Det er et fair tilbud, men ikke markedets mest generøse – og det er et bevidst valg fra Mr Greens side.</p>
          ...
          <Card className="border-border bg-card mb-6">
            ...
            <CardContent>
              <div className="grid grid-cols-1 sm:grid-cols-4 gap-3 text-center">
                <div className="rounded-lg border border-border p-3"><p className="text-xs text-muted-foreground">Indskud + Bonus</p><p className="text-xl font-bold text-foreground">6.000 kr.</p></div>
                <div className="rounded-lg border border-border p-3"><p className="text-xs text-muted-foreground">× 10 omsætning</p><p className="text-xl font-bold text-foreground">= 60.000 kr.</p></div>
                <div className="rounded-lg border border-border p-3"><p className="text-xs text-muted-foreground">Stat. tab (96% RTP)</p><p className="text-xl font-bold text-foreground">~2.400 kr.</p></div>
                <div className="rounded-lg border border-border p-3"><p className="text-xs text-muted-foreground">Reel bonusværdi</p><p className="text-xl font-bold text-foreground">~600 kr.</p></div>
              </div>
            </CardContent>
          </Card>

          <p className="mb-4 text-muted-foreground leading-relaxed">Lad os beregne den reelle bonusværdi: Ved fuld udnyttelse af 3.000 kr.-bonussen med et tilsvarende indskud har du 6.000 kr. at spille for. Med 10x omsætningskrav skal du gennemspille 60.000 kr. Ved en gennemsnitlig RTP på 96% er det statistisk forventede tab under gennemspilningen ~2.400 kr. – hvilket giver en teoretisk nettogevinst på ~600 kr. fra bonussen. Det er en solid reel værdi, særligt fordi Mr Greens kuraterede spiludvalg typisk har højere gennemsnitlig RTP end markeder med mange lavkvalitetsspil.</p>
