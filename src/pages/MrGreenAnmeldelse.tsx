    ...
    <>
      ...
      <div className="container py-8 md:py-12">
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">Mr Greens mest innovative feature er det patenterede Green Gaming-værktøj, der analyserer dine spillemønstre og giver en personlig risikovurdering. Det er et værktøj, der sætter <Link to="/ansvarligt-spil" className={linkClass}>ansvarligt spil</Link> i centrum og gør Mr Green til en pioner inden for spillerbeskyttelse. Ingen anden operatør på det danske marked tilbyder et tilsvarende avanceret system til proaktiv spillerbeskyttelse.</p>
