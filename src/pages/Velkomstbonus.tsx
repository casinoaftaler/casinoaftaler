...
import { Badge, Calculator, Clock, CreditCard, Dog, Gamepad2, Gift, Link, ListChecks, Lock, Minus, ShieldCheck, Sparkles, Target, TrendingUp, Trophy, User, Users } from "lucide-react"
  ...
  return (
    <>
      ...
      <ContentPageLayout>
        ...
        <QuickComparisonTable count={3} title="Velkomstbonus – top 3 tilbud" prioritySlugs={["betinia", "spilleautomaten", "playkasino"]} />
...
{/* Intro */}
        ...
        <ReviewScreenshot
          ...
          alt="Velkomstbonus-popup hos Pip.dk med 100% bonus op til 1.000 kr. og mulighed for at vælge ja eller nej til bonus"
          caption="Velkomstbonus-valg hos Pip.dk – vælg 'Ja til bonus' eller spil uden for at starte (kilde: pip.dk)"
          size="medium"
        />
