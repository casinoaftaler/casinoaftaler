...
const SpilDanskNuAnmeldelse = () => {
  ...
  const reviewJsonLd = { "@context": "https://schema.org", "@type": "Review", itemReviewed: { "@type": "Organization", name: "SpilDanskNu", url: "https://www.spildansknu.dk" }, author: { "@type": "Organization", name: "Casinoaftaler" }, reviewRating: { "@type": "Rating", ratingValue: "4.6", bestRating: "5", worstRating: "1" }, reviewBody: "SpilDanskNu er et dansk online casino med lavt omsætningskrav, over 2.500 spilleautomater, loyalitetsprogram og hurtige udbetalinger." };
