...
const TrustlyGuide = () => {
  return (
    <PaymentMethodPage
      ...
      faqs={[
        { question: "Er Trustly sikkert?", answer: "Ja, Trustly bruger bankens egne sikkerhedsstandarder, MitID-godkendelse og er reguleret af svenske Finansinspektionen." },
        { question: "Kvalificerer Trustly til velkomstbonus?", answer: (
          <>Ja, Trustly behandles som bankoverførsel og kvalificerer til alle{" "}<Link to="/velkomstbonus" className="text-primary underline hover:text-primary/80">velkomstbonusser</Link>.</>
        )},
        { question: "Hvad er Pay N Play?", answer: "En funktion der lader dig spille uden traditionel registrering – du identificerer dig via Trustly og MitID." },
        { question: "Hvor hurtigt er Trustly-udbetalinger?", answer: "Ofte inden for minutter, men det kan tage op til 24 timer afhængigt af casinoet." },
        { question: "Er der gebyrer ved Trustly?", answer: "Nej, Trustly opkræver ingen gebyrer fra spilleren." },
      ]}
