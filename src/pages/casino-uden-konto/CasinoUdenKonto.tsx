...
import { Apple, ArrowRight, Badge, Ban, CreditCard, Eye, Landmark, Link, Lock, Play, Scale, Zap } from "lucide-react"
  ...
  return (
    <>
      ...
      <ContentPageLayout>
        ...
        <QuickComparisonTable count={3} title="Casino uden konto – top 3 picks" prioritySlugs={["swift-casino", "spilleautomaten", "betinia"]} />
