...
const ELKStudiosGuide = () => (
  <ProviderPage
    ...
    historyIntro="ELK Studios startede med en vision om at skabe spilleautomater der var visuelt og teknisk overlegne – en vision de har realiseret med tålmodighed og konsistens over mere end et årti."
    timeline={[
    ...
    licensesContent={
      <>
        ...
        <p className="text-muted-foreground leading-relaxed">
          ELK Studios har aldrig modtaget regulatoriske sanktioner eller bøder fra nogen jurisdiktion – en rekord der understreger deres compliance-kultur. I en branche hvor selv store aktører som Entain og Flutter har modtaget millionbøder, er ELK Studios' plettede regeloverholdelse bemærkelsesværdig. Deres spil er tilgængelige via Spillemyndigheden-licenserede danske casinoer og opfylder alle krav til dansk regulering.
        </p>
      </>
    }
    pros={[
      "Precision Spins-teknologi – unik og eCOGRA-certificeret bankroll-innovation ingen konkurrent tilbyder",
      "Exceptionel visuel og auditiv kvalitet – 6-9 måneders udvikling per titel med cinematisk finish",
      ...
      "Adskillige EGR Awards – den højeste pris-per-titel-ratio i branchen",
      "Walking Wilds med retningsbestemt AI – en mekanik de har perfektioneret over otte titler",
    ]}
    cons={[
      "80 titler mod konkurrenters 200-300+ – begrænset lobby-synlighed på danske casinoer",
      "1-2 nye spil per måned – spillere der søger nyheder ofte kan finde kadencen frustrerende",
      "Ingen live casino, bordspil, progressive jackpots eller social gaming-produkter",
      "Maks. gevinster typisk op til 10.000-25.000x – lavere end high-volatility-konkurrenter",
    ]}
    faqs={[
      {
