...
import { AlertTriangle, Badge, Ban, Calculator, Check, Clock, Dog, DollarSign, Gamepad2, Gift, Link, Lock, Minus, Scale, ShieldCheck, Target, TrendingUp, Users, X } from "lucide-react"
...
{/* Intro */}
        ...
        <section className="mb-12">
          ...
          <ReviewScreenshot
            ...
            alt="LeoVegas sticky bonus betingelser – 100% kontantbonus op til 1.000 kr. med 10x omsætningskrav på Casino"
            caption="LeoVegas – typiske sticky bonus-betingelser: 100% op til 1.000 kr., 10x omsætning, kun spilleautomater tæller"
            size="medium"
          />
        </section>
