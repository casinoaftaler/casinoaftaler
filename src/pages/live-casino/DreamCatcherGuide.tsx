...
import { Activity, Badge, Dices, DollarSign, Gauge, Link, Table, Timer } from "lucide-react"
    ...
    <>
      ...
      <ContentPageLayout>
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">
            Men sammenlignet med mange online <Link to="/casinospil/spillemaskiner" className={linkClass}>spillemaskiner</Link> (500+ spins/time × 3-5 % HE = 750-1.250 kr./time) er Dream Catcher faktisk billigere, fordi tempoet er langsommere (70 spins/time vs. 500+). Denne tempo-effekt er vigtig: selvom Dream Catchers house edge pr. spin er højere end mange slots, er den totale time-action lavere pga. det langsomme tempo – og dermed er det samlede forventede tab pr. time lavere.
          </p>
          <p className="text-muted-foreground leading-relaxed">
