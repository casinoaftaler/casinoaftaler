...
import udbydereLobbySS from "@/assets/screenshots/live-casino-udbydere-lobby.webp";
...
import { Badge, Building, Cpu, Link, Play, Timer } from "lucide-react"
  ...
  return (
    <>
      ...
      <ContentPageLayout>
        ...
        <QuickComparisonTable count={3} title="Flest live-udbydere – top 3" prioritySlugs={["campobet", "luna-casino", "swift-casino"]} />
