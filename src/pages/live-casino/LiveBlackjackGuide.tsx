...
import {
  Sparkles, ShieldCheck, Target, Brain, BarChart3, Users, AlertTriangle, Timer, Zap,
} from "lucide-react";
    ...
    <>
      ...
      <div className="container py-8 md:py-12">
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">
            Målet er simpelt: slå dealeren ved at komme tættere på 21 uden at gå over. Billedkort tæller 10, es tæller 1 eller 11, og alle andre kort tæller deres pålydende. En "blackjack" – et es plus et 10-værdikort – udbetaler typisk 3:2 (1,5x din indsats), men visse borde udbetaler kun 6:5, hvilket øger house edge med hele 1,39 procentpoint.
          </p>
          <p className="mb-4 text-muted-foreground leading-relaxed">
            I live blackjack bruger de fleste borde et <strong>8-deck shoe</strong>, som blandes efter at ca. 50 % af kortene er brugt (cut card-position). Dealeren står på soft 17 i de fleste europæiske varianter – en regel, der reducerer house edge med 0,22 % sammenlignet med "dealer hits soft 17". Du kan double down på alle to startkort, splitte par op til 3 gange (4 hænder total), og surrender er sjældent tilgængeligt.
          </p>
        ...
        <section className="mb-12">
          <h2 className="mb-4 text-3xl font-bold">
            Basisstrategien – det matematisk optimale valg
          </h2>
          <p className="mb-4 text-muted-foreground leading-relaxed">
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-border">
                      ...
                      <th className="py-2 px-4 text-left">Forventet tab/time (50 kr. indsats, 60 hænder)</th>
                    </tr>
                  </thead>
                  <tbody className="text-muted-foreground">
                    ...
                    <tr className="border-b border-border/50">
                      <td className="py-2 px-4 font-medium">Erfaren spiller uden strategi-chart</td>
        ...
        <section className="mb-12">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Konklusion: Card counting fungerer ikke i live casino online. Fokusér i stedet på perfekt basisstrategi – den giver 0,50 % house edge, som er lavere end næsten alle andre spilformer. Supplér med disciplineret bankroll management, og du har den mest fordelagtige spilleoplevelse, live casino tilbyder.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">
            House edge i live blackjack er ikke et fast tal – det varierer baseret på specifikke regler ved dit bord. At forstå disse variationer er afgørende for at vælge det optimale bord og maksimere din RTP.
          </p>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-border">
                      ...
                      <th className="py-2 px-4 text-left">Effect på House Edge</th>
                    </tr>
                  </thead>
                  <tbody className="text-muted-foreground">
                    <tr className="border-b border-border/50">
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">
            Ikke alle live blackjack-borde er skabt lige. Evolution Gaming alene tilbyder 10+ varianter, hver med unikke regler, tempi og strategiske implikationer. At vælge den rigtige variant er næsten lige så vigtigt som at mestre basisstrategien.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <Card className="border-border bg-card">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Den originale live blackjack-oplevelse med maksimalt 7 spillere pr. bord. Fordelen er det mest autentiske tempo og den bedste sociale interaktion. Ulempen er ventetid – hvis bordet er fuldt, skal du vente. House edge: 0,50 % med basisstrategi. Minimumsindsats: typisk 50-100 kr.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-border bg-card">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Ubegrænset antal spillere. Alle modtager de samme startkort men træffer individuelle beslutninger. Lavere minimumsindsats (fra 5 kr.) og ingen ventetid. "Six Card Charlie"-reglen (auto-win med 6 kort uden bust) sænker house edge marginalt. Perfekt for nybegyndere og bankroll-bevidste spillere.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-border bg-card">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Tilfældige RNG-multiplikatorer (2x-25x) tilføjes til vindende hænder. For at finansiere multiplikatorerne betaler du et "Lightning Fee" på 100 % af din indsats. RTP er 99,56 % – marginalt højere end standard, men volatiliteten er markant øget. For spillere, der søger store gevinster med lav indsats.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-border bg-card">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  De hurtigste spillere handler først – ingen ventetid på langsomme medspillere. Reducer beslutningshastigheden til 10-12 sekunder og spil op til 80+ hænder/time. Samme regler og house edge som Classic. Ideel for erfarne spillere, der kender basisstrategien udenad og vil maksimere antal hænder.
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">
            Selv med den laveste house edge i live casino kan dårlig bankroll management føre til hurtige tab. Blackjack har en standardafvigelse på ca. 1,15 pr. enhed pr. hånd – det betyder, at kortsigtede udsving er uundgåelige, selv med perfekt spil.
          </p>
          <p className="mb-4 text-muted-foreground leading-relaxed">
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">
            Tempo er en af de mest undervurderede faktorer i gambling-matematik. House edge fortæller dig, hvor meget du taber pr. krone spillet – men tempo fortæller dig, hvor mange kroner du spiller pr. time. Produktet af de to bestemmer dit faktiske tab.
          </p>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-border">
                      ...
                      <th className="py-2 px-4 text-left">House Edge</th>
                      <th className="py-2 px-4 text-left">Forventet tab/time (50 kr.)</th>
                    </tr>
                  </thead>
                  <tbody className="text-muted-foreground">
                    <tr className="border-b border-border/50">
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">
            Sidebets er designet til at øge casinoets profit ved at tilbyde høje udbetalinger med endnu højere house edge. De er det modsatte af intelligent spil – men de er ekstremt populære, fordi de appellerer til spilleres ønske om store gevinster.
          </p>
          <p className="mb-4 text-muted-foreground leading-relaxed">
            <strong>Perfect Pairs:</strong> Bet på at dine to startkort danner et par. Mixed pair udbetaler 6:1, coloured pair 12:1, perfect pair 25:1. House edge varierer fra 2,17 % (gunstig regel) til 11,25 % (dårlig regel). <strong>21+3:</strong> Dine to kort plus dealerens synlige kort vurderes som en poker-hånd. Flush udbetaler 5:1, straight 10:1, three-of-a-kind 30:1, straight flush 40:1, suited trips 100:1. House edge: ca. 3,24 %.
          </p>
          <p className="text-muted-foreground leading-relaxed">
        ...
        {/* ═══ H2 #9 – Hvem bør/bør ikke ═══ */}
        <section className="mb-12">
          <h2 className="mb-4 text-3xl font-bold">
            Hvem bør spille live blackjack – og hvem bør vælge andet?
          </h2>
          <p className="mb-4 text-muted-foreground leading-relaxed">
            Live blackjack er ikke for alle. Det er et strategisk spil, der belønner tålmodighed, disciplin og vilje til at lære. Her er en ærlig vurdering af, hvem der får mest ud af det.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <Card className="border-primary/20 bg-card">
              ...
              <CardContent>
                <ul className="text-sm text-muted-foreground space-y-2">
                  ...
                  <li>• Værdsætter strategisk dybde i casinospil</li>
                  <li>• Har tålmodighed til længere sessioner med lavere tempo</li>
                  <li>• Er disciplineret med bankroll management</li>
                </ul>
              </CardContent>
            </Card>
            <Card className="border-destructive/20 bg-card">
              ...
              <CardContent>
                <ul className="text-sm text-muted-foreground space-y-2">
                  <li>• Søger ren underholdning uden at lære regler</li>
                  <li>• Foretrækker store jackpots og høj volatilitet</li>
                  <li>• Ikke vil bruge tid på at studere strategi</li>
                  <li>• Har svært ved at holde dig til en fast plan under pres</li>
                  <li>• Vil spille kort sessioner under 20 minutter</li>
                </ul>
              </CardContent>
            </Card>
          </div>
          <p className="text-muted-foreground leading-relaxed">
            Hvis du foretrækker underholdning og høj volatilitet uden strategi, er <Link to="/live-casino/monopoly-live" className={linkClass}>Monopoly Live</Link> eller <Link to="/live-casino/lightning-roulette" className={linkClass}>Lightning Roulette</Link> bedre valg. Disse spil har højere house edge, men kræver ingen beslutninger og tilbyder massive gevinstpotentialer.
          </p>
        </section>

        <Separator className="my-10" />

        {/* ═══ H2 #10 – Ansvarligt spil specifikt for live blackjack ═══ */}
        <section className="mb-12">
          <h2 className="mb-4 text-3xl font-bold">
            Ansvarligt spil ved live blackjack-bordet
          </h2>
          <p className="mb-4 text-muted-foreground leading-relaxed">
            Live blackjack har unikke risikofaktorer, der adskiller det fra andre casinospil. Det langsommere tempo kan paradoksalt nok føre til, at spillere forbliver ved bordet i længere tid – den sociale interaktion med dealeren og følelsen af kontrol kan maskere det akkumulerede tab.
          </p>
          <p className="mb-4 text-muted-foreground leading-relaxed">
            <strong>Tilt-management:</strong> "Tilt" – tilstanden hvor frustration over tab fører til irrationelle beslutninger – er en af de største trusler i live blackjack. Typiske tilt-tegn: du begynder at afvige fra basisstrategien, øger indsatsen for at "vinde tabene tilbage", eller tager sidebets, du normalt ville undgå. Hvis du opdager disse tegn, er det tid til at stoppe.
          </p>
          <p className="text-muted-foreground leading-relaxed">
            Sæt altid en <strong>tabsgrænse</strong> og en <strong>tidsgrænse</strong> før sessionen begynder. De fleste danske licenserede casinoer tilbyder indbetalingsgrænser og session-reminders. Har du brug for hjælp, kontakt <strong>StopSpillet</strong> (70 22 28 25) eller selvudeluk via <strong>ROFUS</strong>. Casino er underholdning – ikke en indtægtskilde. Du skal være 18+ for at spille.
          </p>
        </section>
