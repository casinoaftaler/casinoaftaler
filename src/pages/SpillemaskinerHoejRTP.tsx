...
import { Activity, Dices, Dog, Gauge, LineChart, Link, Play, Table } from "lucide-react"
  ...
  return (
    <>
      ...
      <ContentPageLayout>
        ...
        <QuickComparisonTable count={3} title="Højeste RTP – top 3 casinoer" prioritySlugs={["spilleautomaten", "betinia", "campobet"]} />
...
{/* ── H2 1: Hvad betyder RTP egentlig – matematisk forklaring ── */}
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">
            Sammenlign dette med andre casinospil: <Link to="/casinospil/blackjack" className={linkClass}>blackjack</Link> med optimal strategi har ca. 0,5 % house edge, <Link to="/casinospil/baccarat" className={linkClass}>baccarat</Link> (Banker) har 1,06 %, og <Link to="/casinospil/roulette" className={linkClass}>europæisk roulette</Link> har 2,7 %. De fleste spillemaskiner har altså højere house edge end klassiske bordspil – men med den fordel, at spillemaskiner kræver ingen strategisk viden og tilbyder langt mere varieret underholdning.
          </p>
          <p className="text-muted-foreground leading-relaxed">
