    ...
    <>
      ...
      <div className="container py-8 md:py-12">
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">Ud over de eksklusive spil har One Casino et solidt – men ikke imponerende – katalog fra etablerede udbydere. Cirka 800 titler fra NetEnt, Play'n GO, <Link to="/spiludviklere/microgaming" className={linkClass}>Microgaming</Link> og <Link to="/spiludviklere/pragmatic-play" className={linkClass}>Pragmatic Play</Link>. Du finder de mest populære slots som Book of Dead, Starburst, Gonzo's Quest, Reactoonz og Sweet Bonanza – de titler, som 80% af casual spillere efterspørger. Men kataloget mangler dybde ud over mainstream-favoritterne.</p>
            ...
            <Card className="border-border bg-card">
              ...
              <CardContent>
                <ul className="space-y-3">
                  ...
                  <li className="text-sm text-muted-foreground"><strong className="text-foreground">Casual spillere:</strong> Du spiller lejlighedsvist, holder dig til de 20-30 mest populære slots og behøver ikke tusindvis af titler. One Casino dækker det basale med NetEnt, Play'n GO og Pragmatic Play.</li>
