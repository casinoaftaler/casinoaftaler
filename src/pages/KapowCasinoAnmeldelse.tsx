    ...
    <>
      ...
      <div className="container py-8 md:py-12">
          ...
          <Card className="border-border bg-card border-l-4 border-l-primary">
            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                <div className="rounded-lg border border-border p-3"><p className="text-xs text-muted-foreground uppercase mb-1">Velkomstbonus</p><p className="text-lg font-bold text-foreground">100 Spins (ved 100 kr.)</p></div>
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">Kapow Casino opererer i Danmark med licens fra <Link to="/spillemyndigheden" className={linkClass}>Spillemyndigheden</Link> og er fuldt tilsluttet ROFUS. Spiludvalget tæller over 1.200 titler fra respekterede udbydere. Velkomstbonussen giver 100 Spins til Gates of Olympus ved en overførsel på 100 kr. med 10x <Link to="/omsaetningskrav" className={linkClass}>omsætningskrav</Link>. Men den reelle test er, om substansen bag den eksplosive branding holder i en dybdegående analyse – og det er hvad vores <Link to="/saadan-tester-vi-casinoer" className={linkClass}>testmetode</Link> afslører.</p>
