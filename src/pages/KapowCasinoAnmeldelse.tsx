...
const kapowFaqs: { question: string; answer: ReactNode }[] = [
  ...
  { question: "Hvilken velkomstbonus tilbyder Kapow Casino, og hvad er den reelt værd?", answer: (<>Kapow Casino tilbyder en <Link to="/velkomstbonus" className={linkClass}>velkomstbonus</Link> med 100 % match op til 2.000 kr. plus 50 <Link to="/free-spins" className={linkClass}>free spins</Link> ved første indbetaling. <Link to="/omsaetningskrav" className={linkClass}>Omsætningskravet</Link> er 10x (indskud + bonus). Med en indbetaling på 1.000 kr. får du 2.000 kr. at spille for med 20.000 kr. i omsætningskrav. Med 96 % gennemsnitlig RTP forventer du statistisk et tab på 800 kr. under omsætning, hvilket giver en reel bonusværdi på cirka 1.200 kr. – gennemsnitligt for det danske marked.</>) },
  { question: "Hvordan er Kapow Casinos spiludvalg sammenlignet med konkurrenterne?", answer: (<>Kapow Casino har 1.200+ spil – markant færre end <Link to="/casino-anmeldelser/mr-vegas" className={linkClass}>Mr Vegas</Link> (3.000+) eller <Link to="/casino-anmeldelser/leovegas" className={linkClass}>LeoVegas</Link> (2.000+), men tilstrækkeligt til at dække de mest populære titler. Udbydere som <Link to="/spiludviklere/netent" className={linkClass}>NetEnt</Link>, <Link to="/spiludviklere/play-n-go" className={linkClass}>Play'n GO</Link>, <Link to="/spiludviklere/nolimit-city" className={linkClass}>Nolimit City</Link> og <Link to="/spiludviklere/pragmatic-play" className={linkClass}>Pragmatic Play</Link> er repræsenteret. Inklusionen af Nolimit City er en fordel for high-volatility-spillere.</>) },
...
const KapowCasinoAnmeldelse = () => {
  ...
  const reviewJsonLd = { "@context": "https://schema.org", "@type": "Review", itemReviewed: { "@type": "Organization", name: "Kapow Casino", url: "https://www.kapowcasino.dk/" }, author: { "@type": "Organization", name: "Casinoaftaler" }, reviewRating: { "@type": "Rating", ratingValue: "3.9", bestRating: "5", worstRating: "1" }, reviewBody: "Kapow Casino er en energisk platform med et solidt spiludvalg og generøse bonusser, men det polariserende design og manglen på premium-polish trækker ned." };
  return (
    <>
      ...
      <div className="container py-8 md:py-12">
          ...
          <Card className="border-border bg-card border-l-4 border-l-primary">
            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                <div className="rounded-lg border border-border p-3"><p className="text-xs text-muted-foreground uppercase mb-1">Velkomstbonus</p><p className="text-lg font-bold text-foreground">Op til 2.000 kr. + 50 FS</p></div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-center mt-4">
                ...
                <div className="rounded-lg border border-border p-3"><p className="text-xs text-muted-foreground uppercase mb-1">Udbetaling</p><p className="text-lg font-bold text-foreground">24t–4 hverdage</p></div>
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">Kapow Casino opererer i Danmark med licens fra <Link to="/spillemyndigheden" className={linkClass}>Spillemyndigheden</Link> og er fuldt tilsluttet ROFUS. Spiludvalget tæller over 1.200 titler fra respekterede udbydere. Velkomstbonussen er konkurrencedygtig med 100 % match op til 2.000 kr. plus 50 <Link to="/free-spins" className={linkClass}>free spins</Link>. Men den reelle test er, om substansen bag den eksplosive branding holder i en dybdegående analyse – og det er hvad vores <Link to="/saadan-tester-vi-casinoer" className={linkClass}>testmetode</Link> afslører.</p>
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">Første indbetaling på 1.000 kr. via Trustly blev krediteret på 11 sekunder. Velkomstbonussen på 1.000 kr. (100 % match) plus 50 free spins på Book of Dead blev aktiveret automatisk. Omsætningskravet er 10x (indskud + bonus) = 20.000 kr. Vi startede med free spins-komponentet, der gav en samlet gevinst på 185 kr. – lidt under gennemsnittet, men inden for normal varians.</p>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="border-border bg-card"><CardHeader className="pb-2"><CardTitle className="flex items-center gap-2 text-lg text-primary"><Check className="h-5 w-5" />Fordele</CardTitle></CardHeader><CardContent><ul className="space-y-2">{["Solidt spiludvalg med 1.200+ titler fra kvalitetsudbydere", "Nolimit City inkluderet – sjældent på denne prisklasse", "Dansk licens fra Spillemyndigheden og ROFUS", "Generøs velkomstbonus med 100 % match + free spins", "Progressive jackpots inkl. Mega Moolah", "Hurtige Trustly-udbetalinger (22t 45min i vores test)", "Daglige kampagner og cashback-tilbud", "Mobil-optimeret platform der fungerer på alle enheder"].map((p) => (<li key={p} className="flex items-start gap-2 text-sm"><Check className="h-4 w-4 text-emerald-500 flex-shrink-0 mt-0.5" /><span className="text-muted-foreground">{p}</span></li>))}</ul></CardContent></Card>
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">Kapow Casinos <Link to="/velkomstbonus" className={linkClass}>velkomstbonus</Link> er en 100 % matchbonus op til 2.000 kr. plus 50 free spins på Book of Dead. <Link to="/omsaetningskrav" className={linkClass}>Omsætningskravet</Link> er 10x (indskud + bonus), og alle slots bidrager 100 % til omsætningen. Lad os regne på det.</p>
          <p className="mb-4 text-muted-foreground leading-relaxed">Med en maksimal indbetaling på 2.000 kr. modtager du 2.000 kr. i bonus = 4.000 kr. total spillesaldo. Omsætningskrav: 10x × 4.000 = 40.000 kr. Med 96 % gennemsnitlig slots-RTP forventer du at miste 4 % af 40.000 = 1.600 kr. under omsætning. Din forventede nettværdi er altså 2.000 kr. bonus minus 1.600 kr. forventet tab = 400 kr. i reel bonusværdi. Tilføj free spins-gevinster (vores test gav 185 kr.), og den samlede forventede værdi er cirka 585 kr.</p>
          <p className="mb-4 text-muted-foreground leading-relaxed">Sammenlignet med <Link to="/casino-anmeldelser/mr-vegas" className={linkClass}>Mr Vegas</Link> (op til 4.000 kr. bonus med estimeret EV på 1.200-1.500 kr.) eller <Link to="/casino-anmeldelser/betano" className={linkClass}>Betano</Link> er Kapow Casinos bonus gennemsnitlig. Den er ikke dårlig – 10x omsætningskrav er fair, og free spins på Book of Dead er en populær titel – men den skiller sig ikke ud i et marked med mange generøse tilbud.</p>
        ...
        {/* Spiludvalg */}
        <section className="mb-12">
          <h2 className="mb-4 text-3xl font-bold">1.200 spil – kvalitet vs. kvantitet</h2>
          <p className="mb-4 text-muted-foreground leading-relaxed">Med 1.200+ titler placerer Kapow Casino sig i midterfeltet af det danske marked. Det er markant færre end <Link to="/casino-anmeldelser/mr-vegas" className={linkClass}>Mr Vegas</Link> (3.000+) og <Link to="/casino-anmeldelser/leovegas" className={linkClass}>LeoVegas</Link> (2.000+), men flere end <Link to="/casino-anmeldelser/marathonbet" className={linkClass}>MarathonBet</Link> (600+) og mange andre niche-platforme. Spørgsmålet er, om udvalget er godt kurateret – og svaret er: delvist.</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
            <Card className="border-border bg-card"><CardHeader className="pb-2"><CardTitle className="flex items-center gap-2 text-lg"><Gamepad2 className="h-5 w-5 text-primary" />Spilleautomater</CardTitle></CardHeader><CardContent><p className="text-sm text-muted-foreground">900+ slots fra 7+ udbydere. Nolimit City inkluderet – et sjældent plus i denne prisklasse. Megaways, Bonus Buy og cluster pays repræsenteret.</p></CardContent></Card>
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed"><strong>Kapow vs. <Link to="/casino-anmeldelser/mr-vegas" className={linkClass}>Mr Vegas</Link>:</strong> Mr Vegas har et markant større spiludvalg (3.000+ vs. 1.200+), hurtigere udbetalinger (14t vs. 22t) og Betsson-gruppens overlegne infrastruktur. Kapow vinder kun på Nolimit City-inklusion (som Mr Vegas faktisk også har) og cashback-kampagner. For de fleste spillere er Mr Vegas det objektivt bedre valg i denne sammenligning.</p>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-5 gap-4 mb-6">
            {[{ label: "Spiludvalg", score: "7/10" }, { label: "Bonus", score: "7/10" }, { label: "Design", score: "6/10" }, { label: "Sikkerhed", score: "8/10" }, { label: "Samlet", score: "3.9/5" }].map((i) => (<div key={i.label} className="rounded-lg border border-border bg-card p-4 text-center"><p className="text-xs text-muted-foreground uppercase mb-1">{i.label}</p><p className="text-2xl font-bold text-primary">{i.score}</p></div>))}
          </div>
