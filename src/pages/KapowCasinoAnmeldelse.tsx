...
const kapowFaqs: { question: string; answer: ReactNode }[] = [
  { question: "Er Kapow Casino lovligt i Danmark?", answer: (<>Ja, Kapow Casino opererer med dansk licens (nr. 16 0015962) fra Spillemyndigheden og er tilsluttet <a href="https://www.rofus.nu/" target="_blank" rel="noopener noreferrer" className={linkClass}>ROFUS</a>. Platformen drives af Unity Group ApS, der kører casinoet på SkillOnNet-platformen. Alle danske krav til <Link to="/ansvarligt-spil" className={linkClass}>ansvarligt spil</Link> overholdes, inklusiv MitID-verifikation ved oprettelse og ROFUS-tjek.</>) },
  { question: "Hvem ejer Kapow Casino, og er de pålidelige?", answer: "Kapow Casino ejes af Unity Group ApS og kører på SkillOnNet-platformen. Licensen (nr. 16 0015962) er udstedt af Spillemyndigheden til Unity Group ApS. SkillOnNet-platformen driver 30+ casino-brands globalt og har licenser fra Malta Gaming Authority og UK Gambling Commission. Unity Group ApS er et dansk selskab, der opererer under dansk lovgivning, hvilket giver en ekstra sikkerhed for danske spillere." },
    ...
    <>
      ...
      <section className="relative overflow-hidden py-12 text-white md:py-20" style={{ backgroundImage: heroBackgroundImage ? `linear-gradient(135deg, hsl(260 70% 25% / 0.95), hsl(210 80% 30% / 0.9)), url(${heroBackgroundImage})` : "linear-gradient(135deg, hsl(260 70% 25%), hsl(250 60% 20%) 40%, hsl(210 80% 25%))", backgroundSize: "cover", backgroundPosition: "center" }}>
        <div className="container"><div className="mx-auto max-w-3xl text-center">
          <Badge variant="secondary" className="mb-4"><MenuIcon iconName="zap" className="mr-1.5 h-3.5 w-3.5" />3.9 / 5 – Energisk Nykommer</Badge>
      ...
      <ContentPageLayout>
        ...
        <section className="mb-12">
          <Card className="border-border bg-card border-l-4 border-l-primary">
            <CardHeader><CardTitle className="flex items-center gap-2 text-xl"><MenuIcon iconName="zap" className="h-6 w-6 text-primary" />Hurtige Fakta – Kapow Casino</CardTitle></CardHeader>
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-4 text-center">
                ...
                <div className="rounded-lg border border-border p-2 sm:p-3 min-w-0"><p className="text-[10px] sm:text-xs text-muted-foreground uppercase mb-1 truncate">Ejer</p><p className="text-sm sm:text-lg font-bold text-foreground break-words leading-tight">Unity Group ApS</p></div>
              </div>
        ...
        {/* Introduktion */}
        <section className="mb-12">
          <h2 className="mb-4 text-3xl font-bold">Unity Group ApS og SkillOnNet-platformen bag den eksplosive branding</h2>
          <p className="mb-4 text-muted-foreground leading-relaxed">Første gang du lander på Kapow Casino, er det svært at ignorere den visuelle identitet. Comic-inspireret grafik, eksplosive farver og onomatopoetiske lydeffekter ("KAPOW!") signalerer en platform, der bevidst gør oprør mod den typiske skandinaviske casino-minimalisme. Det er et designvalg, der enten tiltrækker eller frastøder – og det er præcis den polarisering, ejerne bag Kapow Casino sigter efter.</p>
          <p className="mb-4 text-muted-foreground leading-relaxed">Kapow Casino ejes af Unity Group ApS og kører på SkillOnNet-platformen. Unity Group ApS er det danske selskab, der holder den danske licens (nr. 16 0015962) fra Spillemyndigheden. SkillOnNet Ltd, som leverer den tekniske platform, blev grundlagt i 2005 og har hovedsæde i Malta. SkillOnNet driver 30+ casino-brands globalt – herunder PlayOJO, SpinGenie og Slingo – med licenser fra Malta Gaming Authority og UK Gambling Commission. Det er ikke en Betsson eller Flutter i størrelse, men det er heller ikke en fly-by-night startup.</p>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card className="border-border bg-card"><CardHeader className="pb-2"><CardTitle className="flex items-center gap-2 text-lg text-destructive/80"><X className="h-5 w-5" />Ulemper</CardTitle></CardHeader><CardContent><ul className="space-y-2">{["Polariserende comic-design – ikke for alle smag", "Omsætningstracker opdaterer med 10-15 min forsinkelse", "Unity Group ApS er en mindre operatør – ikke børsnoteret", "Kundeservice lukker kl. 22:00 – ingen døgndækning", "Mobilnavigation kræver for mange klik", "Færre eksklusive kampagner end etablerede konkurrenter", "Ingen dedikeret mobilapp", "Langsommere udbetalinger end premium-platforme"].map((c) => (<li key={c} className="flex items-start gap-2 text-sm"><X className="h-4 w-4 text-destructive flex-shrink-0 mt-0.5" /><span className="text-muted-foreground">{c}</span></li>))}</ul></CardContent></Card>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
            <Card className="border-border bg-card"><CardHeader className="pb-2"><CardTitle className="flex items-center gap-2 text-lg"><MenuIcon iconName="gamepad2" className="h-5 w-5 text-primary" />Spilleautomater</CardTitle></CardHeader><CardContent><p className="text-sm text-muted-foreground">1.500+ slots fra 7+ udbydere. Nolimit City inkluderet – et sjældent plus i denne prisklasse. Megaways, Bonus Buy og cluster pays repræsenteret.</p></CardContent></Card>
            <Card className="border-border bg-card"><CardHeader className="pb-2"><CardTitle className="flex items-center gap-2 text-lg"><MenuIcon iconName="trophy" className="h-5 w-5 text-primary" />Live Casino</CardTitle></CardHeader><CardContent><p className="text-sm text-muted-foreground"><Link to="/live-casino" className={linkClass}>Live casino</Link> fra <Link to="/spiludviklere/evolution-gaming" className={linkClass}>Evolution Gaming</Link> med roulette, blackjack, baccarat og game shows. 50+ borde tilgængelige i peak-timer.</p></CardContent></Card>
            <Card className="border-border bg-card"><CardHeader className="pb-2"><CardTitle className="flex items-center gap-2 text-lg"><MenuIcon iconName="sparkles" className="h-5 w-5 text-primary" />Jackpots</CardTitle></CardHeader><CardContent><p className="text-sm text-muted-foreground">Progressive jackpots via Microgaming (Mega Moolah) og Red Tiger daglige jackpots. Præmiepuljer der regelmæssigt overstiger 50 mio. kr.</p></CardContent></Card>
          </div>
        </section>
        ...
        <ReviewAlternativeCTA partnerSlug="spildansknu" headline="Søger du et dansk casino med bedre bonus?" reason="SpilDanskNu leverer en generøs velkomstbonus, dansk licens og MobilePay – med et langt større spiludvalg." ctaText="Besøg SpilDanskNu" />
        ...
        {/* Sikkerhed */}
        <section className="mb-12">
          <h2 className="mb-4 text-3xl font-bold">Regulering under Unity Group ApS</h2>
          <p className="mb-4 text-muted-foreground leading-relaxed">Kapow Casino opererer under dansk licens (nr. 16 0015962) fra Spillemyndigheden, udstedt til Unity Group ApS. Den tekniske platform leveres af SkillOnNet Ltd, der også har licenser fra Malta Gaming Authority og UK Gambling Commission. SkillOnNet har drevet online casinoer siden 2005 uden større regulatoriske sanktioner – en vigtig indikator for pålidelighed. SSL-kryptering (256-bit) beskytter alle transaktioner.</p>
          <p className="mb-4 text-muted-foreground leading-relaxed">ROFUS-tilslutning og <Link to="/ansvarligt-spil" className={linkClass}>ansvarligt spil</Link>-værktøjer er implementeret som krævet af dansk lovgivning. Indskudsgrænser, tabsgrænser og selvudelukkelse er tilgængelige. Spillermidler opbevares på separate konti. Unity Group ApS er ansvarlig for overholdelse af dansk regulering, mens SkillOnNets compliance-team håndterer audits fra de øvrige regulatoriske myndigheder.</p>
          <p className="text-muted-foreground leading-relaxed">Den vigtigste forbehold er, at hverken Unity Group ApS eller SkillOnNet er børsnoterede. Det betyder, at der er mindre finansiel gennemsigtighed sammenlignet med børsnoterede operatører som Betsson Group, Flutter Entertainment eller FDJ United (tidl. Kindred Group). For de fleste spillere er dette ikke et praktisk problem – licenserne fra tre respekterede myndigheder giver tilstrækkelig sikkerhed – men det er en faktor, der bør nævnes i en ærlig anmeldelse.</p>
        ...
        <section className="mb-12">
          <h2 className="mb-4 text-3xl font-bold flex items-center gap-2"><MenuIcon iconName="alert-triangle" className="h-7 w-7 text-destructive" />Når Kapow Casino ikke er det rette match</h2>
        ...
        <section className="mb-12">
          <h2 className="mb-4 text-3xl font-bold">Kapow Casinos markedsposition – Unity Group ApS' strategi i Danmark</h2>
          <p className="mb-4 text-muted-foreground leading-relaxed">For at forstå Kapow Casinos plads i det danske marked er det nødvendigt at analysere den bredere strategi. Unity Group ApS ejer og driver Kapow Casino i Danmark med licens nr. 16 0015962, mens SkillOnNet leverer den tekniske platform der også driver 30+ casino-brands globalt – en "white-label plus"-model, hvor hvert brand har en unik visuel identitet og marketingstrategi, men deler den underliggende teknologiplatform, betalingsinfrastruktur og spiludbyder-integrationer. Det er en effektiv forretningsmodel, der minimerer driftsomkostninger men også begrænser, hvor unikt hvert enkelt brand kan være.</p>
          ...
          <p className="text-muted-foreground leading-relaxed">En vigtig observation er, at hverken Unity Group ApS eller SkillOnNet er børsnoterede. Det betyder lavere finansiel gennemsigtighed sammenlignet med Betsson Group (Nasdaq Stockholm), FDJ United (tidl. Kindred Group) eller Flutter Entertainment (London Stock Exchange). For spillere er den praktiske konsekvens minimal – licenserne fra tre respekterede myndigheder (MGA, UKGC, Spillemyndigheden) giver tilstrækkelig sikkerhed. Men fra et analyseperspektiv gør den manglende børsnotering det sværere at vurdere den finansielle sundhed og langsigtede levedygtighed. Det er en risikofaktor, der bør nævnes, uden at overdrive den.</p>
        </section>
        ...
        <section className="mb-12">
          ...
          <Card className="border-border bg-card my-6">
            <CardHeader><CardTitle className="flex items-center gap-2 text-lg"><MenuIcon iconName="trending-up" className="h-5 w-5 text-primary" />EV-beregning: Kapow Casino samlet værdiskabelse (første 3 måneder)</CardTitle></CardHeader>
        ...
        <section className="mb-12">
          <h2 className="mb-4 text-3xl font-bold">Kapow Casinos fremtid – kan Unity Group ApS levere premium-polish?</h2>
