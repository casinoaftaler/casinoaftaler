...
const KapowCasinoAnmeldelse = () => {
  ...
  const reviewJsonLd = { "@context": "https://schema.org", "@type": "Review", itemReviewed: { "@type": "Organization", name: "Kapow Casino", url: "https://www.kapowcasino.dk/" }, author: { "@type": "Organization", name: "Casinoaftaler" }, reviewRating: { "@type": "Rating", ratingValue: "3.7", bestRating: "5", worstRating: "1" }, reviewBody: "Kapow Casino er en energisk platform med et solidt spiludvalg og generøse bonusser, men det polariserende design og manglen på premium-polish trækker ned." };
  return (
    <>
