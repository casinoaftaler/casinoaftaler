...
const kapowFaqs: { question: string; answer: ReactNode }[] = [
  ...
  { question: "Hvilken velkomstbonus tilbyder Kapow Casino, og hvad er den reelt værd?", answer: (<>Kapow Casino tilbyder en <Link to="/velkomstbonus" className={linkClass}>velkomstbonus</Link> med 100 % match op til 1.000 kr. plus 50 <Link to="/free-spins" className={linkClass}>free spins</Link> ved første indbetaling. <Link to="/omsaetningskrav" className={linkClass}>Omsætningskravet</Link> er 10x (indskud + bonus). Med en indbetaling på 1.000 kr. får du 2.000 kr. at spille for med 20.000 kr. i omsætningskrav. Med 96 % gennemsnitlig RTP forventer du statistisk et tab på 800 kr. under omsætning, hvilket giver en reel bonusværdi på cirka 200 kr. – svarende til det danske markedsgennemsnit.</>) },
    ...
    <>
      ...
      <div className="container py-8 md:py-12">
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">Kapow Casino opererer i Danmark med licens fra <Link to="/spillemyndigheden" className={linkClass}>Spillemyndigheden</Link> og er fuldt tilsluttet ROFUS. Spiludvalget tæller over 1.200 titler fra respekterede udbydere. Velkomstbonussen er konkurrencedygtig med 100 % match op til 1.000 kr. plus 50 <Link to="/free-spins" className={linkClass}>free spins</Link>. Men den reelle test er, om substansen bag den eksplosive branding holder i en dybdegående analyse – og det er hvad vores <Link to="/saadan-tester-vi-casinoer" className={linkClass}>testmetode</Link> afslører.</p>
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">Kapow Casinos <Link to="/velkomstbonus" className={linkClass}>velkomstbonus</Link> er en 100 % matchbonus op til 1.000 kr. plus 50 free spins på Book of Dead. <Link to="/omsaetningskrav" className={linkClass}>Omsætningskravet</Link> er 10x (indskud + bonus), og alle slots bidrager 100 % til omsætningen. Lad os regne på det.</p>
          <p className="mb-4 text-muted-foreground leading-relaxed">Med en maksimal indbetaling på 1.000 kr. modtager du 1.000 kr. i bonus = 2.000 kr. total spillesaldo. Omsætningskrav: 10x × 2.000 = 20.000 kr. Med 96 % gennemsnitlig slots-RTP forventer du at miste 4 % af 20.000 = 800 kr. under omsætning. Din forventede nettoværdi er altså 1.000 kr. bonus minus 800 kr. forventet tab = 200 kr. i reel bonusværdi. Tilføj free spins-gevinster (vores test gav 185 kr.), og den samlede forventede værdi er cirka 385 kr.</p>
          <p className="mb-4 text-muted-foreground leading-relaxed">Sammenlignet med <Link to="/casino-anmeldelser/comeon" className={linkClass}>ComeOn</Link> (1.000 kr. bonus med 5x omsætning – estimeret EV på 800 kr.) er Kapow Casinos bonus gennemsnitlig. Den er ikke dårlig – 10x omsætningskrav er fair, og free spins på Book of Dead er en populær titel – men den skiller sig ikke ud i et marked med mange generøse tilbud.</p>
