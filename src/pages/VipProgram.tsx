  ...
  return (
    <>
      <SEO
        ...
        description="Alt om VIP-programmer hos danske casinoer: Tier-systemer, comp points, cashback vs. reload bonus, matematisk EV-analyse og de bedste loyalitetsprogrammer i Danmark."
