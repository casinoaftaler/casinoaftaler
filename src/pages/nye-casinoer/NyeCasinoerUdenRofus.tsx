    ...
    <>
      ...
      <div className="container py-8 md:py-12">
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">
            Disse casinoer har typisk udenlandske licenser – oftest fra Curaçao (billigst og mindst reguleret), Malta Gaming Authority (mere velrenommeret, men uden dansk beskyttelse) eller helt ulicenserede operatører. De markedsfører sig aggressivt mod danske spillere med tilsyneladende attraktive bonusser og løfter om "ingen begrænsninger", men bag facaden mangler de fundamentale spillerbeskyttelser.
          </p>
          <p className="mb-4 text-muted-foreground leading-relaxed">
