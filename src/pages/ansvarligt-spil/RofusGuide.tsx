      ...
      <div className="container py-8 md:py-12">
        ...
        <section className="mb-12">
          ...
          <p className="text-muted-foreground mb-6 leading-relaxed">
            ROFUS er ét element i en bredere strategi for ansvarligt spil i Danmark. Udforsk
            vores andre guides for at lære mere om spillerbeskyttelse, lovgivning og casinoer
            med dansk licens.
          </p>
