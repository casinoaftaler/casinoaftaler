...
import { Activity, ArrowRight, Badge, Ban, Calculator, Clock, Gavel, Link, Shield, Timer, TrendingDown, Users, Wallet } from "lucide-react"
        ...
        <div className="container">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="text-lg text-white/80">
              Alt om indbetalingsgrænser, tidsgrænser, tabsgrænser, PGSI-selvtest og lovkrav (BEK 1494).
            </p>
          </div>
        </div>
      </section>
