      ...
      <div className="container py-8 md:py-12">
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="border-border bg-card"><CardHeader className="pb-2"><CardTitle className="flex items-center gap-2 text-lg text-primary"><Check className="h-5 w-5" />Fordele</CardTitle></CardHeader><CardContent><ul className="space-y-2">{["Generøs velkomstbonus op til 1.000 kr. + 200 FS", "Enormt spiludvalg med 3.000+ titler fra 25+ udbydere", "Del af Betsson Group med 60+ års erfaring", "Dansk licens fra Spillemyndigheden + ROFUS", "Hurtige udbetalinger – Trustly på under 15 timer i vores test", "Moderne og visuelt tiltalende design", "Stærkt live casino med Evolution Gaming og Pragmatic Live", "Mange betalingsmetoder tilpasset Danmark inkl. MobilePay", "Realtids-bonustracker der viser omsætningsprogression", "Automatisk KYC via MitID – ingen manuelle uploads nødvendige"].map((p) => (<li key={p} className="flex items-start gap-2 text-sm"><Check className="h-4 w-4 text-emerald-500 flex-shrink-0 mt-0.5" /><span className="text-muted-foreground">{p}</span></li>))}</ul></CardContent></Card>
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed"><strong>Mr Vegas vs. <Link to="/casino-anmeldelser/leovegas" className={linkClass}>LeoVegas</Link>:</strong> LeoVegas vinder på mobiloplevelse (dedikeret app, hurtigere indlæsning) og live casino (branded borde). Begge tilbyder 100% match op til 1.000 kr. (dansk lovmæssigt maksimum) med 10x omsætningskrav. Mr Vegas vinder på spiludvalgets bredde (3.000+ vs. 2.000+). Begge har fremragende sikkerhed – LeoVegas via MGM Resorts, Mr Vegas via Betsson Group.</p>
