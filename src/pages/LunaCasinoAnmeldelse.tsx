    ...
    <>
      ...
      <div className="container py-8 md:py-12">
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">
            <strong className="text-foreground">Hvad kurateringen betyder i praksis.</strong> Under vores 14-dages test bemærkede vi, at browsing-oplevelsen var markant anderledes end hos volumen-casinoer. Hos et casino med 5.000+ spil kan du bruge 15–20 minutter på at finde noget interessant – hos Luna Casino fandt vi kvalitetsspil inden for 2–3 klik. Filtreringssystemet er simpelt men effektivt med kategorier som "Populære", "Nye", "Jackpots" og provider-filtrering.
          </p>
          <p className="mb-4 text-muted-foreground leading-relaxed">
