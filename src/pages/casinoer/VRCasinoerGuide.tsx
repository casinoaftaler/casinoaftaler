    ...
    <>
      ...
      <div className="container py-8 md:py-12">
        ...
        <section className="mb-12">
          ...
          <p className="text-muted-foreground leading-relaxed">Vi anbefaler stærkt, at alle VR casinospillere fastsætter klare tids- og budgetgrænser inden de logger ind, og bruger de tilgængelige <Link to="/responsible-gaming" className={linkClass}>selvbegrænsningsværktøjer</Link>. Start altid med korte sessioner og øg gradvist, og tag regelmæssige pauser fra headsettet for at opretholde kontakten med omverdenen.</p>
        </section>
