    ...
    <>
      ...
      <div className="container py-8 md:py-12">
        ...
        <div className="mb-10 overflow-hidden rounded-xl">
          <img src={heroImage} alt="Spil casino for sjov – gratis casinospil" width={1920} height={600} className="w-full h-auto object-cover max-h-[400px]" loading="eager" />
        </div>
        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-6">
            ...
            <Card className="border-border bg-card"><CardContent className="pt-6"><h3 className="font-bold mb-3 text-lg">2. Bonus uden indbetaling</h3><p className="text-sm text-muted-foreground mb-3"><Link to="/bonus-uden-indbetaling" className={linkClass}>Bonusser uden indbetaling</Link> giver dig rigtige penge at spille for – typisk 50–200 kr. – uden at du skal indsætte noget selv. Du kan vinde rigtige penge, men der gælder <Link to="/omsaetningskrav" className={linkClass}>omsætningskrav</Link> typisk på 20-40x bonusbeløbet. Kræver oprettelse af konto med MitID-verifikation.</p><Badge className="bg-yellow-500/20 text-yellow-500">Kan vinde rigtige penge</Badge></CardContent></Card>
