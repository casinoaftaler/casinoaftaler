    ...
    <>
      ...
      <div className="container py-8 md:py-12">
        ...
        <section className="mb-12">
          ...
          <p className="text-muted-foreground leading-relaxed">Det sikreste valg er altid et casino med <Link to="/licenserede-casinoer" className={linkClass}>dansk licens</Link>, hvor skattefriheden er 100 % garanteret ved lov. Selv hvis du finder et attraktivt tilbud på et Curaçao-licenseret casino, kan skattekonsekvenserne æde en enorm del af dine gevinster – ud over den manglende forbrugerbeskyttelse.</p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-muted-foreground leading-relaxed">Det enkleste og sikreste er at undgå hele problemstillingen ved at spille på et <Link to="/licenserede-casinoer" className={linkClass}>dansk licenseret casino</Link>, hvor alle gevinster er 100 % skattefri. Dermed behøver du aldrig bekymre dig om selvangivelse, dokumentation eller skattemæssige konsekvenser.</p>
        </section>
