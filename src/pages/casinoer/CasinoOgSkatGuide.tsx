...
import { AlertTriangle, Badge, Bitcoin, BookOpen, Calculator, Coins, FileText, Gem, Globe, HelpCircle, Landmark, Link, Scale, Shield, Star, TrendingUp } from "lucide-react"
  ...
  return (
    <>
      ...
      <ContentPageLayout>
        ...
        <QuickComparisonTable count={3} title="Skattefrie casinoer – top 3" prioritySlugs={["spildansknu", "betinia", "campobet"]} />
