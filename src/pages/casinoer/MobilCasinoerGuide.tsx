...
const faqs: { question: string; answer: ReactNode }[] = [
  ...
  { question: "Er mobil casino lige så sikkert som desktop?", answer: (<>Ja, sikkerheden er identisk. <Link to="/licenserede-casinoer" className={linkClass}>Licenserede danske casinoer</Link> bruger den samme 256-bit SSL-kryptering og MitID-verifikation på mobil som på desktop. Faktisk kan mobil være endnu sikrere takket være biometrisk autentificering som Face ID og fingeraftryk.</>) },
  { question: "Kan jeg få casino bonus på mobilen?", answer: (<>Absolut. Alle <Link to="/casino-bonus" className={linkClass}>casino bonusser</Link> er tilgængelige på mobil – velkomstbonusser, <Link to="/free-spins" className={linkClass}>free spins</Link>, reload-bonusser og mere. Bonusvilkårene er identiske uanset enhed, og nogle casinoer tilbyder endda eksklusive mobilbonusser.</>) },
    ...
    <>
      ...
      <div className="container py-8 md:py-12">
        ...
        <section className="mb-12">
          ...
          <p className="text-muted-foreground mb-6">Alle <Link to="/licenserede-casinoer" className={linkClass}>licenserede danske casinoer</Link> bruger den samme 256-bit SSL/TLS-kryptering på mobil som på desktop. Dine data er krypteret under transport, og casinoerne overholder strenge sikkerhedsstandarder pålagt af Spillemyndigheden og PCI DSS (Payment Card Industry Data Security Standard).</p>
