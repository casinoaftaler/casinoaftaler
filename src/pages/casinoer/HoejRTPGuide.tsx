    ...
    <>
      ...
      <div className="container py-8 md:py-12">
        ...
        <section className="mb-12">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Uregulerede casinoer uden dansk licens er ikke underlagt disse krav og kan teoretisk manipulere RTP-værdier uden konsekvenser. Det er endnu en grund til altid at vælge <Link to="/licenserede-casinoer" className={linkClass}>licenserede casinoer</Link> med fuld dansk regulering. Din sikkerhed og fair spil bør altid være prioritet nummer ét.
          </p>
        </section>
