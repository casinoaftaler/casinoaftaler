...
const MariaCasinoAnmeldelse = () => {
  ...
  const reviewJsonLd = buildReviewSchema({ itemName: "Maria Casino", itemUrl: "https://www.mariacasino.dk/", ratingValue: "3.9", ratingCount: "138", reviewBody: "Maria Casino tilbyder en unik kombination af bingo og casinospil med et venligt design og dansk licens under Kindred Group. Stærk på inkludering og social spil, men bonusser og spiludvalg er gennemsnitlige." });
  return (
    <>
