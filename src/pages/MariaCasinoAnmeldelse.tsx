...
const mariaFaqs: { question: string; answer: ReactNode }[] = [
  { question: "Er Maria Casino lovligt i Danmark?", answer: (<>Ja, Maria Casino opererer med dansk licens fra Spillemyndigheden via Unibet Denmark Limited under Kindred Group. Platformen er tilsluttet <a href="https://www.rofus.nu/" target="_blank" rel="noopener noreferrer" className={linkClass}>ROFUS</a> og overholder alle danske regler for <Link to="/ansvarligt-spil" className={linkClass}>ansvarligt spil</Link>. Kindred Group (nu en del af FDJ United) var tidligere børsnoteret (nu del af FDJ United).</>) },
    ...
    <>
      ...
      <section className="relative overflow-hidden py-12 text-white md:py-20" style={{ backgroundImage: heroBackgroundImage ? `linear-gradient(135deg, hsl(260 70% 25% / 0.95), hsl(210 80% 30% / 0.9)), url(${heroBackgroundImage})` : "linear-gradient(135deg, hsl(260 70% 25%), hsl(250 60% 20%) 40%, hsl(210 80% 25%))", backgroundSize: "cover", backgroundPosition: "center" }}>
        <div className="container"><div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mb-6 text-lg text-white/80">Opdateret anmeldelse af Maria Casino – Kindred Groups venlige casinoplatform med 1.500+ slots, 270+ live spil og bred betalingsunderstøttelse inkl. PayPal og MobilePay.</p>
        </div></div>
      </section>
      <div className="container py-8 md:py-12">
        ...
        <section className="mb-10">
          <Card className="border-border bg-card border-l-4 border-l-primary">
            ...
            <CardContent className="flex flex-col gap-3">
              ...
              <Link to="/casino-med-mobilepay" className="inline-flex items-center justify-between rounded-lg border border-border bg-background px-4 py-3 font-medium text-primary transition-colors hover:bg-muted/40 hover:underline">Se casinoer med MobilePay</Link>
            </CardContent>
          </Card>
        </section>
          ...
          <Card className="border-border bg-card border-l-4 border-l-primary">
            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                <div className="rounded-lg border border-border p-3"><p className="text-xs text-muted-foreground uppercase mb-1">Velkomstbonus</p><p className="text-lg font-bold text-foreground">100 kr. gratis</p></div>
                ...
                <div className="rounded-lg border border-border p-3"><p className="text-xs text-muted-foreground uppercase mb-1">Operatør</p><p className="text-lg font-bold text-foreground">Kindred Group</p></div>
              </div>
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-center mt-4">
                <div className="rounded-lg border border-border p-3"><p className="text-xs text-muted-foreground uppercase mb-1">Min. indbetaling</p><p className="text-lg font-bold text-foreground">80 kr.</p></div>
                <div className="rounded-lg border border-border p-3"><p className="text-xs text-muted-foreground uppercase mb-1">Udbetaling</p><p className="text-lg font-bold text-foreground">0–3 hverdage</p></div>
                <div className="rounded-lg border border-border p-3"><p className="text-xs text-muted-foreground uppercase mb-1">Antal spil</p><p className="text-lg font-bold text-foreground">1.500+ slots, 270+ live</p></div>
              </div>
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">Maria Casino er en del af Kindred Group – det svenske børsnoterede selskab, der også driver <Link to="/casino-anmeldelser/unibet" className={linkClass}>Unibet</Link>. I Danmark udbydes Maria Casino via Unibet Denmark Limited, som har dansk licens fra <Link to="/spillemyndigheden" className={linkClass}>Spillemyndigheden</Link>. Kindred har over 15 millioner kunder i 100+ lande og omsætter for over 1 mia. GBP årligt.</p>
        ...
        <section className="mb-12">
          ...
          <p className="text-muted-foreground leading-relaxed">24/7-tilgængeligheden er en klar fordel sammenlignet med mange mellemstore operatører. Det er et direkte resultat af Kindred Groups infrastruktur – samme supportsetup kører også hos <Link to="/casino-anmeldelser/unibet" className={linkClass}>Unibet</Link>.</p>
        </section>
