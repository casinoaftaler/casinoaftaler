    ...
    <>
      ...
      <section className="relative overflow-hidden py-12 text-white md:py-20" style={{ backgroundImage: heroBackgroundImage ? `linear-gradient(135deg, hsl(260 70% 25% / 0.95), hsl(210 80% 30% / 0.9)), url(${heroBackgroundImage})` : "linear-gradient(135deg, hsl(260 70% 25%), hsl(250 60% 20%) 40%, hsl(210 80% 25%))", backgroundSize: "cover", backgroundPosition: "center" }}>
        <div className="container"><div className="mx-auto max-w-3xl text-center">
          <Badge variant="secondary" className="mb-4"><MenuIcon iconName="heart" className="mr-1.5 h-3.5 w-3.5" />3.9 / 5 – Venlig Casinoplatform</Badge>
      ...
      <ContentPageLayout>
        ...
        <section className="mb-12">
          <Card className="border-border bg-card border-l-4 border-l-primary">
            <CardHeader><CardTitle className="flex items-center gap-2 text-xl"><MenuIcon iconName="zap" className="h-6 w-6 text-primary" />Hurtige Fakta – Maria Casino</CardTitle></CardHeader>
            <CardContent>
        ...
        <section className="mb-12">
          ...
          <Card className="border-border bg-card my-6">
            <CardHeader><CardTitle className="flex items-center gap-2 text-lg"><MenuIcon iconName="trending-up" className="h-5 w-5 text-primary" />EV-beregning: Maria Casino velkomstbonus</CardTitle></CardHeader>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 my-6">
            ...
            <Card className="border-border bg-card"><CardHeader className="pb-2"><CardTitle className="flex items-center gap-2 text-lg"><MenuIcon iconName="trophy" className="h-5 w-5 text-primary" />Live Casino</CardTitle></CardHeader><CardContent><p className="text-sm text-muted-foreground">270+ live spil fra <Link to="/spiludviklere/evolution-gaming" className={linkClass}>Evolution Gaming</Link>. Roulette, blackjack, baccarat, Casino Hold'em og game shows.</p></CardContent></Card>
            <Card className="border-border bg-card"><CardHeader className="pb-2"><CardTitle className="flex items-center gap-2 text-lg"><MenuIcon iconName="sparkles" className="h-5 w-5 text-primary" />Bordspil & Poker</CardTitle></CardHeader><CardContent><p className="text-sm text-muted-foreground">Blackjack, roulette (europæisk, fransk, amerikansk), baccarat og 6 varianter af video poker.</p></CardContent></Card>
          </div>
          ...
          <p className="text-muted-foreground leading-relaxed">Ud over live casino tilbyder Maria Casino også en dedikeret bingo-sektion – et arv fra brandets skandinaviske rødder, hvor bingo altid har været en central del af produktmixet.</p>
        ...
        <section className="mb-12">
          <h2 className="mb-4 text-3xl font-bold flex items-center gap-2"><MenuIcon iconName="alert-triangle" className="h-7 w-7 text-destructive" />Hvem passer Maria Casino ikke til?</h2>
