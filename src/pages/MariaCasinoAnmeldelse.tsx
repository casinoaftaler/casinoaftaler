      ...
      <section
        ...
        style={{
          backgroundImage: heroBackgroundImage
            ? `linear-gradient(135deg, hsl(320 60% 30% / 0.95), hsl(280 50% 25% / 0.9)), url(${heroBackgroundImage})`
            : "linear-gradient(135deg, hsl(320 60% 30%), hsl(300 50% 20%) 40%, hsl(280 50% 25%))",
