...
const MariaCasinoAnmeldelse = () => {
  ...
  const reviewJsonLd = { "@context": "https://schema.org", "@type": "Review", itemReviewed: { "@type": "Organization", name: "Maria Casino", url: "https://www.mariacasino.dk/" }, author: { "@type": "Organization", name: "Casinoaftaler" }, reviewRating: { "@type": "Rating", ratingValue: "4.0", bestRating: "5", worstRating: "1" }, reviewBody: "Maria Casino tilbyder en unik kombination af bingo og casinospil med et venligt design og dansk licens under Kindred Group. Stærk på inkludering og social spil, men bonusser og spiludvalg er gennemsnitlige." };
  return (
    <>
      ...
      <div className="container py-8 md:py-12">
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">Velkomstbonussen på 100 % match op til 2.000 kr. blev aktiveret automatisk med 1.000 kr. i bonusmidler. <Link to="/omsaetningskrav" className={linkClass}>Omsætningskravet</Link> er 10x (indskud + bonus) = 20.000 kr. Vi valgte at omsætte primært via slots (Starburst, Gonzos Quest, Reactoonz 2) og supplerede med et par bingo-sessioner. Slots bidrager 100 % til omsætningen, mens bingo bidrager 100 % – en vigtig detalje for bingo-spillere.</p>
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">Maria Casinos <Link to="/velkomstbonus" className={linkClass}>velkomstbonus</Link> er 100 % match op til 2.000 kr. ved første indbetaling med 10x <Link to="/omsaetningskrav" className={linkClass}>omsætningskrav</Link> (indskud + bonus). Med maksimal indbetaling giver det 4.000 kr. spillesaldo og 40.000 kr. i omsætningskrav. Med 96 % RTP forventer du at miste 1.600 kr. under omsætning, hvilket giver en reel bonusværdi på cirka 400 kr.</p>
          <p className="mb-4 text-muted-foreground leading-relaxed">Det er en gennemsnitlig bonus. <Link to="/casino-anmeldelser/mr-vegas" className={linkClass}>Mr Vegas</Link> tilbyder op til 4.000 kr. med en EV på 1.200+ kr., og <Link to="/casino-anmeldelser/betano" className={linkClass}>Betano</Link> har lignende eller højere værdier. Maria Casinos bonus er fair – 10x omsætningskrav er det lavest mulige under dansk lovgivning – men den er ikke designet til at tiltrække bonusjægere. Det passer til platformens generelle filosofi: moderat, fair og langvarig værdi frem for aggressiv first-deposit-marketing.</p>
