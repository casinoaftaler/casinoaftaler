...
const stakeFaqs: { question: string; answer: ReactNode }[] = [
  ...
  { question: "Hvornår kommer Stake til Danmark?", answer: (<>Stake har ansøgt om dansk licens, og en lancering forventes i løbet af 2026. Når Stake åbner i Danmark, vil platformen være underlagt dansk lovgivning, tilsluttet <a href="https://www.rofus.nu/" target="_blank" rel="noopener noreferrer" className={linkClass}>ROFUS</a> og opfylde alle krav til <Link to="/ansvarligt-spil" className={linkClass}>ansvarligt spil</Link>. Den danske version vil sandsynligvis have et tilpasset spiludvalg og betalingsmetoder.</>) },
