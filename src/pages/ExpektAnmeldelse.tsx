...
const ExpektAnmeldelse = () => {
  ...
  const reviewJsonLd = { "@context": "https://schema.org", "@type": "Review", itemReviewed: { "@type": "Organization", name: "Expekt", url: "https://www.expekt.dk/" }, author: { "@type": "Organization", name: "Casinoaftaler" }, reviewRating: { "@type": "Rating", ratingValue: "3.8", bestRating: "5", worstRating: "1" }, reviewBody: "Expekt tilbyder en unik kombination af sportsbetting og casino under Betsson Group med dansk licens." };
