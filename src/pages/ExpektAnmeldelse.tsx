...
const faqs: { question: string; answer: ReactNode }[] = [
  { question: "Er Expekt lovligt i Danmark?", answer: (<>Ja, Expekt opererer under dansk licens fra Spillemyndigheden. Platformen er tilsluttet <a href="https://www.rofus.nu/" target="_blank" rel="noopener noreferrer" className={linkClass}>ROFUS</a> og overholder alle krav til <Link to="/ansvarligt-spil" className={linkClass}>ansvarligt spil</Link>. Expekt ejes af Betsson Group, en af Nordens mest regulerede spiludbydere med licenser i over 20 jurisdiktioner. Betsson Group er børsnoteret på Nasdaq Stockholm, hvilket sikrer ekstra finansiel gennemsigtighed og reguleringsmæssig overvågning.</>) },
    ...
    <>
      ...
      <div className="container py-8 md:py-12">
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">Vi valgte casino-bonussen og indbetalte 500 kr. via <Link to="/betalingsmetoder/trustly" className={linkClass}>Trustly</Link>. Modtog 500 kr. i matchbonus plus 50 free spins på Sweet Bonanza. Samlet startkapital: 1.000 kr. + free spins-gevinster. <Link to="/omsaetningskrav" className={linkClass}>Omsætningskrav</Link>: 10 × (500+500) = 10.000 kr. Free spins-gevinsterne havde separat 10x-krav – fair og i tråd med markedsstandard.</p>
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">Expekt splitter velkomstbonussen i to spor: casino og sport. Du skal vælge ved første indbetaling. Casino-bonussen er op til 1.000 kr. i matchbonus plus 50 free spins med 10x <Link to="/omsaetningskrav" className={linkClass}>omsætningskrav</Link> (d+b). Sportsbonussen er typisk et risk-free bet eller odds-boost.</p>
          <p className="mb-4 text-muted-foreground leading-relaxed"><strong>Casino-bonus regneeksempel:</strong> Indbetal 1.000 kr. → modtag 1.000 kr. bonus + 50 free spins. Omsætningskrav: 10 × (1.000+1.000) = 20.000 kr. Med gennemsnitlig indsats på 10 kr. = 2.000 spins. Med gennemsnitlig RTP 96% = forventet saldo efter omsætning: ca. 1.200 kr. Forventet tab: ca. 800 kr. <strong>Tidsbegrænsning:</strong> 30 dage. <strong>Spilrestriktioner:</strong> Slots 100%, bordspil 10%, live casino 5%.</p>
          <p className="mb-4 text-muted-foreground leading-relaxed">Free spins-gevinsterne har separat 10x-krav, hvilket er fair. Maksimal gevinst fra free spins: 500 kr. Det er en standard begrænsning på det danske marked.</p>
          <p className="text-muted-foreground leading-relaxed"><strong>Sammenligning:</strong> Expekts casino-bonus er mere beskeden end <Link to="/casino-anmeldelser/leovegas" className={linkClass}>LeoVegas</Link>' op til 3.000 kr. og <Link to="/casino-anmeldelser/888-casino" className={linkClass}>888 Casino</Link>'s op til 2.000 kr. + no-deposit bonus. Men Expekt kompenserer med sportsbook-dimensionen – noget hverken LeoVegas eller 888 Casino tilbyder i samme omfang. For den alsidige spiller er den samlede værdi sammenlignelig.</p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">Expekts mobile oplevelse er funktionel men ujævn. Sportsbook-sektionen er godt optimeret til mobil med hurtig navigation og responsiv live-betting. Casino-sektionen er mere gennemsnitlig – spil loader fint, men brugerflowet mellem kategorier er ikke lige så smooth som hos dedikerede mobilcasinoer.</p>
          <p className="mb-4 text-muted-foreground leading-relaxed">Vi testede på iPhone 15 (Safari) og Samsung Galaxy S24 (Chrome). Indlæsningstid for forsiden: 3,2 sekunder (iOS) og 2,9 sekunder (Android). Spilleautomater loadede inden for 4-5 sekunder. Live casino fungerede stabilt med minimal buffering. Den primære kritik er kontekstskiftet mellem sport og casino – på mobil er det endnu mere forvirrende end på desktop, da skærmarealet er begrænset.</p>
          <p className="text-muted-foreground leading-relaxed">Der er ingen dedikeret app tilgængelig for iOS eller Android. Expekt anbefaler mobilbrowseren, hvilket fungerer acceptabelt men mangler push-notifikationer for live-betting – en funktion mange konkurrenter tilbyder via deres apps.</p>
        </section>
