...
const faqs: { question: string; answer: ReactNode }[] = [
  { question: "Er Expekt lovligt i Danmark?", answer: (<>Ja, Expekt opererer under dansk licens fra Spillemyndigheden. Platformen er tilsluttet <a href="https://www.rofus.nu/" target="_blank" rel="noopener noreferrer" className={linkClass}>ROFUS</a> og overholder alle krav til <Link to="/ansvarligt-spil" className={linkClass}>ansvarligt spil</Link>. Expekt ejes af Betsson Group, en af Nordens mest regulerede spiludbydere.</>) },
