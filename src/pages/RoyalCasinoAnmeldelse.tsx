    ...
    <>
      ...
      <div className="container py-8 md:py-12">
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">Royal Casinos <Link to="/velkomstbonus" className={linkClass}>velkomstbonus</Link> er en 100% matchbonus op til 2.000 kr. med det danske standard-<Link to="/omsaetningskrav" className={linkClass}>omsætningskrav</Link> på 10x (d+b). Det er en <Link to="/sticky-bonus" className={linkClass}>sticky bonus</Link>, hvilket betyder, at du ikke kan hæve bonus-andelen, før omsætningskravet er opfyldt.</p>
          <p className="mb-4 text-muted-foreground leading-relaxed"><strong>Regneeksempel:</strong> Du indbetaler 2.000 kr. og modtager 2.000 kr. i matchbonus. Samlet saldo: 4.000 kr. Omsætningskrav: (2.000 + 2.000) × 10 = 40.000 kr. Med en gennemsnitlig slot-RTP på 96% er dit statistisk forventede tab under omsætningen ca. 1.600 kr. Det efterlader dig med ca. 2.400 kr. – en reel bonusværdi på ca. 400 kr. (2.000 bonus minus 1.600 statistisk tab). Det er en positiv forventet værdi, som gør bonussen værd at tage, men du skal være forberedt på variansen.</p>
