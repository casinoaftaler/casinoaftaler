...
import { AlertTriangle, ArrowRight, Badge, Ban, BookOpen, Calculator, Clock, CreditCard, Dog, DollarSign, Flame, Gamepad2, Gift, Heart, Link, Lock, Percent, Scale, ShieldCheck, Sparkles, Target, Users } from "lucide-react"
  ...
  return (
    <>
      ...
      <ContentPageLayout>
        ...
        <QuickComparisonTable count={3} title="Laveste omsætningskrav – top 3" prioritySlugs={["betinia", "playkasino", "spilleautomaten"]} />
