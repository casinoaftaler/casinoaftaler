...
import { ArrowRight, Badge, BookOpen, Briefcase, CheckCircle2, Eye, FileCheck, Gamepad2, Heart, Link, MessageSquare, Pen, Quote, RefreshCw, Scale, Search, Sparkles, Trophy, Tv, Users } from "lucide-react"
...
const OmTeamet = () => {
  ...
  const stats = [
    { icon: Briefcase, value: "17+", label: "Års samlet erfaring" },
    { icon: Trophy, value: "30+", label: "Testede danske casinoer" },
    { icon: Tv, value: "7000+", label: "Timers live streaming" },
    { icon: BookOpen, value: "330+", label: "Publicerede artikler & guides" },
