...
const faqs: { question: string; answer: ReactNode }[] = [
  { question: "Er Unibet lovligt i Danmark?", answer: (<>Ja, Unibet har dansk licens fra Spillemyndigheden og er tilsluttet <a href="https://www.rofus.nu/" target="_blank" rel="noopener noreferrer" className={linkClass}>ROFUS</a>. Unibet ejes af FDJ United (tidl. Kindred Group), en af verdens største børsnoterede spiludbydere med hovedkontor i Malta. Alle krav til <Link to="/ansvarligt-spil" className={linkClass}>ansvarligt spil</Link> overholdes, og Unibet har været aktiv i Danmark siden licensordningens start i 2012.</>) },
  ...
  { question: "Hvem ejer Unibet?", answer: "Unibet ejes af Kindred Group PLC (nu en del af FDJ United), en stor europæisk spiludbyder med hovedkontor i Malta. Kindred Group blev grundlagt i 1997 og driver ud over Unibet flere andre brands inkl. 32Red og Maria Casino. Koncernen har over 1.500 medarbejdere og er en af de mest etablerede og troværdige aktører i online gambling-industrien. Kindred har desuden et ambitiøst mål om at eliminere skadeligt spil inden 2030." },
      ...
      <ContentPageLayout>
        ...
        <section className="mb-12"><Card className="border-border bg-card border-l-4 border-l-primary"><CardHeader><CardTitle className="flex items-center gap-2 text-xl"><MenuIcon iconName="zap" className="h-6 w-6 text-primary" />Hurtige Fakta – Unibet</CardTitle></CardHeader><CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-4 text-center">
            ...
            <div className="rounded-lg border border-border p-2 sm:p-3 min-w-0"><p className="text-[10px] sm:text-xs text-muted-foreground uppercase mb-1 truncate">Produkter</p><p className="text-sm sm:text-lg font-bold text-foreground break-words leading-tight">Casino + Sports + Poker</p></div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-center mt-4">
            <div className="rounded-lg border border-border p-2 sm:p-3 min-w-0"><p className="text-[10px] sm:text-xs text-muted-foreground uppercase mb-1 truncate">Min. indbetaling</p><p className="text-sm sm:text-lg font-bold text-foreground break-words leading-tight">40 kr.</p></div>
            <div className="rounded-lg border border-border p-2 sm:p-3 min-w-0"><p className="text-[10px] sm:text-xs text-muted-foreground uppercase mb-1 truncate">Udbetaling</p><p className="text-sm sm:text-lg font-bold text-foreground break-words leading-tight">1–24 timer</p></div>
            <div className="rounded-lg border border-border p-2 sm:p-3 min-w-0"><p className="text-[10px] sm:text-xs text-muted-foreground uppercase mb-1 truncate">Ejer</p><p className="text-sm sm:text-lg font-bold text-foreground break-words leading-tight">FDJ United (tidl. Kindred)</p></div>
          </div>
        ...
        <section className="mb-12">
          ...
          <ReviewScreenshot
            ...
            alt="Unibet live casino sektion med Evolution Gaming roulette og blackjack borde"
