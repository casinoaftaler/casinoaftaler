...
const faqs: { question: string; answer: ReactNode }[] = [
  ...
  { question: "Hvad er Unibets velkomstbonus?", answer: (<>Unibet tilbyder en casino <Link to="/velkomstbonus" className={linkClass}>velkomstbonus</Link> på 100% op til 500 kr. (min. indbetaling 500 kr.) plus 100 Cash <Link to="/free-spins" className={linkClass}>Free Spins</Link> uden omsætningskrav ved indbetaling af 100 kr. Derudover tilbydes en sportsbonus på 100% op til 1.000 kr. (8x omsætning). <Link to="/omsaetningskrav" className={linkClass}>Omsætningskrav</Link> for casino er 10x på udvalgte slots. Bonusserne er opdelt i separate tilbud, så du kan vælge den pakke, der passer til din spilleprofil.</>) },
  { question: "Hvem ejer Unibet?", answer: "Unibet ejes af Kindred Group, som siden oktober 2024 er en del af La Française des Jeux (FDJ) – det franske statslige lotteri- og spilselskab. Kindred Group blev grundlagt i 1997 og driver ud over Unibet flere andre brands inkl. 32Red og Maria Casino. FDJ er børsnoteret på Euronext Paris og er en af Europas største spiludbydere. Opkøbet har tilført Kindred yderligere ressourcer og stabilitet, mens brandene opererer videre som selvstændige enheder." },
    ...
    <>
      ...
      <section className="relative overflow-hidden py-12 text-white md:py-20" style={{ backgroundImage: heroBackgroundImage ? `linear-gradient(135deg, hsl(260 70% 25% / 0.95), hsl(210 80% 30% / 0.9)), url(${heroBackgroundImage})` : "linear-gradient(135deg, hsl(260 70% 25%), hsl(250 60% 20%) 40%, hsl(210 80% 25%))", backgroundSize: "cover", backgroundPosition: "center" }}>
        <div className="container"><div className="mx-auto max-w-3xl text-center">
          <Badge variant="secondary" className="mb-4"><Globe className="mr-1.5 h-3.5 w-3.5" />4.3 / 5 – Komplet spilleplatform</Badge>
      ...
      <div className="container py-8 md:py-12">
        ...
        <section className="mb-12"><Card className="border-border bg-card border-l-4 border-l-primary"><CardHeader><CardTitle className="flex items-center gap-2 text-xl"><Zap className="h-6 w-6 text-primary" />Hurtige Fakta – Unibet</CardTitle></CardHeader><CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
            <div className="rounded-lg border border-border p-3"><p className="text-xs text-muted-foreground uppercase mb-1">Velkomstbonus</p><p className="text-lg font-bold text-foreground">100% op til 500 kr.</p></div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-center mt-4">
            ...
            <div className="rounded-lg border border-border p-3"><p className="text-xs text-muted-foreground uppercase mb-1">Ejer</p><p className="text-lg font-bold text-foreground">FDJ / Kindred Group</p></div>
          </div>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card className="border-border bg-card"><CardHeader className="pb-2"><CardTitle className="flex items-center gap-2 text-lg text-destructive/80"><X className="h-5 w-5" />Ulemper</CardTitle></CardHeader><CardContent><ul className="space-y-2">{["Casino-velkomstbonus på 500 kr. er lavere end flere konkurrenter", "Platform kan føles kompleks for nye brugere pga. mange produkter", "Casino-sektionen kan drukne i sports-orienteret design", "VIP-program er ikke så gennemsigtigt som konkurrenters", "Kundeservice-ventetid kan være lang i spidsbelastningsperioder", "Poker-app kræver separat download"].map((c) => (<li key={c} className="flex items-start gap-2 text-sm"><X className="h-4 w-4 text-destructive flex-shrink-0 mt-0.5" /><span className="text-muted-foreground">{c}</span></li>))}</ul></CardContent></Card>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">Unibet tilbyder en casino <Link to="/velkomstbonus" className={linkClass}>velkomstbonus</Link> på 100% op til 500 kr. (min. indbetaling 500 kr.) til nye spillere, plus et separat tilbud om 100 Cash <Link to="/free-spins" className={linkClass}>Free Spins</Link> uden omsætningskrav ved indbetaling af 100 kr. <Link to="/omsaetningskrav" className={linkClass}>Omsætningskravene</Link> for casinobonussen er 10x på udvalgte slots inden for 60 dage. Sportsspillere får en 100% matchbonus op til 1.000 kr. med 8x omsætning (odds 1.40+). Det er vigtigt at forstå, at casino- og sportsbonusser er fuldstændig adskilte – du vælger den pakke, der passer til din spilleprofil.</p>
          <p className="mb-4 text-muted-foreground leading-relaxed">Lad os beregne den reelle værdi af casinobonussen: Indbetaler du 500 kr. og modtager 500 kr. i bonus, har du 1.000 kr. i samlet saldo. Med 10x omsætningskrav skal du gennemspille 10.000 kr., før du kan udbetale bonusmidler. Spiller du primært på <Link to="/casinospil/spillemaskiner" className={linkClass}>spilleautomater</Link> med en gennemsnitlig RTP på 96%, betyder det et statistisk forventet tab på ca. 400 kr. under gennemspilningen – hvilket efterlader dig med en teoretisk nettogevinst på ca. 100 kr. fra bonussen. De 100 Cash Free Spins (separat tilbud, min. 100 kr. indbetaling) kræver ingen omsætning, hvilket gør dem til en af de mest fordelagtige free spins-pakker på markedet.</p>
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">Unibet understøtter alle populære danske <Link to="/betalingsmetoder" className={linkClass}>betalingsmetoder</Link> inkl. <Link to="/betalingsmetoder/trustly" className={linkClass}>Trustly</Link>, <Link to="/betalingsmetoder/mobilepay" className={linkClass}>MobilePay</Link>, <Link to="/betalingsmetoder/skrill" className={linkClass}>Skrill</Link>, Neteller, <Link to="/betalingsmetoder/paysafecard" className={linkClass}>Paysafecard</Link>, <Link to="/betalingsmetoder/visa-mastercard" className={linkClass}>Visa/Mastercard</Link> og Earthport. MobilePay gør det nemt for danske spillere at indbetale hurtigt direkte fra mobilen.</p>
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">Unibet opererer under dansk licens fra Spillemyndigheden (licens nr. 18-0098) og er tilsluttet <a href="https://www.rofus.nu/" target="_blank" rel="noopener noreferrer" className={linkClass}>ROFUS</a>. Kindred Group blev i oktober 2024 opkøbt af La Française des Jeux (FDJ) – det franske statslige spilselskab, der er børsnoteret på Euronext Paris. FDJ er en af Europas største spiludbydere, og opkøbet har tilført Unibet yderligere finansiel styrke og stabilitet. Du kan tilgå FDJ's årsrapporter og kvartalsresultater offentligt, hvilket giver indsigt i virksomhedens finansielle sundhed.</p>
