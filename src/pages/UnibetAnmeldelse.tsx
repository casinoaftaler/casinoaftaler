...
const faqs: { question: string; answer: ReactNode }[] = [
  ...
  { question: "Hvad er Unibets velkomstbonus?", answer: (<>Unibet tilbyder en <Link to="/velkomstbonus" className={linkClass}>velkomstbonus</Link> på op til 1.000 kr. i matchbonus plus <Link to="/free-spins" className={linkClass}>free spins</Link> til nye spillere. Derudover tilbydes et risikofrit væddemål til nye sportsspillere. <Link to="/omsaetningskrav" className={linkClass}>Omsætningskrav</Link> er 10x (d+b). Bonussen er opdelt i separate casino- og sportstilbud, så du kan vælge den pakke, der passer til din spilleprofil.</>) },
...
const UnibetAnmeldelse = () => {
  ...
  const reviewJsonLd = { "@context": "https://schema.org", "@type": "Review", itemReviewed: { "@type": "Organization", name: "Unibet", url: "https://www.unibet.dk/" }, author: { "@type": "Person", "@id": "https://casinoaftaler.dk/forfatter/jonas#person" }, reviewRating: { "@type": "Rating", ratingValue: "4.3", bestRating: "5", worstRating: "1" }, reviewBody: "Unibet er en af de mest komplette spilleplatforme i Danmark med casino, sports, poker og live casino under Kindred Groups paraply." };
    ...
    <>
      ...
      <div className="container py-8 md:py-12">
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">Unibet tilbyder en <Link to="/velkomstbonus" className={linkClass}>velkomstbonus</Link> på op til 1.000 kr. plus <Link to="/free-spins" className={linkClass}>free spins</Link> til nye casinospillere. <Link to="/omsaetningskrav" className={linkClass}>Omsætningskravene</Link> er 10x (indskud + bonus), hvilket er den danske standardsats. Sportsspillere får derudover et risikofrit væddemål som separat tilbud. Det er vigtigt at forstå, at casino- og sportsbonusser er fuldstændig adskilte – du vælger den ene eller den anden ved registrering, og de har forskellige vilkår og betingelser.</p>
          <p className="mb-4 text-muted-foreground leading-relaxed">Lad os beregne den reelle værdi af casinobonussen: Indbetaler du 1.000 kr. og modtager 1.000 kr. i bonus, har du 2.000 kr. i samlet saldo. Med 10x omsætningskrav skal du gennemspille 20.000 kr., før du kan udbetale bonusmidler. Spiller du primært på <Link to="/casinospil/spillemaskiner" className={linkClass}>spilleautomater</Link> med en gennemsnitlig RTP på 96%, betyder det et statistisk forventet tab på ca. 800 kr. under gennemspilningen – hvilket efterlader dig med en teoretisk nettogevinst på ca. 200 kr. fra bonussen. Det er en solid reel værdi sammenlignet med markedets gennemsnit, men det er ikke en "gratis" gave, som markedsføringen kan antyde.</p>
