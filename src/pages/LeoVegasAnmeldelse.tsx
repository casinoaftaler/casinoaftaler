    ...
    <>
      ...
      <div className="container py-8 md:py-12">
          ...
          <Card className="border-border bg-card border-l-4 border-l-primary">
            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                <div className="rounded-lg border border-border p-3"><p className="text-xs text-muted-foreground uppercase mb-1">Velkomstbonus</p><p className="text-lg font-bold text-foreground">Op til 1.000 kr. + 100 FS (New York New York)</p></div>
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">
            LeoVegas' <Link to="/velkomstbonus" className={linkClass}>velkomstbonus</Link> på op til 1.000 kr. plus 100 <Link to="/free-spins" className={linkClass}>free spins</Link> er en af de bedst strukturerede bonusser på det danske marked. Bonussen er underlagt det lovpligtige <Link to="/omsaetningskrav" className={linkClass}>omsætningskrav</Link> på 10x (indskud + bonus), og vilkårene er klare og gennemsigtige.
          </p>
          <p className="mb-4 text-muted-foreground leading-relaxed">
            <strong>Regneeksempel:</strong> Du indbetaler 1.000 kr. og modtager 1.000 kr. i matchbonus + 100 free spins. Din samlede spillesaldo er 2.000 kr. Omsætningskravet beregnes som (1.000 + 1.000) × 10 = 20.000 kr. Spilleautomater bidrager 100 % til omsætningskravet, mens bordspil som <Link to="/casinospil/blackjack" className={linkClass}>blackjack</Link> og <Link to="/casinospil/roulette" className={linkClass}>roulette</Link> typisk bidrager med 10 %. Med en gennemsnitlig RTP på 96 % og ren slots-spil kan du statistisk forvente at have ca. 1.200 kr. tilbage efter at have opfyldt kravet. Free spins-gevinster tilføjes som bonuspenge med samme omsætningskrav.
          </p>
          <p className="mb-4 text-muted-foreground leading-relaxed">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Det er værd at bemærke, at LeoVegas ikke tilbyder et traditionelt VIP-program i Danmark. I stedet modtager aktive spillere personlige bonusser og invitationer via "Mine Tilbud"-sektionen. Det giver fleksibilitet, men manglen på et fast niveaubaseret loyalitetsprogram kan skuffe spillere, der forventer dedikerede VIP-fordele.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">
            <strong>LeoVegas vs. <Link to="/casino-anmeldelser/mr-green" className={linkClass}>Mr Green</Link>:</strong> Begge er premium-casinoer med fokus på design og brugeroplevelse. LeoVegas vinder på spiludvalg (2.500+ vs. 1.000+), live casino-dybde (200+ vs. ~80 borde) og mobilhastighed. Mr Green vinder på Green Gaming-værktøjet til ansvarligt spil. For de fleste spillere er LeoVegas det stærkere valg.
          </p>
          <p className="mb-4 text-muted-foreground leading-relaxed">
