...
const faqs: { question: string; answer: ReactNode }[] = [
  { question: "Er LeoVegas lovligt i Danmark?", answer: (<>Ja, LeoVegas har en dansk licens fra Spillemyndigheden og er tilsluttet <a href="https://www.rofus.nu/" target="_blank" rel="noopener noreferrer" className={linkClass}>ROFUS</a>. LeoVegas ejes af MGM Resorts International, en af verdens største casino- og hospitality-koncerner, og opfylder alle krav til <Link to="/ansvarligt-spil" className={linkClass}>ansvarligt spil</Link> i Danmark.</>) },
