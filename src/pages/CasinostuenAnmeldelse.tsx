    ...
    <>
      ...
      <div className="container py-8 md:py-12">
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">Spiludvalget er kurateret snarere end udtømmende. <p className="mb-4 text-muted-foreground leading-relaxed">Spiludvalget er kurateret snarere end udtømmende. Med omkring 1.000+ spil har Casinostuen færre titler end giganterne, men dækker alle de populære kategorier. Det er et bevidst valg: hellere 1.000 gennemtestede, populære titler end 3.000 spil, hvor halvdelen er ukendte filler-titler fra obskure studier.</p>, hvor halvdelen er ukendte filler-titler fra obskure studier.</p>
