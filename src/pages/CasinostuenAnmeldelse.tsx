...
import { Check, Club, Link, Play, X } from "lucide-react"
  ...
  return (
    <>
      ...
      <ContentPageLayout>
        ...
        <section className="mb-12">
          <h2 className="mb-6 text-3xl font-bold">Det positive og det negative – ærlig opvejning</h2>
        ...
        <section className="mb-12">
          <h2 className="mb-4 text-3xl font-bold">Brugerfladen på mobil og desktop</h2>
        ...
        <section className="mb-12">
          <h2 className="mb-4 text-3xl font-bold">Målgruppe og frasortering – passer Casinostuen dig?</h2>
