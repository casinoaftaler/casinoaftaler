...
const DanskeSpilAnmeldelse = () => {
  ...
  const reviewJsonLd = { "@context": "https://schema.org", "@type": "Review", itemReviewed: { "@type": "Organization", name: "Danske Spil Casino", url: "https://www.danskespil.dk/casino" }, author: { "@type": "Organization", name: "Casinoaftaler" }, reviewRating: { "@type": "Rating", ratingValue: "4.5", bestRating: "5" }, reviewBody: "Danske Spil Casino er Danmarks mest troværdige online casino med dansk licens, statsligt ejerskab og et solidt spiludvalg fra topudbydere." };
