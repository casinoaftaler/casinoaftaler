    ...
    <>
      ...
      <div className="container py-8 md:py-12">
        ...
        <section className="mb-12">
          <Card className="border-border bg-card border-l-4 border-l-primary"><CardHeader><CardTitle className="flex items-center gap-2 text-xl"><Zap className="h-6 w-6 text-primary" />Hurtige Fakta – Danske Spil Casino</CardTitle></CardHeader><CardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-4 text-center">
              ...
              <div className="rounded-lg border border-border p-2 sm:p-3 min-w-0"><p className="text-[10px] sm:text-xs text-muted-foreground uppercase mb-1 truncate">Ejerskab</p><p className="text-sm sm:text-lg font-bold text-foreground break-words leading-tight">Delvist statsligt</p></div>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-center mt-4">
              <div className="rounded-lg border border-border p-2 sm:p-3 min-w-0"><p className="text-[10px] sm:text-xs text-muted-foreground uppercase mb-1 truncate">Min. indbetaling</p><p className="text-sm sm:text-lg font-bold text-foreground break-words leading-tight">50 kr.</p></div>
              ...
              <div className="rounded-lg border border-border p-2 sm:p-3 min-w-0"><p className="text-[10px] sm:text-xs text-muted-foreground uppercase mb-1 truncate">Grundlagt</p><p className="text-sm sm:text-lg font-bold text-foreground break-words leading-tight">1948</p></div>
            </div>
        ...
        <section className="mb-12">
          ...
          <p className="text-muted-foreground leading-relaxed">Det er værd at understrege den unikke position, Danske Spil indtager på det danske marked. Mens private casinoer primært drives af aktionærinteresser, har Danske Spil en dobbelt mission: at tilbyde underholdning og samtidig bidrage til det danske samfund. En betydelig del af overskuddet kanaliseres til almennyttige formål inden for sport, kultur og frivillighed – i 2023 bidrog Danske Spil med over 1,5 milliard kr. til danske foreninger og organisationer. Det giver en helt anderledes kontekst for din spiloplevelse: du spiller på en platform, der investerer i Danmark, ikke kun i sine ejere.</p>
          <ReviewScreenshot src={danskespilForside} alt="Danske Spil forside med produktoversigt over Casino, Oddset, Lotto, Poker og Bingo" caption="Danske Spils forside samler alle spilprodukter under én platform – fra Casino til Oddset og Bingo." eager size="full" />
        ...
        <section className="mb-12">
          ...
          <ReviewScreenshot src={danskespilLiveCasino} alt="Danske Spil live casino med blackjack-borde, gameshows som Crazy Coin Flip og Top 10 liste" caption="Live casino-sektionen hos Danske Spil med dedikerede blackjack-borde, gameshows og Top 10 mest populære." size="full" />
        ...
        <section className="mb-12">
          ...
          <ReviewScreenshot src={danskespilBingo} alt="Danske Spil Bingo med Stjernebingo jackpotgaranti og bingorum-oversigt" caption="Bingo-sektionen er endnu et eksempel på Danske Spils brede produktudbud – med jackpotgaranti og flere bingorum." size="full" />
        </section>
