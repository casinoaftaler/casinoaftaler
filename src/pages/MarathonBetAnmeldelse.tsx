    ...
    <>
      ...
      <ContentPageLayout>
        ...
        <section className="mb-12">
          ...
          <ReviewScreenshot src={marathonbetForside} alt="MarathonBet sportsbook forside med live betting, populære begivenheder og velkomstbonus på 500 kr." caption="MarathonBets forside viser sportsbogen med live-kampe, populære begivenheder og velkomstbonus til nye kunder." eager size="full" />
        </section>
        ...
        <section className="mb-12">
          ...
          <ReviewScreenshot src={marathonbetLive} alt="MarathonBet live betting oversigt med ishockey, esport og fodbold samt detaljerede odds-markeder" caption="Live betting-sektionen hos MarathonBet med KHL ishockey, CS2 esport og internationale fodboldkampe – bemærk de lave marginer på alle markeder." size="full" />
        </section>
        ...
        <section className="mb-12">
          ...
          <ReviewScreenshot src={marathonbetCasino} alt="MarathonBet casino-sektion med velkomstbonus, nye og populære spillemaskiner som Gold Blitz og Thunderstruck II" caption="Casino-lobbyen hos MarathonBet med velkomstbonus-banner, nye titler som Trojan Kingdom og populære slots som Gold Blitz og Thunderstruck II." size="full" />
        </section>
