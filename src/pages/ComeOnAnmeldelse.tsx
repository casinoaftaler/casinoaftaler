    ...
    <>
      ...
      <div className="container py-8 md:py-12">
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">I en branche, hvor bonusser ofte er pakket ind i ugennemsigtige vilkår og skjulte begrænsninger, har ComeOn Casino valgt en fundamentalt anderledes tilgang: simpelhed. Velkomstbonussen er op til 2.000 kr. med 5x <Link to="/omsaetningskrav" className={linkClass}>omsætningskrav</Link> (d+b) – markant lavere end det danske loft på 10x. Men det er ikke kun størrelsen, der gør ComeOn interessant. Det er måden, vilkårene præsenteres på.</p>
          <p className="mb-4 text-muted-foreground leading-relaxed"><strong>Regneeksempel med maks. bonus:</strong> Indbetal 2.000 kr. → modtag 2.000 kr. bonus = 4.000 kr. total. Omsætningskrav: 5 × (2.000+2.000) = 20.000 kr. Med gennemsnitlig indsats på 20 kr. pr. spin = 1.000 spins. Med gennemsnitlig RTP 96% = forventet saldo efter omsætning: ca. 3.200 kr. Forventet tab: ca. 800 kr. <strong>Tidsbegrænsning:</strong> 30 dage. <strong>Maksimal bonusgevinst:</strong> Ingen eksplicit grænse – en sjælden gennemsigtighedsdetalje.</p>
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed"><strong>Sammenligning:</strong> ComeOns maks. bonus (2.000 kr.) matcher <Link to="/casino-anmeldelser/888-casino" className={linkClass}>888 Casino</Link> og ligger under <Link to="/casino-anmeldelser/leovegas" className={linkClass}>LeoVegas</Link>' 3.000 kr. Men 888 Casino har 30x-krav på free spins (vs. ComeOns 5x), og LeoVegas ekskluderer live casino fra omsætning (0% vs. ComeOns 10%). ComeOns 5x omsætningskrav er blandt de laveste på det danske marked – kun delt med GetLucky. For den bonusbevidste spiller er ComeOns vilkår blandt de mest ærlige på markedet.</p>
