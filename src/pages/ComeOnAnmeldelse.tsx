...
import { Check, Club, Link, Play, RotateCcw, X } from "lucide-react"
    ...
    <>
      ...
      <ContentPageLayout>
        ...
        <section className="mb-12">
          ...
          <ReviewScreenshot src={comeonForside} alt="ComeOn Casino forside med velkomstbonus, kampagnebannere og kategorifiltre til casino og live casino" caption="ComeOns forside med synlige kampagnebannere og nem adgang til alle sektioner via kategorifilteret." eager size="full" />
        ...
        <section className="mb-12">
          ...
          <ReviewScreenshot src={comeonKampagner} alt="ComeOn Casino kampagneside med Dagens Spil, cashback til sportsbook og Cash Drop Uge tilbud" caption="ComeOns kampagneoversigt med løbende tilbud som Dagens Spil, cashback og ugentlige konkurrencer." size="full" />
        </section>
        ...
        <section className="mb-12">
          ...
          <ReviewScreenshot src={comeonLiveCasino} alt="ComeOn live casino med blackjack, roulette og anbefalede borde fra Evolution Gaming" caption="Live casino-sektionen hos ComeOn med bredt udvalg af blackjack, roulette og VIP-borde fra Evolution Gaming." size="full" />
        ...
        <section className="mb-12">
          ...
          <ReviewScreenshot src={comeonSportsbook} alt="ComeOn sportsbook med odds på fodbold, betboost-tilbud og populære ligaer som NHL og NBA" caption="ComeOns sportsbook-sektion med live odds, betboost-kampagner og bred dækning af internationale ligaer." size="full" />
