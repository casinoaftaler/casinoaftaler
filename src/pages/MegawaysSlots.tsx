        ...
        <section className="mb-12" id="relaterede">
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              { to: "/slot-database", title: "Slot Database", desc: "1.470+ slots med community-statistik" }, "/slot-database", title: "Slot Database", desc: "1.470+ slots med community-statistik" }," },
