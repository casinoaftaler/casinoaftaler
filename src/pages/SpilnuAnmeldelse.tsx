  ...
  return (
    <>
      ...
      <div className="container py-8 md:py-12">
        ...
        {/* Customer Support */}
        <section className="mb-12">
          <h2 className="mb-4 text-3xl font-bold"><Headphones className="inline h-7 w-7 text-primary mr-2" />Kundeservice – den danske fordel</h2>
        ...
        {/* Mobile Experience */}
        <section className="mb-12">
          <h2 className="mb-4 text-3xl font-bold"><Smartphone className="inline h-7 w-7 text-primary mr-2" />Mobiloplevelsen – browseren som platform</h2>
        ...
        {/* Security */}
        <section className="mb-12">
          <h2 className="mb-4 text-3xl font-bold"><ShieldCheck className="inline h-7 w-7 text-primary mr-2" />Sikkerhed, licens og ansvarligt spil – den statslige garanti</h2>
