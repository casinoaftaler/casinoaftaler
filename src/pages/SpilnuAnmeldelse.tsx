...
import spilnuLobby from "@/assets/screenshots/spilnu-lobby.webp";
...
import spilnuBingo from "@/assets/screenshots/bingo-75kugle-spilrum.webp";
...
import { Apple, Check, Play, Table, Target, X } from "lucide-react"
    ...
    <>
      ...
      <ContentPageLayout>
        ...
        <section className="mb-12">
          ...
          <ReviewScreenshot src={spilnuBetaling} alt="Spilnu indbetalingsskærm med betalingsmetoder: Betalingskort, Apple Pay og MobilePay" caption="Indbetalingsflowet er enkelt med tre danske betalingsmuligheder – alle uden gebyr." size="full" />
