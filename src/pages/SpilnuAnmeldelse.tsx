...
const spilnuFaqs: { question: string; answer: ReactNode }[] = [
  { question: "Er Spilnu lovligt i Danmark?", answer: (<>Ja, Spilnu.dk er en del af Danske Spil-koncernen og opererer med dansk licens fra Spillemyndigheden. Platformen er tilsluttet <a href="https://www.rofus.nu/" target="_blank" rel="noopener noreferrer" className={linkClass}>ROFUS</a> og overholder alle krav til <Link to="/ansvarligt-spil" className={linkClass}>ansvarligt spil</Link>.</>) },
