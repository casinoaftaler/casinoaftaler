...
const nordicbetFaqs: { question: string; answer: ReactNode }[] = [
  ...
  { question: "Hvilken velkomstbonus tilbyder NordicBet Casino?", answer: (<>NordicBet tilbyder separate velkomstbonusser for sport og casino. Casino-bonussen matcher din første indbetaling 100 % op til 1.000 kr. med et <Link to="/omsaetningskrav" className={linkClass}>omsætningskrav</Link> på 10x (indskud + bonus). Ved en indbetaling på 1.000 kr. modtager du 1.000 kr. i bonus og skal omsætte for 20.000 kr. Sportsbonussen har separate vilkår med risikofrit væddemål. Tjek altid aktuelle betingelser.</>) },
