...
import { Check, Dog, Link, Play, X } from "lucide-react"
  ...
  return (
    <>
      ...
      <ContentPageLayout>
        ...
        {/* Pros & Cons */}
        <section className="mb-12">
          <h2 className="mb-6 text-3xl font-bold">Plusser og minusser – den ærlige opsamling</h2>
