...
const nordicbetFaqs: { question: string; answer: ReactNode }[] = [
  { question: "Er NordicBet lovligt i Danmark?", answer: (<>Ja, NordicBet har dansk licens fra Spillemyndigheden og er tilsluttet <a href="https://www.rofus.nu/" target="_blank" rel="noopener noreferrer" className={linkClass}>ROFUS</a>. NordicBet drives af Betsson Group, et af Nordens største spilleselskaber, og overholder alle danske regler for <Link to="/responsible-gaming" className={linkClass}>ansvarligt spil</Link>.</>) },
...
const NordicBetAnmeldelse = () => {
  ...
  const faqJsonLd = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: nordicbetFaqs.map((faq) => ({ "@type": "Question", name: faq.question, acceptedAnswer: { "@type": "Answer", text: typeof faq.answer === "string" ? faq.answer : faq.question } })) };
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden py-12 text-white md:py-20" style={{ backgroundImage: heroBackgroundImage ? `linear-gradient(135deg, hsl(200 70% 20% / 0.95), hsl(220 60% 25% / 0.9)), url(${heroBackgroundImage})` : "linear-gradient(135deg, hsl(200 70% 20%), hsl(210 60% 15%) 40%, hsl(220 60% 25%))", backgroundSize: "cover", backgroundPosition: "center" }}>
