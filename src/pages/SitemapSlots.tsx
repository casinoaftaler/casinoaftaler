  ...
  return (
    <>
      <SEO
        ...
        description="Komplet liste over alle 1.470+ spillemaskiner på Casinoaftaler.dk med statistik, RTP og bonus hunt data."
        noindex
      />
      <div className="container py-8">
        ...
        <noscript>
          <div>
            ...
            <p>Se det komplette katalog med links til alle {slots?.length || "1.470+"} spillemaskiner: <a href="/slot-directory.html">Slot Directory</a>.</p>
          </div>
        </noscript>
      </div>
    </>
