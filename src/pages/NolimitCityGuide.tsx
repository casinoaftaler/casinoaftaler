...
const NolimitCityGuide = () => (
  <ProviderPage
    ...
    technicalProfile={
      <>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <Card><CardContent className="pt-6"><p className="text-xs text-muted-foreground uppercase mb-1">RTP-interval</p><p className="text-lg font-bold">94,0% – 96,5%</p><p className="text-xs text-muted-foreground">San Quentin: 96,03% | Mental: 96,09%</p></CardContent></Card>
    ...
    games={[
      ...
      { name: "Mental", desc: "Det mest kontroversielle spil i slot-historien. Psykiatrisk hospital-tema der bruger alle fire patenterede mekanikker (xWays + xNudge + xBomb + xSplit) i én titel. Mekanisk kompleksitet der er uovertruffen. Fire bonus-niveauer med stigende intensitet. RTP: 96,09%. Ikke for alle – men dem der forstår det, elsker det.", highlight: "Alle 4 patenter – uovertruffen kompleksitet" },
