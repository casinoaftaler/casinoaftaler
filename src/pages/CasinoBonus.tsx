  ...
  return (
    <>
      <SEO
        ...
        description="Casino bonus i Danmark 2026: Sammenlign no-sticky, free spins, velkomstbonus og 7+ bonustyper med matematiske analyser. Find den bedste bonus."
        jsonLd={[faqJsonLd, articleSchema, {
          "@context": "https://schema.org",
          "@type": "ItemList",
          name: "Bonustyper i Danmark 2026",
          itemListElement: [
            { "@type": "ListItem", position: 1, item: { "@type": "Thing", name: "No-Sticky Bonus", url: `${SITE_URL}/no-sticky-bonus` } },
            { "@type": "ListItem", position: 2, item: { "@type": "Thing", name: "Free Spins", url: `${SITE_URL}/free-spins` } },
            { "@type": "ListItem", position: 3, item: { "@type": "Thing", name: "Velkomstbonus", url: `${SITE_URL}/velkomstbonus` } },
            { "@type": "ListItem", position: 4, item: { "@type": "Thing", name: "Indskudsbonus", url: `${SITE_URL}/indskudsbonus` } },
            { "@type": "ListItem", position: 5, item: { "@type": "Thing", name: "Bonus uden Indbetaling", url: `${SITE_URL}/bonus-uden-indbetaling` } },
            { "@type": "ListItem", position: 6, item: { "@type": "Thing", name: "Bonus uden Omsætningskrav", url: `${SITE_URL}/bonus-uden-omsaetningskrav` } },
            { "@type": "ListItem", position: 7, item: { "@type": "Thing", name: "Cashback Bonus", url: `${SITE_URL}/cashback-bonus` } },
            { "@type": "ListItem", position: 8, item: { "@type": "Thing", name: "Reload Bonus", url: `${SITE_URL}/reload-bonus` } },
            { "@type": "ListItem", position: 9, item: { "@type": "Thing", name: "Sticky Bonus", url: `${SITE_URL}/sticky-bonus` } },
            { "@type": "ListItem", position: 10, item: { "@type": "Thing", name: "VIP Program", url: `${SITE_URL}/vip-program` } },
          ],
        }]}
      />
