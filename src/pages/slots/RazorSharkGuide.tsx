...
const RazorSharkGuide = () => {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 4, name: "Razor Shark", item: `${SITE_URL}/casinospil/spillemaskiner/razor-shark` },
    ],
  };
  ...
  return (
    <>
      ...
      {/* ── HERO ── */}
      <section className="relative overflow-hidden py-12 text-white md:py-20" style={{ backgroundImage: "linear-gradient(135deg, hsl(200 80% 25%), hsl(220 70% 20%) 40%, hsl(190 90% 15%))" }}>
