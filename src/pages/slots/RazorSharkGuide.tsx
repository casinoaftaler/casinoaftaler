    ...
    <>
      ...
      <ContentPageLayout>
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">
            Men den høje volatilitet (4,5/5) skaber en bust-risiko på ca. 15-20 % – markant højere end de 5-8 %, der opnås med lavere volatilitetsalternativer. Spørgsmålet er, om den lavere forventede omkostning (pga. højere RTP) kompenserer for den højere bust-risiko. Svaret er nuanceret: for spillere med tilstrækkeligt startbudget (indskud + bonus > 2.500 kr.) er Razor Shark's høje RTP en netto fordel, fordi den ekstra sikkerhedsmargin reducerer bust-risikoen til acceptable niveauer. For spillere med minimal startbankroll er lavere volatilitet altid at foretrække.
          </p>
          <p className="mb-4 text-muted-foreground leading-relaxed">
