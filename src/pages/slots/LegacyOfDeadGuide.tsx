...
const LegacyOfDeadGuide = () => {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 4, name: "Legacy of Dead", item: `${SITE_URL}/casinospil/spillemaskiner/legacy-of-dead` },
    ],
  };
    ...
    <>
      ...
      <div className="container py-8 md:py-12">
        ...
        <section className="mb-10">
          ...
          <p className="text-muted-foreground mb-4 leading-relaxed">
            RTP'en på 96,58 % er en væsentlig forbedring over Book of Dead's 96,21 %. Denne 0,37 procentpoint-forskel lyder beskeden, men over 10.000 spins à 10 kr. repræsenterer det en forventet besparelse på 370 kr. House edge på 3,42 % placerer Legacy of Dead i det absolutte topkvartil for high-volatility slots – bedre end de fleste konkurrenter i "Book of"-genren.
          </p>
          <p className="text-muted-foreground leading-relaxed">
