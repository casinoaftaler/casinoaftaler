...
const StarburstGuide = () => {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 4, name: "Starburst", item: `${SITE_URL}/casinospil/spillemaskiner/starburst` },
    ],
  };
  ...
  return (
    <>
      ...
      {/* ── HERO ── */}
      <section className="relative overflow-hidden py-12 text-white md:py-20" style={{ backgroundImage: "linear-gradient(135deg, hsl(260 80% 30%), hsl(200 90% 25%) 40%, hsl(180 70% 20%))" }}>
