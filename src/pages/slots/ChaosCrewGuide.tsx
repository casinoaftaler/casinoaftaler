...
const chaosCrewFaqs: { question: string; answer: ReactNode }[] = [
  ...
  { question: "Hvordan fungerer bonus buy i Chaos Crew?", answer: (<>Chaos Crew tilbyder bonus buy til 129× indsatsen (f.eks. 516 kr. ved 4 kr. indsats), der giver direkte adgang til free spins. Bonus buy-RTP'en er 95,92 % – lidt lavere end base game's 96,50 %. Bonus buy kan være deaktiveret under <Link to="/spillemyndigheden" className={linkClass}>Spillemyndigheden</Link>s regulering i Danmark.</>)},
  ...
  { question: "Hvordan fungerer gevinstlinjerne i Chaos Crew?", answer: "Chaos Crew bruger 15 faste gevinstlinjer på et 5×3 grid. Du vinder ved at matche identiske symboler fra venstre mod højre på tilstødende hjul langs en af de 15 linjer. Tumble-funktionen fjerner gevindende symboler, så nye falder ned – dette kan skabe kædegevinster fra et enkelt spin." },
    ...
    <>
      ...
      <section className="relative overflow-hidden py-12 text-white md:py-20" style={{ backgroundImage: "linear-gradient(135deg, hsl(260 70% 25%), hsl(250 60% 20%) 40%, hsl(210 80% 25%))" }}>
        <div className="container">
          <div className="mx-auto max-w-3xl text-center">
            <Badge variant="secondary" className="mb-4"><MenuIcon iconName="puzzle" className="mr-1.5 h-3.5 w-3.5" /> 15 paylines & dual wilds</Badge>
      ...
      <ContentPageLayout>
        ...
        <section className="mb-12">
          ...
          <p className="text-muted-foreground mb-4 leading-relaxed">Hacksaw Gaming har siden 2018 positioneret sig som slot-branchens enfant terrible – et studie, der konsekvent vælger æstetisk provokation og mekanisk innovation over sikre formler. Chaos Crew, lanceret i 2021, repræsenterer studiets forsøg på at gøre den ultra-volatile Hacksaw-oplevelse tilgængelig for et bredere publikum. Hvor titler som <Link to="/casinospil/spillemaskiner/wanted-dead-or-a-wild" className={linkClass}>Wanted Dead or a Wild</Link> opererer med brutal 5/5 volatilitet og niche-appel, finder Chaos Crew en mellemplads med sit 5×3 grid og 15 gevinstlinjer, mens den bevarer den ekstreme volatilitet og et visuelt univers, der er mere legesygt end intimiderende.</p>
          ...
          <p className="text-muted-foreground leading-relaxed">I konteksten af Hacksaws portefølje er Chaos Crew studiets mest mainstream-venlige titel. Den har en højere RTP end de fleste Hacksaw-produkter (96,50 % vs. typisk 96,00-96,30 %), en lavere max win (10.000× vs. 12.500×+ for mange Hacksaw-titler), og en 15-linje mekanik på et standard 5×3 grid, der er intuitivt forståelig for spillere, der er vant til klassiske slots. For danske spillere, der er nysgerrige på Hacksaw Gaming men afskrækket af den brutale volatilitet i deres mest populære titler, er Chaos Crew det naturlige indgangspunkt.</p>
        </section>

        {/* ── CLUSTER PAYS MEKANIK ── */}
        <section className="mb-12">
          <h2 className="mb-4 text-3xl font-bold flex items-center gap-2"><MenuIcon iconName="layers" className="h-6 w-6 text-primary" /> 15 Gevinstlinjer: Hvad Det Betyder for Din Gevinst</h2>
          <p className="text-muted-foreground mb-4 leading-relaxed">Chaos Crew bruger 15 faste gevinstlinjer på et standard 5×3 grid (5 hjul, 3 rækker). Du vinder ved at matche identiske symboler fra venstre mod højre på tilstødende hjul langs en af de 15 fastlagte linjer. Denne mekanik er mere traditionel end cluster pays eller Megaways og giver spillere et klart overblik over, hvordan gevinster dannes. Alle 15 linjer er altid aktive – du kan ikke vælge at deaktivere linjer.</p>

          <ReviewScreenshot src={chaoscrewGameplay} alt="Chaos Crew 5x3 gameplay grid med alle symboltyper synlige inklusiv kraniet, hjernen, møllen og smiley-symbolerne på det punk-inspirerede spillebræt" caption="Chaos Crew's 5×3 grid i base game med det karakteristiske punk-graffiti design og 15 faste gevinstlinjer" size="full" />

          <p className="text-muted-foreground mb-4 leading-relaxed">Den matematiske implikation af 15 linjer er, at hit frequency er lavere end slots med 20-40+ linjer – estimeret til 20-25 % for Chaos Crew. Til gengæld er individuelle linjegevinster proportionalt højere, da indsatsen fordeles over færre linjer. Tumble-funktionen (cascading wins) kompenserer delvist: når en gevinstkombination dannes, fjernes de gevindende symboler og nye falder ned, hvilket kan skabe kædegevinster fra et enkelt spin.</p>
          <p className="text-muted-foreground mb-4 leading-relaxed">Tumble-funktionens gennemsnitlige kædelængde i Chaos Crew estimeres til 1,3-1,6 pr. gevindende spin – lavere end <Link to="/casinospil/spillemaskiner/sweet-bonanza" className={linkClass}>Sweet Bonanza</Link>'s 1,5-2,0, men tilstrækkeligt til at skabe meningsfulde tillægsgevinster. Kombineret med wild-multiplikatorer kan en tumble-kæde producere akkumulerede gevinster, der overstiger, hvad en enkelt linjegevinst normalt leverer.</p>
          <p className="text-muted-foreground leading-relaxed">En kritisk detalje: da Chaos Crew bruger faste linjer (ikke ways-to-win eller cluster pays), er symbolernes position på specifikke rækker afgørende. Et premium-symbol på række 1 indgår kun i linjer, der passerer igennem den position – ikke i alle mulige kombinationer. At forstå linjemønstrene hjælper med at evaluere potentialet i et givent spin, selvom du naturligvis ikke kan påvirke udfaldet.</p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-muted-foreground mb-4 leading-relaxed">Den virkelige magi opstår, når multiple wilds interagerer. Når to eller flere wilds indgår i den samme gevinstlinje, ganges deres multiplikatorer sammen. To Cranky wilds med 3× giver 9× samlet. En Cranky 3× og en Sketchy 5× giver 15×. Tre wilds (3× × 2× × 5×) giver 30×. Med 4-5 sticky wilds på griddet under free spins kan den kombinerede multiplikator nå 50-100×+, hvilket er mekanismen bag Chaos Crew's mest eksplosive gevinster.</p>
        ...
        <section className="mb-12">
          ...
          <p className="text-muted-foreground mb-4 leading-relaxed">Den sticky wild-mekanik er motoren bag Chaos Crew's bonus-potentiale. Hver Cranky eller Sketchy wild, der lander under free spins, forbliver på sin position for resten af runden. Da wilds også substituerer alle regulære symboler, akkumulerer de ikke kun multiplikator-value – de øger også sandsynligheden for, at gevinstkombinationer dannes på de 15 linjer ved at fungere som universelle erstatningssymboler.</p>
        ...
        <section className="mb-12">
          ...
          <p className="text-muted-foreground mb-4 leading-relaxed">Chaos Crew tilbyder én bonus buy-mulighed til 129× indsatsen (f.eks. 516 kr. ved en indsats på 4 kr.), der giver direkte adgang til free spins-runden. Bonus buy-RTP'en er 95,92 % – lidt lavere end base game's 96,50 %, hvilket betyder en marginalt højere house edge ved køb.</p>
        ...
        <section className="mb-12">
          ...
          <p className="text-muted-foreground mb-4 leading-relaxed">Et vigtigt aspekt er "near miss"-effekten. Når et premium-symbol lander på 4 ud af 5 hjul i en linje, er det visuelt meget tæt på en gevinst – og med tumble-funktionen er der altid en chance for, at det næste faldende symbol kompletterer kombinationen. Denne dynamik skaber en konstant spænding, der holder opmærksomheden fanget, men det er afgørende at huske, at hvert spin er uafhængigt, og at "nær-gevinster" ikke øger sandsynligheden for fremtidige gevinster.</p>
        ...
        <section className="mb-12">
          ...
          <ReviewScreenshot src={chaoscrewPaylines} alt="Chaos Crew spilleregler med 15 gevinstlinjer visualiseret på 5x3 grid samt bonuskøb-regler og RTP på 95,92 procent ved køb af gratis spins" caption="De 15 faste gevinstlinjer: Chaos Crew's komplette spillemekanik med linjepositioner visualiseret" size="full" />

          <p className="text-muted-foreground mb-4 leading-relaxed">Chaos Crew skiller sig ud med sit kompakte 5×3 grid og 15 linjer, mens de fleste Hacksaw-konkurrenter bruger større grids. <Link to="/casinospil/spillemaskiner/wanted-dead-or-a-wild" className={linkClass}>Wanted Dead or a Wild</Link> har højere max win (12.500×) og et 5×5 grid, men med højere volatilitet. Chaos Crew 2 udvider konceptet til et 7×7 grid med nye bonusfunktioner.</p>

          <p className="text-muted-foreground mb-4 leading-relaxed">Chaos Crew's differentiator er den dual-wild mekanik, som ingen andre slots tilbyder på samme måde. Den kombination af faste (Cranky) og tilfældige (Sketchy) multiplikatorer på sticky wilds skaber en unik risk/reward-profil, der giver spilleren to kontrasterende oplevelser inden for samme spil. Denne mekaniske unikhed gør Chaos Crew til et genuint supplement til enhver slot-portfolio.</p>

          <p className="text-muted-foreground leading-relaxed">For danske spillere, der allerede kender Hacksaw Gaming's større titler, tilbyder Chaos Crew en mere tilgængelig men stadig ekstremt volatil oplevelse med den tilføjede krydderi af dual-wild mekanikken og punk-æstetikken. Det er ikke en erstatning for de andre titler – det er et komplement, der tilføjer variation og en ny mekanisk dimension til spiloplevelsen.</p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-muted-foreground mb-4 leading-relaxed">Chaos Crew er Hacksaw Gaming's mest tilgængelige slot med ekstrem volatilitet – en titel, der balancerer punk-anarki med matematisk disciplin. Den dual-wild mekanik er genuint innovativ, det kompakte 5×3 grid med 15 linjer giver en visuelt overskuelig spiloplevelse, og den 96,50 % RTP sikrer fair value for danske spillere. For dem, der søger en alternativ slot-oplevelse med Hacksaw's karakteristiske kant, er Chaos Crew et fremragende valg.</p>
