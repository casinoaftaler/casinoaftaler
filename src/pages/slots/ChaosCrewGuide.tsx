...
const chaosCrewFaqs: { question: string; answer: ReactNode }[] = [
  ...
  { question: "Er Chaos Crew en Hacksaw Gaming-slot?", answer: "Ja, Hacksaw Gaming udviklede Chaos Crew og lancerede den i 2021. Spillet er en af Hacksaws mest populære og tilgængelige titler, der balancerer den høje volatilitet, som kendetegner studiet, med en mere moderat max win og tilgængelig cluster pays-mekanik." },
