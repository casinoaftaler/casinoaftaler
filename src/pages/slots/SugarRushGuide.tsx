...
const SugarRushGuide = () => {
  ...
  const breadcrumbJsonLd = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 4, name: "Sugar Rush", item: `${SITE_URL}/casinospil/spillemaskiner/sugar-rush` },
  ]};

  return (
    <>
      <SEO title="Sugar Rush – Cluster Pays & Multiplikator-Analyse" description="Komplet analyse af Sugar Rush: akkumulerende multiplikatorer, cluster pays mekanik, RTP 96,50 % og EV-beregninger for danske spillere." jsonLd={[faqJsonLd, articleSchema, breadcrumbJsonLd]} />
      <article className="mx-auto max-w-4xl px-4 py-12">
        <header className="mb-8 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4 leading-tight">Sugar Rush – Cluster Pays & Akkumulerende Multiplikatorer</h1>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">Pragmatic Play's innovative slik-slot med positionsbaserede multiplikatorer: en matematisk analyse af 7×7 cluster pays-dynamikken og den akkumulerende mekanik, der belønner hvert eneste spin i bonusrunden.</p>
        </header>
