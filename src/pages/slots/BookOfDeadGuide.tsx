...
const BookOfDeadGuide = () => {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 4, name: "Book of Dead", item: `${SITE_URL}/casinospil/spillemaskiner/book-of-dead` },
    ],
  };
  ...
  return (
    <>
      ...
      {/* ── HERO ── */}
      <section className="relative overflow-hidden py-12 text-white md:py-20" style={{ backgroundImage: "linear-gradient(135deg, hsl(35 70% 25%), hsl(25 60% 20%) 40%, hsl(15 50% 15%))" }}>
      ...
      <div className="container py-8 md:py-12">
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">
            Book of Dead opererer med den klassiske 5x3 grid-arkitektur med 10 faste gevinstlinjer. Denne struktur er fundamentalt anderledes end moderne cluster-pays eller Megaways-slots. Med kun 10 gevinstlinjer er sandsynlighedsrummet langt mere kompakt: der er præcis 10 mulige vinderkombinationer pr. spin (én pr. linje), og gevinster beregnes fra venstre mod højre med det højeste symbolmatch pr. linje.
          </p>
          <p className="mb-4 text-muted-foreground leading-relaxed">
            Symbolhierarkiet er klart defineret: Rich Wilde (explorer) er det højestbetalende symbol med 5.000 mønter for 5-of-a-kind, efterfulgt af Osiris (2.000), Anubis (750), Horus (750) og så de fire lavbetalende kortsymboler (A, K, Q, J med 150 mønter for 5-of-a-kind). Bogen fungerer som både wild og scatter – en dual-rolle der er karakteristisk for "Book of"-genren.
          </p>
          <p className="text-muted-foreground leading-relaxed">
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">
            Book of Dead er særligt velegnet til <Link to="/indskudsbonus" className={linkClass}>indskudsbonusser</Link> med moderate omsætningskrav (20–30x). Med 25x wagering på en 500 kr. bonus er forventet tab ca. 474 kr. – marginalt under bonusværdien, hvilket giver en net-positiv EV på ca. 26 kr. Break-even-punktet er ca. 26,4x wagering: enhver bonus med lavere omsætningskrav er matematisk fordelagtig med Book of Dead.
          </p>
          <p className="text-muted-foreground leading-relaxed">
