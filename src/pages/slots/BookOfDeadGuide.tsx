...
import { AlertTriangle, BarChart3, BookOpen, Calculator, Dog, Flame, Gem, Link, Play, Scale, Shield, Sparkles, Target, TrendingUp, Trophy, Users, Zap } from "lucide-react"
...
const BookOfDeadGuide = () => {
  ...
  const videoJsonLd = buildVideoSchema(`${SITE_URL}/casinospil/spillemaskiner/book-of-dead`, "Jw--inO4LNk", {
    title: "Book of Dead gennemgang – Expanding symbols og RTP forklaret",
    description: "Se en komplet gennemgang af Book of Dead: expanding symbol-mekanikken, RTP på 96,21 % og free spins-matematik forklaret i praksis.",
  ...
  return (
    <>
      ...
      <ContentPageLayout>
        ...
        <LatestNewsByCategory pagePath="/casinospil/spillemaskiner/book-of-dead" />
