...
const WantedDeadOrAWildGuide = () => {
  ...
  return (
    <>
      ...
      {/* ── HERO ── */}
      <section className="relative overflow-hidden py-12 text-white md:py-20" style={{ backgroundImage: "linear-gradient(135deg, hsl(25 75% 22%), hsl(15 65% 18%) 40%, hsl(35 80% 28%))" }}>
