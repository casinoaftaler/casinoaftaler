...
const wantedFaqs: { question: string; answer: ReactNode }[] = [
  ...
  { question: "Hvordan fungerer Duel at Dawn-funktionen?", answer: "Duel at Dawn er bonusrunden med 10 free spins. Under free spins kan versus-symboler (VS) lande med en tilfældig multiplikator fra 1× til 100×. VS-symbolet duellerer og efterlader en sticky wild med sin multiplikator. Jo flere VS-symboler der lander, desto flere sticky wilds akkumuleres, og multiplikatorer kombineres multiplicativt for eksponentielt voksende gevinster." },
    ...
    <>
      ...
      <ContentPageLayout>
        ...
        <section className="mb-12">
          ...
          <p className="text-muted-foreground mb-4 leading-relaxed">Når en versus-symbol (VS) lander under free spins, bærer den en tilfældig multiplikator fra 1× til 100×. VS'en duellerer og efterlader en sticky wild med sin multiplikator på positionen. Hvis flere sticky wilds akkumuleres, kan multiplikatorerne kombineres multiplicativt på gevinster, der krydser flere wild-positioner. Denne mekanisme skaber eksponentielt voksende gevinstpotentiale – en enkelt 100× VS kan alene transformere en hel bonusrunde. Det er matematisk elegant men også ekstremt variabelt.</p>
        ...
        <section className="mb-12">
          ...
          <p className="text-muted-foreground mb-4 leading-relaxed">Versus-symboler er kernen i Wanted's gevinstpotentiale. Under free spins kan versus-symboler (VS) lande på griddet. Hver VS bærer en tilfældig multiplikator fra 1× til 100× – et enormt spænd, der alene kan afgøre en hel bonusrundes udfald. Når en VS lander, duellerer den og efterlader en sticky wild med sin multiplikator på den pågældende position. Duellens visuelle animation er dramatisk, men det underliggende system er RNG-baseret.</p>
          <p className="text-muted-foreground mb-4 leading-relaxed">Multiplikator-matematikken er det, der virkelig driver potentialet. Sticky wilds akkumulerer multiplikatorer: en wild med 5× ved siden af en wild med 20× kan kombinere multiplicativt på gevinster, der krydser begge positioner. Med VS-multiplikatorer op til 100× kan selv en enkelt velplaceret VS transformere en ellers middelmådig bonusrunde. Eksempel: én VS med 50× på hjul 3 kombineret med en 10× på hjul 1 giver en samlet multiplikator-effekt på 500× på gevinster, der krydser begge positioner. Denne multiplicative akkumulering er nøglen til 12.500×.</p>
          ...
          <p className="text-muted-foreground leading-relaxed">For at sætte VS-matematikken i perspektiv: en bonusrunde med 3 velplacerede sticky wilds (fx 20×, 50× og 5× på hjul 1, 3, 5) med premium-symboler på de resterende positioner kan producere gevinster på 1.000-5.000× fra et enkelt spin inden for bonusrunden. En sjælden 100× VS kombineret med andre multiplikatorer er vejen til max win (12.500×). Men husk: høje VS-multiplikatorer (50×+) er ekstremt sjældne, og dette scenarie opstår i under 1 % af alle bonusrunder.</p>
        </section>
