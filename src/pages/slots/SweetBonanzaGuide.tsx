...
const SweetBonanzaGuide = () => {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 4, name: "Sweet Bonanza", item: `${SITE_URL}/casinospil/spillemaskiner/sweet-bonanza` },
    ],
  };
  ...
  return (
    <>
      ...
      {/* ── HERO ── */}
      <section className="relative overflow-hidden py-12 text-white md:py-20" style={{ backgroundImage: "linear-gradient(135deg, hsl(330 70% 35%), hsl(280 60% 25%) 40%, hsl(260 80% 20%))" }}>
