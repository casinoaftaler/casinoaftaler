...
const GonzosQuestGuide = () => {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 4, name: "Gonzo's Quest", item: `${SITE_URL}/casinospil/spillemaskiner/gonzos-quest` },
    ],
  };
  ...
  return (
    <>
      <SEO
        title="Gonzo's Quest – RTP & Avalanche-Analyse"
      ...
      {/* ── HERO ── */}
      <section className="relative overflow-hidden py-12 text-white md:py-20" style={{ backgroundImage: "linear-gradient(135deg, hsl(45 70% 25%), hsl(35 80% 18%) 40%, hsl(25 60% 15%))" }}>
      ...
      <div className="container py-8 md:py-12">
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">
            Spørgsmålet i 2026 er brutalt ærligt: er Gonzo's Quest stadig værd at spille, eller er den overhalet af sine efterkommere? Med en RTP på 95,97 % (under gennemsnittet), et max win på 2.500x (beskedent), og ingen bonus buy-funktion, er den teknisk set inferior sammenlignet med de fleste moderne cluster-pay slots. Men Gonzo's Quest har noget, de andre mangler: den originale Avalanche med stigende multiplikatorer, der føles fundamentalt anderledes end Tumble.
          </p>
