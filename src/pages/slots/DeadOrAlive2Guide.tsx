...
const DeadOrAlive2Guide = () => {
  ...
  const videoJsonLd = buildVideoSchema(`${SITE_URL}/casinospil/spillemaskiner/dead-or-alive-2`, "oz_VUxjLXZ0", {
    title: "Dead or Alive 2 gennemgang – Tre bonusmodes og max win forklaret",
    description: "Se en komplet gennemgang af Dead or Alive 2: sticky wilds, tre free spins-modes og 111.111x max win forklaret i praksis.",
    ...
    <>
      ...
      <ContentPageLayout>
        ...
        <section className="mb-12">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Med det danske 10x omsætningskrav og en 1.000 kr. bonus er det forventede tab: 10.000 × 0,0318 = 318 kr. – en fremragende EV på +680 kr. Bust-risikoen er dog stadig en faktor: med High Noon Saloon er der ca. 15–20 % chance for at gå bust ved 10x wagering. Med Train Heist er det ca. 8–10 %. Valget af mode har altså enorm praktisk betydning.
          </p>
        </section>
