...
const JokerStrikeGuide = () => {
  ...
  return (
    <>
      <SEO title="Joker Strike – 98 % RTP & Hi Roller" description="Dybdegående analyse af Joker Strike: 98,11 % RTP med Hi Roller, lav volatilitet, 456× max win og gennemspilningsstrategi." jsonLd={[faqJsonLd, articleSchema]} />
      {/* ── HERO ── */}
