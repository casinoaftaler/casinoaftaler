...
const JokerStrikeGuide = () => {
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden py-12 text-white md:py-20" style={{ backgroundImage: "linear-gradient(135deg, hsl(40 80% 25%), hsl(30 70% 20%) 40%, hsl(20 60% 18%))" }}>
