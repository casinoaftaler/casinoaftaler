...
const JokerStrikeGuide = () => {
  ...
  const breadcrumbJsonLd = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 4, name: "Joker Strike", item: `${SITE_URL}/casinospil/spillemaskiner/joker-strike` },
  ]};
    ...
    <>
      ...
      <div className="container py-8 md:py-12">
        ...
        <div className="mb-10 overflow-hidden rounded-xl">
          <img src={heroImage} className="w-full h-auto object-cover max-h-[400px]" alt="Joker Strike spillemaskine" />
        </div>
        ...
        <section className="mb-10">
          ...
          <p className="text-muted-foreground mb-4 leading-relaxed">98,11 % RTP er ikke bare høj – det er næsten uhørt i slot-industrien. Kun en håndfuld slots i hele markedet overgår dette tal, og de fleste af dem er enten nedtaget eller har begrænset tilgængelighed. For at sætte det i perspektiv: en session på 500 spins à 4 kr. (2.000 kr. indsats) har et forventet tab på kun 38 kr. – prisen for en biograf-billet med popcorn.</p>
