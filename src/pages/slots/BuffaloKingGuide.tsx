    ...
    <>
      ...
      <ContentPageLayout>
        ...
        <section className="mb-12">
          ...
          <p className="text-muted-foreground mb-4 leading-relaxed">Tabellen illustrerer den eksplosive effekt af multiplikator-stacking: et buffel-6-of-a-kind, der normalt betaler 7,5× per way, kan med to 5× WILD-multiplikatorer betale 187,5× per way. Med 4.096 aktive ways og potentielt hundredvis af samtidige gevinster kan den samlede udbetaling fra et enkelt free spin nå astronomiske niveauer. Det er denne multiplikative matematik – per-way gevinster × antal ways × WILD-multiplikatorer – der producerer max win-potentialet på 93.750×.</p>
