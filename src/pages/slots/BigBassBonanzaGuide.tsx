...
const BigBassBonanzaGuide = () => {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 4, name: "Big Bass Bonanza", item: `${SITE_URL}/casinospil/spillemaskiner/big-bass-bonanza` },
    ],
  };
  ...
  return (
    <>
      ...
      {/* ── HERO ── */}
      <section className="relative overflow-hidden py-12 text-white md:py-20" style={{ backgroundImage: "linear-gradient(135deg, hsl(210 70% 30%), hsl(180 60% 20%) 40%, hsl(150 70% 18%))" }}>
