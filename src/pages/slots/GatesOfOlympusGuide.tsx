...
const GatesOfOlympusGuide = () => {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 4, name: "Gates of Olympus", item: `${SITE_URL}/casinospil/spillemaskiner/gates-of-olympus` },
    ],
  };
  ...
  return (
    <>
      ...
      {/* ── HERO ── */}
      <section className="relative overflow-hidden py-12 text-white md:py-20" style={{ backgroundImage: "linear-gradient(135deg, hsl(45 80% 30%), hsl(35 70% 22%) 40%, hsl(220 60% 18%))" }}>
      ...
      <div className="container py-8 md:py-12">
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">
            Gates of Olympus deler det 6x5 scatter-pays layout med Sweet Bonanza: 30 synlige positioner, gevinster baseret på minimum 8 identiske symboler hvor som helst på skærmen, og tumble-mekanik (vindende symboler fjernes, nye falder ned). Symbolhierarkiet består af 4 lavbetalende ædelsten-symboler (blå, grøn, rød, lilla) og 4 højbetalende objekter (ring, timeglas, bæger, krone). Zeus fungerer som wild, og scatter-symbolet er Pegasus.
          </p>
          <p className="mb-4 text-muted-foreground leading-relaxed">
            Den kritiske forskel fra Sweet Bonanza er multiplikatorernes opførsel: i Gates of Olympus kan multiplikator-orbs (lyskugler holdt af Zeus) lande med værdier fra 2x til 500x. Under free spins adderes alle multiplikatorer, der lander i ét spin, og ganges med den samlede gevinst for det spin. Men ved næste free spin nulstilles multiplikatoren til 1x. Denne "per-spin reset"-model skaber en anden gevinstfordeling end Sweet Bonanzas akkumulerende model.
          </p>
          <p className="text-muted-foreground leading-relaxed">
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">
            For <Link to="/indskudsbonus" className={linkClass}>indskudsbonusser</Link> med 20–25x wagering er Gates of Olympus et udmærket valg – den positive EV opvejer volatilitetsrisikoen. For bonusser med 30–35x wagering er det et grænsetilfælde, og vi anbefaler Book of Dead i stedet pga. lavere bust-risiko. For <Link to="/bonus-uden-omsaetningskrav" className={linkClass}>bonusser uden omsætningskrav</Link> er Gates of Olympus ideelt, da du beholder alt hvad du vinder uden at skulle bekymre dig om bankroll-svingninger.
          </p>
          <p className="text-muted-foreground leading-relaxed">
