...
import { AlertTriangle, BarChart3, Calculator, Crown, Dog, Flame, Link, Play, Scale, Shield, Sparkles, Target, TrendingUp, Trophy, Users, Zap } from "lucide-react"
  ...
  return (
    <>
      <SEO
        ...
        description="Gates of Olympus 2026: 96,50 % RTP, høj volatilitet og 5.000× max win. Se multiplikator-matematik og vurdering for danske spillere."
      ...
      <ContentPageLayout>
        <AuthorMetaBar author="jonas" readTime="153 Min." />
