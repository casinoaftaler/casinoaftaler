    ...
    <>
      ...
      <div className="container py-8 md:py-12">
        ...
        <section className="mb-10">
          ...
          <p className="text-muted-foreground mb-4 leading-relaxed">
            Sammenlignet med moderne 5-hjuls slots som <Link to="/casinospil/spillemaskiner/starburst" className={linkClass}>Starburst</Link> (96,08 % RTP, lav volatilitet) er Fire Joker marginalt bedre på RTP (96,15 %) men har et lavere max win (800× vs. 800× – bemærk at Starburst faktisk har lavere max win). Begge slots appellerer til det samme segment, men Fire Joker tilbyder en mere retro-æstetik og et simplere interface.
          </p>
          <p className="text-muted-foreground leading-relaxed">
