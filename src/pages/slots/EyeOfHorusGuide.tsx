...
const EyeOfHorusGuide = () => {
  ...
  return (
    <>
      <SEO title="Eye of Horus – Symbol Upgrade & RTP-Analyse" description="Komplet analyse af Eye of Horus: symbol upgrade-mekanik, expanding symbols, RTP 96,31 % og EV-beregninger for danske spillere." jsonLd={[faqJsonLd, articleSchema]} />
      {/* ── HERO ── */}
