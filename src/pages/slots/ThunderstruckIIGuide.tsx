...
const ThunderstruckIIGuide = () => {
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden py-12 text-white md:py-20" style={{ backgroundImage: "linear-gradient(135deg, hsl(220 70% 20%), hsl(200 60% 18%) 40%, hsl(180 50% 22%))" }}>
