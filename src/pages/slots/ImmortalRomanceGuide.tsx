...
const ImmortalRomanceGuide = () => {
  ...
  return (
    <>
      <SEO title="Immortal Romance Spilleautomat – RTP 96,86% (2026)" description="Dybdegående analyse af Immortal Romance: Chamber of Spins, 96,86 % RTP, Wild Vine og 12.150× max win for danske spillere." jsonLd={[faqJsonLd, articleSchema]} />
      {/* ── HERO ── */}
