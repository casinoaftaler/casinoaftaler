...
const DivineFortuneGuide = () => {
  ...
  const breadcrumbJsonLd = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 4, name: "Divine Fortune", item: `${SITE_URL}/casinospil/spillemaskiner/divine-fortune` },
  ]};
    ...
    <>
      ...
      <div className="container py-8 md:py-12">
        ...
        <div className="mb-10 overflow-hidden rounded-xl">
          <img src={heroImage} className="w-full h-auto object-cover max-h-[400px]" alt="Divine Fortune spillemaskine" />
        </div>
