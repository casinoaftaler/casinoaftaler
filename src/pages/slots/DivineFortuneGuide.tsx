...
const DivineFortuneGuide = () => {
  ...
  return (
    <>
      <SEO title="Divine Fortune – Jackpot & RTP-Analyse" description="Dybdegående analyse af Divine Fortune: progressivt jackpot-system, Falling Wilds, RTP 96,59 % og EV-beregninger for danske spillere." jsonLd={[faqJsonLd, articleSchema]} />
      {/* ── HERO ── */}
