...
import { AlertTriangle, Badge, Calculator, Check, Clock, CreditCard, Dog, DollarSign, Eye, Gamepad2, Link, Lock, X } from "lucide-react"
  ...
  return (
    <>
      ...
      <ContentPageLayout>
        ...
        <QuickComparisonTable count={3} title="No-sticky bonus – top 3 casinoer" prioritySlugs={["betinia", "spilleautomaten", "playkasino"]} />
