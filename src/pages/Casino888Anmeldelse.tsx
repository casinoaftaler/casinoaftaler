...
const faqs: { question: string; answer: ReactNode }[] = [
  ...
  { question: "Hvad er 888 Casinos velkomstbonus?", answer: (<>888 Casino tilbyder en <Link to="/velkomstbonus" className={linkClass}>velkomstbonus</Link> på 100% match op til 1.000 kr. til nye danske spillere. Indbetaler du 1.000 kr., får du 1.000 kr. i bonus. <Link to="/omsaetningskrav" className={linkClass}>Omsætningskravet</Link> er 10x (d+b). Regneeksempel: Indbetal 1.000 kr. → modtag 1.000 kr. bonus → omsæt 20.000 kr. [(1.000+1.000)×10] inden 30 dage.</>) },
...
const Casino888Anmeldelse = () => {
  ...
  const articleSchema = buildArticleSchema({ headline: "888 Casino Anmeldelse 2026 – Pioneren i Online Casino", description: "Komplet anmeldelse af 888 Casino. Børsnoteret pioner med dansk licens, eksklusive spil og 888 Club loyalitetsprogram.", url: "https://casinoaftaler.dk/casino-anmeldelser/888-casino", datePublished: "2026-02-15", dateModified: "2026-02-18", authorName: "Jonas", authorUrl: "https://casinoaftaler.dk/forfatter/jonas", aggregateRating: { ratingValue: "4.2", ratingCount: "188" } });
  const faqJsonLd = buildFaqSchema(faqs);
  const reviewJsonLd = { "@context": "https://schema.org", "@type": "Review", itemReviewed: { "@type": "Organization", name: "888 Casino", url: "https://www.888casino.dk/" }, author: { "@type": "Person", "@id": "https://casinoaftaler.dk/forfatter/jonas#person" }, reviewRating: { "@type": "Rating", ratingValue: "4.2", bestRating: "5", worstRating: "1" }, reviewBody: "888 Casino er en pioner inden for online gambling med eksklusivt spiludvalg, loyalitetsprogram og dansk licens." };
    ...
    <>
      ...
      <div className="container py-8 md:py-12">
        ...
        <section className="mb-12">
          <Card className="border-border bg-card border-l-4 border-l-primary"><CardHeader><CardTitle className="flex items-center gap-2 text-xl"><Zap className="h-6 w-6 text-primary" />Hurtige Fakta – 888 Casino</CardTitle></CardHeader><CardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
              <div className="rounded-lg border border-border p-3"><p className="text-xs text-muted-foreground uppercase mb-1">Velkomstbonus</p><p className="text-lg font-bold text-foreground">Op til 1.000 kr. + FS</p></div>
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">888 Casino tilbyder to typer bonusser til nye spillere: en <Link to="/bonus-uden-indbetaling" className={linkClass}>bonus uden indbetaling</Link> og en <Link to="/velkomstbonus" className={linkClass}>matchbonus</Link> på op til 1.000 kr. Lad os gennemgå begge.</p>
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed"><strong>Matchbonus regneeksempel:</strong> Du indbetaler 1.000 kr. og modtager 1.000 kr. i bonus = 2.000 kr. total. Omsætningskrav: 10 × (1.000 + 1.000) = 20.000 kr. Med gennemsnitlig indsats på 20 kr. pr. spin = 1.000 spins påkrævet. Med gennemsnitlig RTP på 96% kan du forvente ca. 1.200 kr. tilbage efter fuld omsætning – et forventet tab på ca. 800 kr. Det er standard for 10x-vilkår.</p>
