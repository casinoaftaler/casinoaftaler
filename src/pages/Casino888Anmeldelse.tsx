...
const faqs: { question: string; answer: ReactNode }[] = [
  ...
  { question: "Hvad er 888 Casinos velkomstbonus?", answer: (<>888 Casino tilbyder en <Link to="/velkomstbonus" className={linkClass}>velkomstbonus</Link> på op til 2.000 kr. i matchbonus plus <Link to="/free-spins" className={linkClass}>free spins</Link> til nye danske spillere. <Link to="/omsaetningskrav" className={linkClass}>Omsætningskravet</Link> er 10x (d+b). Derudover er 888 Casino et af de få danske casinoer, der tilbyder en <Link to="/bonus-uden-indbetaling" className={linkClass}>bonus uden indbetaling</Link> – et sjældent tilbud, der lader dig teste platformen risikofrit. Regneeksempel: Indbetal 1.000 kr. → modtag 1.000 kr. bonus → omsæt 20.000 kr. [(1.000+1.000)×10] inden 30 dage.</>) },
    ...
    <>
      ...
      <div className="container py-8 md:py-12">
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">Vi indbetalte 1.000 kr. via Trustly og modtog 1.000 kr. i matchbonus plus 25 free spins på udvalgte slots. Samlet startkapital: 2.000 kr. plus free spins-gevinster. <Link to="/omsaetningskrav" className={linkClass}>Omsætningskravet</Link> på 10x (d+b) betød, at vi skulle omsætte for 20.000 kr. inden 30 dage. Free spins-gevinsterne havde separat omsætningskrav på 30x, hvilket er højere end standardmarkedet – en detalje der er værd at notere.</p>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card className="border-border bg-card"><CardHeader className="pb-2"><CardTitle className="flex items-center gap-2 text-lg text-destructive/80"><X className="h-5 w-5" />Reelle svagheder</CardTitle></CardHeader><CardContent><ul className="space-y-2">{["Platformdesign føles dateret – UI er ikke moderniseret tilstrækkeligt", "31 timers udbetalingstid i test – langt fra branchens hurtigste", "Eksklusive spil har varierende RTP (ned til 94,8%)", "Ekstra KYC-krav udover MitID kan forsinke første udbetaling", "Spiludvalg er numerisk mindre end nyere konkurrenter som GetLucky", "Free spins-omsætningskrav på 30x er over markedsstandard"].map((c) => (<li key={c} className="flex items-start gap-2 text-sm"><X className="h-4 w-4 text-destructive flex-shrink-0 mt-0.5" /><span className="text-muted-foreground">{c}</span></li>))}</ul></CardContent></Card>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">888 Casino tilbyder to typer bonusser til nye spillere: en <Link to="/bonus-uden-indbetaling" className={linkClass}>bonus uden indbetaling</Link> og en <Link to="/velkomstbonus" className={linkClass}>matchbonus</Link> på op til 2.000 kr. Lad os gennemgå begge.</p>
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed"><strong>Matchbonus regneeksempel:</strong> Du indbetaler det maksimale 2.000 kr. og modtager 2.000 kr. i bonus = 4.000 kr. total. Omsætningskrav: 10 × (2.000 + 2.000) = 40.000 kr. Med gennemsnitlig indsats på 20 kr. pr. spin = 2.000 spins påkrævet. Med gennemsnitlig RTP på 96% kan du forvente ca. 2.400 kr. tilbage efter fuld omsætning – et forventet tab på ca. 1.600 kr. Det er standard for 10x-vilkår.</p>
          ...
          <p className="text-muted-foreground leading-relaxed"><strong>Sammenligning:</strong> <Link to="/casino-anmeldelser/leovegas" className={linkClass}>LeoVegas</Link> tilbyder op til 3.000 kr. i velkomstbonus med samme 10x-krav, men uden bonus uden indbetaling. <Link to="/casino-anmeldelser/comeon" className={linkClass}>ComeOn</Link> matcher med op til 2.000 kr. men tilbyder heller ingen no-deposit bonus. 888 Casinos unikke no-deposit tilbud er altså en reel differentiator – om end værdien er beskeden.</p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">888 Casino er reguleret af <Link to="/spillemyndigheden" className={linkClass}>Spillemyndigheden</Link> i Danmark og UK Gambling Commission i Storbritannien. Børsnoteringen på London Stock Exchange kræver kvartalsrapportering og ekstern revision, hvilket giver et gennemsigtighedsniveau, som private operatører ikke er forpligtet til at levere.</p>
          <p className="text-muted-foreground leading-relaxed">Fusionen med William Hill International i 2022 skabte en af verdens største gambling-koncerner. Det styrker den finansielle stabilitet men rejser også spørgsmål om konsolidering og konkurrencemæssig magt. For den individuelle spiller betyder det primært større ressourcer til produktudvikling og bedre forhandlingsposition overfor spiludbydere. <Link to="/ansvarligt-spil" className={linkClass}>Ansvarligt spil</Link>-værktøjer inkluderer indbetalingsgrænser, sessionsgrænser, selvudelukkelse og ROFUS-tilslutning.</p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed"><strong>Vs. <Link to="/casino-anmeldelser/leovegas" className={linkClass}>LeoVegas</Link>:</strong> LeoVegas vinder på mobiloplevelse, udbetalingshastighed og spiludvalgets bredde. 888 Casino vinder på eksklusive spil, loyalitetsprogram og troværdighed som børsnoteret pioner. For mobilspillere: LeoVegas. For loyalitetsfokuserede spillere: 888 Casino.</p>
          <p className="mb-4 text-muted-foreground leading-relaxed"><strong>Vs. <Link to="/casino-anmeldelser/bet365" className={linkClass}>Bet365</Link>:</strong> Begge er gigantiske, etablerede operatører. Bet365 har den stærkeste sportsbook, mens 888 Casino har de bedre eksklusive casino-features. Bet365's casinosektion er bredere men mere generisk. For den rene casinospiller: 888 Casino. For all-round betting: Bet365.</p>
          <p className="text-muted-foreground leading-relaxed"><strong>Vs. <Link to="/casino-anmeldelser/comeon" className={linkClass}>ComeOn</Link>:</strong> ComeOn er enklere, mere gennemsigtigt og mere brugervenligt. 888 Casino er dybere, mere funktionsrigt og har langt mere at tilbyde loyale spillere over tid. ComeOn er bedre for den ukomplicerede casual spiller. 888 Casino er bedre for den engagerede spiller, der vil belønnes for sin loyalitet.</p>
        </section>
