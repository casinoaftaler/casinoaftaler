...
const RouletteGuide = () => {
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden py-12 text-white md:py-20" style={{ backgroundImage: "linear-gradient(135deg, hsl(0 60% 25%), hsl(350 50% 20%) 40%, hsl(340 70% 20%))" }}>
        <div className="container">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h1 className="mt-6 text-4xl font-bold tracking-tight md:text-5xl lg:text-6xl">Roulette Regler 2026</h1>
            <p className="mt-6 text-lg leading-8 text-red-100">Guide til væddemål, odds og varianter – din komplette roulette-guide.</p>
          </div>
        </div>
      </section>
