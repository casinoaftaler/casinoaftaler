    ...
    <>
      ...
      <div className="container py-8 md:py-12">
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">
            Sammenlign med <Link to="/casinospil/blackjack" className={linkClass}>blackjack</Link>, hvor dine beslutninger (hit, stand, double, split) direkte påvirker den forventede værdi af hånden. I blackjack kan perfekt spil reducere house edge til 0,5 % – og korttælling kan i teorien eliminere den helt. I roulette eksisterer denne mekanisme ikke. Du placerer din indsats, kuglen lander, og resultatet er 100 % uafhængigt af din handling. Det eneste valg, der påvirker din matematiske situation, er <em>hvilken variant</em> du spiller (europæisk, fransk, amerikansk) og <em>hvor stor</em> din indsats er relativt til din bankroll.
          </p>
          <p className="mb-4 text-muted-foreground leading-relaxed">
