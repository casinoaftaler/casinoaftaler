    ...
    <>
      ...
      <div className="container py-8 md:py-12">
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">
            <strong><Link to="/casinospil/caribbean-stud-poker" className={linkClass}>Caribbean Stud Poker</Link></strong> spilles mod huset: du modtager fem kort, dealeren modtager fem kort (ét synligt). Du beslutter om du vil raise eller folde baseret på din håndstyrke og dealerens synlige kort. House edge er ~5,2 % – markant højere end <Link to="/casinospil/blackjack" className={linkClass}>blackjack</Link> – men progressiv jackpot-sideindsatsen kan være break-even ved høje jackpots (typisk over 263.000 kr.). AK-Q-8-3-strategien reducerer house edge til minimum.
          </p>
          <p className="mb-4 text-muted-foreground leading-relaxed">
