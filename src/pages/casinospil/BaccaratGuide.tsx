...
const BaccaratGuide = () => {
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden py-12 text-white md:py-20" style={{ backgroundImage: "linear-gradient(135deg, hsl(330 50% 25%), hsl(340 40% 20%) 40%, hsl(350 60% 25%))" }}>
        <div className="container">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h1 className="mt-6 text-4xl font-bold tracking-tight md:text-5xl lg:text-6xl">Baccarat Regler 2026</h1>
            <p className="mt-6 text-lg leading-8 text-pink-100">Guide til Punto Banco, kortregler og strategi – den komplette baccarat-guide.</p>
          </div>
        </div>
      </section>
