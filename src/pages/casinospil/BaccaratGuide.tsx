...
const BaccaratGuide = () => {
  ...
  return (
    <>
      ...
      <div className="h-16 md:h-24" style={{ background: "linear-gradient(135deg, hsl(330 50% 25%), hsl(340 40% 20%) 40%, hsl(350 60% 25%))" }} />
      ...
      <div className="container py-8 md:py-12">
        ...
        <h1 className="mb-8 text-3xl font-bold tracking-tight md:text-4xl lg:text-5xl">
          Baccarat Regler 2026 – Den Komplette Guide
        </h1>
