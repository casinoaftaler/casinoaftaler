...
import blackjackLiveLobby from "@/assets/screenshots/blackjack-live-casino-lobby.webp";
import blackjackDealerBord from "@/assets/screenshots/blackjack-dealer-bord-venter.webp";
import blackjackMidgame from "@/assets/screenshots/blackjack-midgame-kort-dealt.webp";
import blackjackOmspillet from "@/assets/screenshots/blackjack-omspillet-regler-menu.webp";
...
import { Dog, Play, Timer } from "lucide-react"
    ...
    <>
      ...
      <ContentPageLayout>
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-muted-foreground leading-relaxed">
            Sammenlign med andre varianter: <Link to="/casinospil/blackjack/double-exposure-blackjack" className={linkClass}>Double Exposure</Link> giver endnu mere information (begge dealerkort synlige), men kompenserer med strengere regler. <Link to="/casinospil/blackjack/spanish-21" className={linkClass}>Spanish 21</Link> fjerner 10'erne fra kortbunken for at tilbyde flere bonusgevinster. Amerikansk blackjack rammer et sweet spot mellem information, fairness og spilletempo.
          </p>
          <p className="text-muted-foreground leading-relaxed">
