      ...
      <section
        ...
        style={{
          backgroundImage: heroBackgroundImage
            ? `linear-gradient(135deg, hsl(340 65% 30% / 0.95), hsl(280 60% 25% / 0.9)), url(${heroBackgroundImage})`
            : "linear-gradient(135deg, hsl(340 65% 30%), hsl(310 50% 22%) 40%, hsl(280 60% 25%))",
