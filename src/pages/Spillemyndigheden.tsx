...
import { Badge, Ban, Eye, FileCheck, Gavel, Link, Lock, Phone, Shield } from "lucide-react"
...
import spillemyndighedenVendor from "@/assets/screenshots/spillemyndigheden-spilleverandoer.webp";
const keyFacts = [
  ...
  return (
    <>
      ...
      <ContentPageLayout hideSidebar>
        ...
        <QuickComparisonTable count={3} title="Godkendte casinoer – top 3" prioritySlugs={["spildansknu", "betinia", "spilleautomaten"]} />
