...
-- Drop and recreate the whitelisted settings policy to include frame position keys
...
USING (
  (key = ANY (ARRAY[
    ...
    'slot_machine_frame_image'::text, 'slot_frame_size'::text,
    'slot_frame_width'::text, 'slot_frame_height'::text, 'slot_frame_offset_x'::text, 'slot_frame_offset_y'::text,
    ...
    'rise_of_fedesvin_background_image'::text, 'rise_of_fedesvin_frame_image'::text, 'rise_of_fedesvin_frame_size'::text,
    'rise_of_fedesvin_frame_width'::text, 'rise_of_fedesvin_frame_height'::text,
